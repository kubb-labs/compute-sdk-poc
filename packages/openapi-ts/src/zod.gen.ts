...
export const getBetaProgramsResponseSchema = z.object({
    ...
    data: z.optional(z.array(z.object({
        ...
        greenlight_only: z.optional(z.boolean().readonly()),
        id: z.optional(z.string()),
        label: z.optional(z.string().readonly()),
        more_info: z.optional(z.union([
            z.string().readonly(),
            z.null()
        ]).readonly()),
        started: z.optional(z.iso.datetime().readonly())
...
export const getDatabasesInstancesResponseSchema = z.object({
    ...
    data: z.optional(z.array(z.object({
        ...
        created: z.optional(z.iso.datetime().readonly()),
        encrypted: z.optional(z.boolean().readonly()).default(true),
        engine: z.optional(z.enum(['mysql', 'postgresql'])),
        ...
        id: z.optional(z.int().readonly()),
        instance_uri: z.optional(z.string().readonly()),
        label: z.optional(z.string().min(3).max(32)),
        members: z.optional(z.record(z.string(), z.unknown()).readonly()),
        oldest_restore_time: z.optional(z.iso.datetime().readonly()),
        platform: z.optional(z.enum(['rdbms-legacy', 'rdbms-default'])),
        port: z.optional(z.int().readonly()),
        ...
        total_disk_size_gb: z.optional(z.int().readonly()),
        type: z.optional(z.string()),
        ...
        used_disk_size_gb: z.optional(z.int().readonly()),
        version: z.optional(z.string())
    })))
}));
...
export const getDatabasesMysqlInstancesResponseSchema = z.object({
    ...
    data: z.optional(z.array(z.object({
        ...
        created: z.optional(z.iso.datetime().readonly()),
        encrypted: z.optional(z.boolean().readonly()).default(true),
        engine: z.optional(z.string().readonly()),
...
export const getDatabasesMysqlInstanceCredentialsResponseSchema = z.object({
    password: z.optional(z.string().readonly()),
    username: z.optional(z.string().readonly())
});
...
export const getDatabasesTypesResponseSchema = z.object({
    ...
    data: z.optional(z.array(z.object({
        class: z.optional(z.enum([
            'dedicated',
            'shared',
            'premium'
        ])),
        disk: z.optional(z.int()),
        engines: z.optional(z.object({
            mysql: z.optional(z.array(z.object({
                price: z.optional(z.object({
                    hourly: z.optional(z.number()),
                    monthly: z.optional(z.number())
                })),
        ...
        id: z.optional(z.string().readonly()),
        label: z.optional(z.string().readonly()),
        memory: z.optional(z.int()),
        vcpus: z.optional(z.int())
    })))
}));
...
export const getDomainZoneResponseSchema = z.object({
    zone_file: z.optional(z.array(z.string()))
});
...
export const getSharegroupImagesByTokenResponseSchema = z.object({
    data: z.array(z.object({
        ...
        image_sharing: z.object({
            ...
            shared_with: z.optional(z.union([
                z.record(z.string(), z.unknown()),
                z.null()
            ]))
        }).readonly(),
    ...
    data: z.optional(z.array(z.object({
        ...
        placement_group: z.optional(z.union([
            z.object({
                ...
                migrating_to: z.optional(z.union([
                    z.int().readonly(),
                    z.null()
                ]).readonly()),
...
export const getBackupsResponseSchema = z.object({
    automatic: z.optional(z.array(z.object({
        available: z.optional(z.boolean().readonly()),
        configs: z.optional(z.array(z.string()).readonly()),
        created: z.optional(z.iso.datetime().readonly()),
        ...
        finished: z.optional(z.iso.datetime().readonly()),
        id: z.optional(z.int().readonly()),
        label: z.optional(z.union([
            z.string(),
            z.null()
        ...
        type: z.optional(z.enum(['auto', 'snapshot'])),
        updated: z.optional(z.iso.datetime().readonly())
    }).and(z.object({
        type: z.optional(z.string())
    })))),
    snapshot: z.optional(z.object({
        ...
        in_progress: z.optional(z.object({
            available: z.optional(z.boolean().readonly()),
            configs: z.optional(z.array(z.string()).readonly()),
            created: z.optional(z.iso.datetime().readonly()),
            disks: z.optional(z.array(z.object({
...
export const getLinodeDisksResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        created: z.optional(z.iso.datetime().readonly()),
        disk_encryption: z.optional(z.string().readonly()).default('enabled'),
        filesystem: z.optional(z.enum([
            'raw',
            'swap',
            'ext2',
...
export const getLinodeInterfacesResponseSchema = z.object({
    interfaces: z.array(z.union([
        z.object({
            created: z.optional(z.iso.datetime()),
            default_route: z.optional(z.union([
                z.object({
                    ipv4: z.optional(z.boolean()).default(false),
                    ipv6: z.optional(z.boolean()).default(false)
                }),
                z.null()
            ])),
            id: z.optional(z.int().readonly()),
            mac_address: z.optional(z.string().min(1).max(64).regex(/[a-zA-Z0-9-]+/)),
            public: z.optional(z.object({
                ipv4: z.optional(z.object({
                    ...
                    shared: z.optional(z.array(z.object({
                        address: z.optional(z.string()),
                        linode_id: z.optional(z.string())
                    })))
                })),
                ipv6: z.optional(z.object({
                    ranges: z.optional(z.array(z.object({
                        range: z.optional(z.string()),
                        route_target: z.optional(z.string())
                    }))),
                    shared: z.optional(z.array(z.object({
                        range: z.optional(z.string()),
                        route_target: z.optional(z.string())
        ...
        z.object({
            ...
            vlan: z.optional(z.object({
                ...
                vlan_label: z.optional(z.string())
            })),
            vpc: z.optional(z.union([
                z.record(z.string(), z.unknown()),
                z.null()
...
export const getLinodeInterfaceHistoryResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        created: z.optional(z.iso.datetime().readonly()),
        interface_data: z.optional(z.string()),
        interface_history_id: z.optional(z.int().readonly()),
        interface_id: z.optional(z.int().readonly()),
        linode_id: z.optional(z.int().readonly()),
        version: z.optional(z.int().readonly())
    }))),
    page: z.optional(z.int().readonly()),
    pages: z.optional(z.int().readonly()),
...
export const getLinodeIpsResponseSchema = z.object({
    ipv4: z.optional(z.object({
        private: z.optional(z.array(z.object({
            address: z.optional(z.string().readonly()),
            gateway: z.optional(z.union([
                z.string().readonly(),
                z.null()
            ]).readonly()),
            linode_id: z.optional(z.int().readonly()),
            prefix: z.optional(z.int().readonly()),
            public: z.optional(z.boolean().readonly()),
            rdns: z.optional(z.union([
                z.string(),
                z.null()
            ])),
            region: z.optional(z.string().readonly()),
            subnet_mask: z.optional(z.string().readonly()),
            type: z.optional(z.string().readonly())
        })).readonly()),
        public: z.optional(z.array(z.object({
            ...
            interface_id: z.optional(z.union([
                z.int().readonly(),
                z.null()
            ]).readonly()),
            linode_id: z.optional(z.int().readonly()),
            ...
            vpc_nat_1_1: z.optional(z.object({
                address: z.optional(z.ipv4()),
                subnet_id: z.optional(z.int()),
                vpc_id: z.optional(z.int().readonly())
            }))
        })).readonly()),
        ...
        vpc: z.optional(z.array(z.object({
            ...
            address_range: z.optional(z.union([
                z.string().readonly(),
                z.null()
            ]).readonly()),
            config_id: z.optional(z.union([
            ...
            interface_id: z.optional(z.int().readonly()),
            linode_id: z.optional(z.int().readonly()),
            nat_1_1: z.optional(z.string().readonly()),
    ...
    ipv6: z.optional(z.object({
        global: z.optional(z.array(z.object({
            prefix: z.optional(z.int()),
            range: z.optional(z.string().readonly()),
            region: z.optional(z.string().readonly()),
            route_target: z.optional(z.string())
        }))),
        link_local: z.optional(z.object({
            address: z.optional(z.string().readonly()),
            gateway: z.optional(z.string().readonly()),
            linode_id: z.optional(z.int().readonly()),
            prefix: z.optional(z.int().readonly()),
            public: z.optional(z.boolean().readonly()),
            rdns: z.optional(z.union([
...
export const getLinodeStatsResponseSchema = z.object({
    cpu: z.optional(z.array(z.array(z.number()))),
    io: z.optional(z.object({
        io: z.optional(z.array(z.array(z.number()))),
        swap: z.optional(z.array(z.array(z.number())))
    })),
    netv4: z.optional(z.object({
        in: z.optional(z.array(z.array(z.number()))),
        out: z.optional(z.array(z.array(z.number()))),
        private_in: z.optional(z.array(z.array(z.number()))),
        private_out: z.optional(z.array(z.array(z.number())))
    })),
...
export const getLinodeTransferByYearMonthResponseSchema = z.object({
    bytes_in: z.optional(z.int().readonly()),
    bytes_out: z.optional(z.int().readonly()),
    bytes_total: z.optional(z.int().readonly())
});
...
export const getKernelsResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        architecture: z.optional(z.enum(['x86_64', 'i386'])),
        built: z.optional(z.iso.datetime().readonly()),
        deprecated: z.optional(z.boolean().readonly()),
        id: z.optional(z.string().readonly()),
        kvm: z.optional(z.boolean().readonly()),
        label: z.optional(z.string().readonly()),
        pvops: z.optional(z.boolean().readonly()),
        version: z.optional(z.string().readonly())
    }))),
    page: z.optional(z.int().readonly()),
    pages: z.optional(z.int().readonly()),
    results: z.optional(z.int().readonly())
...
export const getLinodeTypesResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        label: z.optional(z.string().readonly()),
        memory: z.optional(z.int().readonly()),
        network_out: z.optional(z.int().readonly()),
        price: z.optional(z.object({
            hourly: z.optional(z.number()),
            monthly: z.optional(z.number())
        }).readonly()),
...
export const getLkeClusterApiEndpointsResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        endpoint: z.optional(z.string().readonly())
    }))),
    page: z.optional(z.int().readonly()),
    pages: z.optional(z.int().readonly()),
    results: z.optional(z.int().readonly())
...
export const getLkeClusterAclResponseSchema = z.object({
    ...
    acl: z.optional(z.object({
        addresses: z.optional(z.object({
            ipv4: z.optional(z.unknown()),
            ipv6: z.optional(z.unknown())
        })),
        'revision-id': z.optional(z.unknown())
    }))
}));
...
export const getLkeClusterKubeconfigResponseSchema = z.object({
    kubeconfig: z.optional(z.string().readonly())
});
...
export const getLkeClusterNodeResponseSchema = z.object({
    id: z.optional(z.string()),
    instance_id: z.optional(z.union([
        z.int(),
        z.null()
    ])),
    status: z.optional(z.enum(['ready', 'not_ready']))
}).readonly();
...
export const getLkeTypesResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        transfer: z.optional(z.int().gte(0).readonly())
    }))),
    page: z.optional(z.int().readonly()),
    pages: z.optional(z.int().readonly()),
    results: z.optional(z.int().readonly())
...
export const getLongviewPlanResponseSchema = z.object({
    clients_included: z.optional(z.int().readonly()),
    ...
    label: z.optional(z.string().readonly()),
    price: z.optional(z.object({
        hourly: z.optional(z.number().readonly()),
        monthly: z.optional(z.number().readonly())
    }).readonly())
});
...
export const getMaintenancePoliciesResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        is_default: z.optional(z.boolean()),
        label: z.optional(z.string()),
        notification_period_sec: z.optional(z.int()),
        slug: z.optional(z.string()),
        type: z.optional(z.enum(['migrate', 'power_off_on']))
    }))),
    page: z.optional(z.int().readonly()),
    pages: z.optional(z.int().readonly()),
    results: z.optional(z.int().readonly())
...
export const getManagedSshKeyResponseSchema = z.object({
    ssh_key: z.optional(z.string().readonly())
});
...
export const getManagedIssuesResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        entity: z.optional(z.object({
            id: z.optional(z.int().readonly()),
            label: z.optional(z.string().readonly()),
            type: z.optional(z.enum(['ticket'])),
            url: z.optional(z.string().readonly())
        }).readonly()),
        id: z.optional(z.int().readonly()),
        services: z.optional(z.array(z.int()).readonly())
    }))),
    page: z.optional(z.int().readonly()),
    pages: z.optional(z.int().readonly()),
    results: z.optional(z.int().readonly())
    ...
    data: z.optional(z.union([
        z.object({
            cpu: z.optional(z.array(z.object({
                x: z.optional(z.int().readonly()),
                y: z.optional(z.int().readonly())
            }))),
...
export const getAlertChannelsResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        channel_type: z.optional(z.enum(['email'])),
        content: z.optional(z.object({
            email: z.optional(z.object({
                email_addresses: z.optional(z.array(z.string()))
            }))
        })),
        created: z.optional(z.iso.datetime()),
        ...
        id: z.optional(z.int()),
        label: z.optional(z.string()),
        type: z.optional(z.enum(['system', 'user'])),
        updated: z.optional(z.iso.datetime()),
...
export const getAlertDefinitionsResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        alert_channels: z.optional(z.array(z.object({
            id: z.optional(z.int()),
            label: z.optional(z.string()),
            type: z.optional(z.enum(['email'])),
            url: z.optional(z.string())
        }))),
        class: z.optional(z.enum(['shared', 'dedicated'])),
        created: z.optional(z.iso.datetime()),
        created_by: z.optional(z.string()),
        description: z.optional(z.string()),
        entity_ids: z.optional(z.array(z.string())),
        has_more_resources: z.optional(z.boolean()),
        id: z.optional(z.int()),
        label: z.optional(z.string()),
        ...
        type: z.optional(z.enum(['user', 'system'])),
        updated: z.optional(z.iso.datetime()),
        updated_by: z.optional(z.string())
    }))),
    page: z.optional(z.int().readonly()),
...
export const getDashboardsAllResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        widgets: z.array(z.object({
            ...
            chart_type: z.optional(z.enum(['line', 'area'])),
            color: z.optional(z.string()),
            label: z.optional(z.string()),
            metric: z.optional(z.string()),
            size: z.optional(z.enum(['6', '12'])),
            unit: z.optional(z.enum([
                '%',
                'Bytes',
                'sec',
...
export const getDashboardsResponseSchema = z.object({
    data: z.array(z.object({
        ...
        label: z.optional(z.string()),
        service_type: z.optional(z.string()),
        type: z.optional(z.enum(['standard'])),
        updated: z.optional(z.iso.datetime()),
...
export const getMonitorInformationResponseSchema = z.object({
    data: z.array(z.object({
        available_aggregate_functions: z.optional(z.array(z.enum([
            'min',
            'max',
            'avg',
            'sum',
        ...
        scrape_interval: z.optional(z.string()),
        unit: z.optional(z.enum([
            '%',
            'Bytes',
            'sec',
...
export const postReadMetricResponseSchema = z.object({
    data: z.object({
        result: z.optional(z.array(z.object({
            metric: z.optional(z.record(z.string(), z.string())),
            values: z.optional(z.array(z.array(z.union([z.int(), z.string()]))).min(1))
        })).min(1)),
        resultType: z.optional(z.enum(['matrix']))
    }),
    isPartial: z.boolean(),
    stats: z.object({
        executionTimeMsec: z.optional(z.int().gte(0)),
        seriesFetched: z.optional(z.string().min(1))
    }),
    status: z.string()
});
...
export const getFirewallTemplatesResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        slug: z.optional(z.enum(['vpc', 'public']))
    }))),
    page: z.optional(z.int().readonly()),
    pages: z.optional(z.int().readonly()),
    results: z.optional(z.int().readonly())
...
export const getIpv6PoolsResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        range: z.optional(z.string().readonly()),
        region: z.optional(z.string().readonly()),
        route_target: z.optional(z.union([
            z.string(),
            z.null()
        ]))
    }))),
...
export const getIpv6RangeResponseSchema = z.object({
    is_bgp: z.optional(z.boolean().readonly()),
    linodes: z.optional(z.array(z.int()).readonly()),
    prefix: z.optional(z.int()),
    range: z.optional(z.string().readonly()),
    region: z.optional(z.string().readonly())
});
...
export const getNodeBalancerStatsResponseSchema = z.object({
    data: z.optional(z.object({
        connections: z.optional(z.array(z.number())),
        traffic: z.optional(z.object({
            in: z.optional(z.array(z.number())),
            out: z.optional(z.array(z.number()))
        }))
    })),
    title: z.optional(z.string())
});
...
export const getObjectStorageBucketAccessResponseSchema = z.object({
    ...
    acl_xml: z.optional(z.string()),
    cors_enabled: z.optional(z.union([
        z.boolean(),
        z.null()
    ])),
    cors_xml: z.optional(z.union([
        z.string(),
        z.null()
    ]))
});
...
export const getObjectStorageBucketContentResponseSchema = z.object({
    ...
    is_truncated: z.optional(z.boolean()),
    next_marker: z.optional(z.union([
        z.string(),
        z.null()
    ]))
});
...
export const getObjectStorageSslResponseSchema = z.object({
    ssl: z.optional(z.boolean().readonly())
});
...
export const getObjectStorageClustersResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        id: z.optional(z.string()),
        region: z.optional(z.string()),
        static_site_domain: z.optional(z.string()),
        status: z.optional(z.enum(['available', 'unavailable']))
    }))),
    page: z.optional(z.int().readonly()),
    pages: z.optional(z.int().readonly()),
    results: z.optional(z.int().readonly())
...
export const getObjectStorageEndpointsResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        region: z.optional(z.string()),
        s3_endpoint: z.optional(z.union([
            z.string(),
            z.null()
        ]))
    })))
...
export const postObjectStorageKeysResponseSchema = z.object({
    access_key: z.optional(z.string().readonly()),
    bucket_access: z.optional(z.array(z.object({
        bucket_name: z.optional(z.string()),
        cluster: z.optional(z.string()),
        permissions: z.optional(z.enum(['read_write', 'read_only'])),
    ...
    id: z.optional(z.int().readonly()),
    label: z.optional(z.string()),
    limited: z.optional(z.boolean().readonly()),
    regions: z.optional(z.array(z.object({
        endpoint_type: z.optional(z.enum([
            'E0',
            'E1',
    ...
    secret_key: z.optional(z.string().readonly())
});
...
export const getObjectStorageQuotasResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        quota_id: z.optional(z.string()),
        quota_limit: z.optional(z.int()),
        quota_name: z.optional(z.enum([
            'Number of Objects',
            'Number of Buckets',
            'Total Capacity'
        ])),
        resource_metric: z.optional(z.enum([
            'bucket',
            'object',
            'byte'
        ])),
...
export const getPlacementGroupsResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        id: z.optional(z.int()),
        is_compliant: z.optional(z.boolean()),
        label: z.optional(z.string().min(1)),
        members: z.optional(z.array(z.object({
            is_compliant: z.optional(z.boolean()),
            linode_id: z.optional(z.int().readonly())
        }))),
        migrations: z.optional(z.union([
            z.object({
                inbound: z.optional(z.array(z.object({
                    linode_id: z.optional(z.int().readonly())
                }))),
...
export const getProfileAppsResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        website: z.optional(z.string().readonly())
    }))),
    page: z.optional(z.int().readonly()),
    pages: z.optional(z.int().readonly()),
    results: z.optional(z.int().readonly())
...
export const getDevicesResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        expiry: z.optional(z.iso.datetime().readonly()),
        id: z.optional(z.int().readonly()),
        last_authenticated: z.optional(z.iso.datetime().readonly()),
        last_remote_addr: z.optional(z.string().readonly()),
        user_agent: z.optional(z.string().readonly())
    }))),
    page: z.optional(z.int().readonly()),
    pages: z.optional(z.int().readonly()),
    results: z.optional(z.int().readonly())
...
export const getSecurityQuestionsResponseSchema = z.object({
    security_questions: z.optional(z.array(z.object({
        id: z.optional(z.int()),
        question: z.optional(z.string().readonly()),
...
export const getRegionsResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        ...
        placement_group_limits: z.optional(z.object({
            maximum_linodes_per_flexible_pg: z.optional(z.union([
                z.int(),
                z.null()
            ])),
            maximum_linodes_per_pg: z.optional(z.union([
                z.int(),
                z.null()
            ])),
            maximum_pgs_per_customer: z.optional(z.union([
                z.int(),
                z.null()
            ]))
        })),
        resolvers: z.optional(z.object({
            ...
            ipv6: z.optional(z.string())
        })),
        site_type: z.optional(z.enum(['core', 'distributed'])),
        status: z.optional(z.enum(['ok', 'outage']))
    }))),
    page: z.optional(z.int().readonly()),
    pages: z.optional(z.int().readonly()),
    results: z.optional(z.int().readonly())
...
export const getTicketsResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        attachments: z.optional(z.array(z.string()).readonly()),
        closable: z.optional(z.boolean()),
        closed: z.optional(z.union([
            z.iso.datetime().readonly(),
            z.null()
        ]).readonly()),
        description: z.optional(z.string().min(1).max(65000).readonly()),
        entity: z.optional(z.union([
            z.object({
                id: z.optional(z.int().readonly()),
                label: z.optional(z.string().readonly()),
        ...
        gravatar_id: z.optional(z.string().readonly()),
        id: z.optional(z.int().readonly()),
        opened: z.optional(z.iso.datetime().readonly()),
        opened_by: z.optional(z.string().readonly()),
        severity: z.optional(z.enum([
            'low',
            'moderate',
            'major'
        ...
        summary: z.optional(z.string().min(1).max(64).readonly()),
        updated: z.optional(z.iso.datetime().readonly()),
...
export const getTicketRepliesResponseSchema = z.object({
    data: z.optional(z.array(z.object({
        created: z.optional(z.iso.datetime().readonly()),
        created_by: z.optional(z.string().readonly()),
        description: z.optional(z.string().readonly()),
        from_linode: z.optional(z.boolean().readonly()),
        gravatar_id: z.optional(z.string().readonly()),
        id: z.optional(z.int().readonly())
    }))),
    page: z.optional(z.int().readonly()),
