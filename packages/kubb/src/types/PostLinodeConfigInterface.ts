...
export const postLinodeConfigInterfacePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostLinodeConfigInterfacePathParamsApiVersionEnumKey = (typeof postLinodeConfigInterfacePathParamsApiVersionEnum)[keyof typeof postLinodeConfigInterfacePathParamsApiVersionEnum];

export interface PostLinodeConfigInterfacePathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostLinodeConfigInterfacePathParamsApiVersionEnumKey;
    /**
...
export const ipv4Nat11Enum8 = {
    "any": "any"
} as const;

export type Ipv4Nat11Enum8Key = (typeof ipv4Nat11Enum8)[keyof typeof ipv4Nat11Enum8];

export const postLinodeConfigInterface200PurposeEnum = {
    "public": "public",
    "vlan": "vlan",
    "vpc": "vpc"
} as const;

export type PostLinodeConfigInterface200PurposeEnumKey = (typeof postLinodeConfigInterface200PurposeEnum)[keyof typeof postLinodeConfigInterface200PurposeEnum];

/**
 * @description Configuration profile interface successfully added.
*/
export interface PostLinodeConfigInterface200 {
    /**
    ...
    */
    ipv4?: {
         ...
         * @type string
        */
        nat_1_1?: (string | Ipv4Nat11Enum8Key) | null;
        /**
    ...
    */
     ...
     * @type string
    */
    purpose: PostLinodeConfigInterface200PurposeEnumKey;
    /**
...
*/
export interface PostLinodeConfigInterfaceError {
    /**
...
export const ipv4Nat11Enum9 = {
    "any": "any"
} as const;

export type Ipv4Nat11Enum9Key = (typeof ipv4Nat11Enum9)[keyof typeof ipv4Nat11Enum9];

export const postLinodeConfigInterfaceMutationRequestPurposeEnum = {
    "public": "public",
    "vlan": "vlan",
    "vpc": "vpc"
} as const;

export type PostLinodeConfigInterfaceMutationRequestPurposeEnumKey = (typeof postLinodeConfigInterfaceMutationRequestPurposeEnum)[keyof typeof postLinodeConfigInterfaceMutationRequestPurposeEnum];

export type PostLinodeConfigInterfaceMutationRequest = (any & {
    /**
     * @description __Read-only__ Returns `true` if the interface is in use, meaning that the Linode has been booted using the configuration profile to which the interface belongs.
     * @type boolean | undefined
    */
    ...
    */
    ipv4?: {
         ...
         * @type string
        */
        nat_1_1?: (string | Ipv4Nat11Enum9Key) | null;
        /**
         * @description The VPC subnet IPv4 address for this interface.\n\n- This only applies to interfaces with a `purpose` of `vpc`.\n\n- Returned as an empty string (`\"\"`) for non-`vpc` type interfaces.\n\nWhen included in a request:\n\n- The `vpc` can\'t be assigned to an existing Linode as an address or in a range.\n\n- The target address can\'t be the first two or last two addresses in the subnet IPv4 range.\n\n- If omitted, a valid address within the Subnet IPv4 range is automatically assigned.
         * @type string, ip
        */
    ...
    */
     ...
     * @type string
    */
    purpose: PostLinodeConfigInterfaceMutationRequestPurposeEnumKey;
    /**
     * @description The `id` of the VPC subnet for this interface. Use this value in a request to assign a Linode to a VPC subnet.\n\n- Required for `vpc` type interfaces.\n\n- Returned as `null` for non-`vpc` type interfaces.\n\n- Once you\'ve assigned a VPC subnet to an interface, you can\'t update it.\n\n- You need to reboot a Linode using the interface\'s configuration profile to assign the Linode to a VPC subnet.
     * @type integer
    */
...
export type PostLinodeConfigInterfaceMutationResponse = PostLinodeConfigInterface200;

export type PostLinodeConfigInterfaceMutation = {
    Response: PostLinodeConfigInterface200;
    Request: PostLinodeConfigInterfaceMutationRequest;
    PathParams: PostLinodeConfigInterfacePathParams;
    Errors: any;
};