...
export const getFirewallsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetFirewallsPathParamsApiVersionEnumKey = (typeof getFirewallsPathParamsApiVersionEnum)[keyof typeof getFirewallsPathParamsApiVersionEnum];

export interface GetFirewallsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetFirewallsPathParamsApiVersionEnumKey;
}
...
export type GetFirewallsQuery = {
    ...
    PathParams: GetFirewallsPathParams;
