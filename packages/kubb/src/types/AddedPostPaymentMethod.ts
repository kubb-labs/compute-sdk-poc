...
export const addedPostPaymentMethodTypeEnum = {
    "credit_card": "credit_card"
} as const;

export type AddedPostPaymentMethodTypeEnumKey = (typeof addedPostPaymentMethodTypeEnum)[keyof typeof addedPostPaymentMethodTypeEnum];

/**
 * @description Payment Method Request Object.
*/
export interface AddedPostPaymentMethod {
    /**
    ...
    */
     ...
     * @type string
    */
    type: AddedPostPaymentMethodTypeEnumKey;
}