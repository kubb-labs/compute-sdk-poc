...
export const xFilterorderEnum2 = {
    "asc": "asc",
    "desc": "desc"
} as const;

export type XFilterorderEnum2Key = (typeof xFilterorderEnum2)[keyof typeof xFilterorderEnum2];

export interface GetEventsHeaderParams {
    /**
...
export type DataActionEnum2Key = (typeof dataActionEnum2)[keyof typeof dataActionEnum2];

export const detailsDescriptionEnum3 = {
    "Scheduled Maintenance": "Scheduled Maintenance",
    "Emergency Maintenance": "Emergency Maintenance"
} as const;

export type DetailsDescriptionEnum3Key = (typeof detailsDescriptionEnum3)[keyof typeof detailsDescriptionEnum3];

export const detailsSourceEnum3 = {
    "platform": "platform",
    "user": "user"
} as const;

export type DetailsSourceEnum3Key = (typeof detailsSourceEnum3)[keyof typeof detailsSourceEnum3];

export const entityTypeEnum5 = {
    "account": "account",
    "backups": "backups",
    "community": "community",
    "disks": "disks",
...
export type EntityTypeEnum5Key = (typeof entityTypeEnum5)[keyof typeof entityTypeEnum5];
...
export type DataStatusEnum8Key = (typeof dataStatusEnum8)[keyof typeof dataStatusEnum8];
