...
export const postAttachVolumePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostAttachVolumePathParamsApiVersionEnumKey = (typeof postAttachVolumePathParamsApiVersionEnum)[keyof typeof postAttachVolumePathParamsApiVersionEnum];
...
export interface PostAttachVolumePathParams {
     ...
     * @type string
    */
    apiVersion: PostAttachVolumePathParamsApiVersionEnumKey;
    /**
