...
*/
export interface PutVpcMutationRequest {
    /**
     * @description A written description to help distinguish the VPC.
     * @maxLength 255
     * @default ""
...
export type PutVpcMutationResponse = PutVpc200;

export type PutVpcMutation = {
    Response: PutVpc200;
    Request: PutVpcMutationRequest;
    PathParams: PutVpcPathParams;
    Errors: any;
};