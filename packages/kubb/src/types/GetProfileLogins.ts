...
export const getProfileLoginsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetProfileLoginsPathParamsApiVersionEnumKey = (typeof getProfileLoginsPathParamsApiVersionEnum)[keyof typeof getProfileLoginsPathParamsApiVersionEnum];

export interface GetProfileLoginsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetProfileLoginsPathParamsApiVersionEnumKey;
}
...
export type GetProfileLoginsQuery = {
    ...
    PathParams: GetProfileLoginsPathParams;
    Errors: any;
};