...
export const postGroupAddLinodePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostGroupAddLinodePathParamsApiVersionEnumKey = (typeof postGroupAddLinodePathParamsApiVersionEnum)[keyof typeof postGroupAddLinodePathParamsApiVersionEnum];

export interface PostGroupAddLinodePathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostGroupAddLinodePathParamsApiVersionEnumKey;
    /**
...
export const postGroupAddLinode200PlacementGroupPolicyEnum = {
    "strict": "strict",
    "flexible": "flexible"
} as const;

export type PostGroupAddLinode200PlacementGroupPolicyEnumKey = (typeof postGroupAddLinode200PlacementGroupPolicyEnum)[keyof typeof postGroupAddLinode200PlacementGroupPolicyEnum];

export const postGroupAddLinode200PlacementGroupTypeEnum = {
    "anti_affinity:local": "anti_affinity:local"
} as const;

export type PostGroupAddLinode200PlacementGroupTypeEnumKey = (typeof postGroupAddLinode200PlacementGroupTypeEnum)[keyof typeof postGroupAddLinode200PlacementGroupTypeEnum];

/**
 * @description The Linode was added successfully.
*/
export interface PostGroupAddLinode200 {
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    placement_group_policy?: PostGroupAddLinode200PlacementGroupPolicyEnumKey;
    /**
     ...
     * @type string | undefined
    */
    readonly placement_group_type?: PostGroupAddLinode200PlacementGroupTypeEnumKey;
    /**
...
*/
export interface PostGroupAddLinodeError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export interface PostGroupAddLinodeMutationRequest {
    /**
...
export type PostGroupAddLinodeMutationResponse = PostGroupAddLinode200;

export type PostGroupAddLinodeMutation = {
    Response: PostGroupAddLinode200;
    Request: PostGroupAddLinodeMutationRequest;
    PathParams: PostGroupAddLinodePathParams;
    Errors: any;
};