...
export const postDatabasesMysqlInstancesPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostDatabasesMysqlInstancesPathParamsApiVersionEnumKey = (typeof postDatabasesMysqlInstancesPathParamsApiVersionEnum)[keyof typeof postDatabasesMysqlInstancesPathParamsApiVersionEnum];

export interface PostDatabasesMysqlInstancesPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostDatabasesMysqlInstancesPathParamsApiVersionEnumKey;
}

export const postDatabasesMysqlInstances200ClusterSizeEnum = {
    "1": 1,
    "2": 2,
    "3": 3
} as const;

export type PostDatabasesMysqlInstances200ClusterSizeEnumKey = (typeof postDatabasesMysqlInstances200ClusterSizeEnum)[keyof typeof postDatabasesMysqlInstances200ClusterSizeEnum];

export const mysqlInternalTmpMemStorageEngineEnum = {
    "TempTable": "TempTable",
    "MEMORY": "MEMORY"
} as const;

export type MysqlInternalTmpMemStorageEngineEnumKey = (typeof mysqlInternalTmpMemStorageEngineEnum)[keyof typeof mysqlInternalTmpMemStorageEngineEnum];

export const postDatabasesMysqlInstances200PlatformEnum = {
    "rdbms-legacy": "rdbms-legacy",
    "rdbms-default": "rdbms-default"
} as const;

export type PostDatabasesMysqlInstances200PlatformEnumKey = (typeof postDatabasesMysqlInstances200PlatformEnum)[keyof typeof postDatabasesMysqlInstances200PlatformEnum];

export const postDatabasesMysqlInstances200StatusEnum = {
...
export type PostDatabasesMysqlInstances200StatusEnumKey = (typeof postDatabasesMysqlInstances200StatusEnum)[keyof typeof postDatabasesMysqlInstances200StatusEnum];

export const updatesFrequencyEnum2 = {
    "weekly": "weekly"
} as const;

export type UpdatesFrequencyEnum2Key = (typeof updatesFrequencyEnum2)[keyof typeof updatesFrequencyEnum2];

/**
 * @description A new MySQL Managed Database is deploying.
*/
export interface PostDatabasesMysqlInstances200 {
    /**
    ...
    */
    cluster_size?: PostDatabasesMysqlInstances200ClusterSizeEnumKey;
    /**
        ...
        */
        mysql?: {
            ...
            */
             ...
             * @type string | undefined
            */
            internal_tmp_mem_storage_engine?: MysqlInternalTmpMemStorageEngineEnumKey;
            /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly platform?: PostDatabasesMysqlInstances200PlatformEnumKey;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly status?: PostDatabasesMysqlInstances200StatusEnumKey;
    /**
    ...
    */
    updates?: {
        ...
        */
         ...
         * @type string | undefined
        */
        frequency?: UpdatesFrequencyEnum2Key;
        /**
...
*/
export interface PostDatabasesMysqlInstancesError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export const postDatabasesMysqlInstancesMutationRequestClusterSizeEnum = {
    "1": 1,
    "2": 2,
    "3": 3
} as const;

export type PostDatabasesMysqlInstancesMutationRequestClusterSizeEnumKey = (typeof postDatabasesMysqlInstancesMutationRequestClusterSizeEnum)[keyof typeof postDatabasesMysqlInstancesMutationRequestClusterSizeEnum];

export const mysqlInternalTmpMemStorageEngineEnum2 = {
    "TempTable": "TempTable",
    "MEMORY": "MEMORY"
} as const;

export type MysqlInternalTmpMemStorageEngineEnum2Key = (typeof mysqlInternalTmpMemStorageEngineEnum2)[keyof typeof mysqlInternalTmpMemStorageEngineEnum2];

export interface PostDatabasesMysqlInstancesMutationRequest {
    /**
     * @description Controls access to the Managed Database.\n\n- Individually included IP addresses or CIDR ranges can access the Managed Database while all other sources are blocked.\n\n- A standalone value of `0.0.0.0/0` allows all IP addresses access to the Managed Database.\n\n- An empty array (`[]`) blocks all public and private connections to the Managed Database.
     * @type array | undefined
    */
     ...
     * @type integer | undefined
    */
    cluster_size?: PostDatabasesMysqlInstancesMutationRequestClusterSizeEnumKey;
    /**
        ...
        */
        mysql?: {
            ...
            */
             ...
             * @type string | undefined
            */
            internal_tmp_mem_storage_engine?: MysqlInternalTmpMemStorageEngineEnum2Key;
            /**
             * @description Size of the largest message in bytes that can be received by the server.
             * @minLength 102400
             * @maxLength 1073741824
    ...
    */
    fork?: {
        ...
        */
        restore_time?: string;
        /**
         * @description The unique instance id for the database to fork from. Run the [List Managed Databases](https://techdocs.akamai.com/linode-api/reference/get-databases-instances) operation and store the unique `id` for the target Managed Database.
         * @type integer
        */
        source: number;
    };
    ...
    */
    label: string;
    /**
     * @description __Beta__ Restricts access on a MySQL Managed Database to a specific Virtual Private Cloud (VPC) configured for the cluster.
     * @type object
    */
    private_network?: {
        /**
        ...
        */
        public_access?: boolean;
        /**
         * @description If the `vpc_id` includes multiple subnets, specify the `subnet_id` you want to use to control access to the database. Use the [List VPCs](https://techdocs.akamai.com/linode-api/reference/get-vpcs) operation to find and store the `id` of the relevant subnet object.\n\n> 📘\n>\n> A VPC needs at least one subnet to assign a Manage Database instance.
         * @type integer | undefined
        */
        subnet_id?: number;
        /**
...
export type PostDatabasesMysqlInstancesMutationResponse = PostDatabasesMysqlInstances200;

export type PostDatabasesMysqlInstancesMutation = {
    Response: PostDatabasesMysqlInstances200;
    Request: PostDatabasesMysqlInstancesMutationRequest;
    PathParams: PostDatabasesMysqlInstancesPathParams;
    Errors: any;
};