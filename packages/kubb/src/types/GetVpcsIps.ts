...
export const getVpcsIpsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetVpcsIpsPathParamsApiVersionEnumKey = (typeof getVpcsIpsPathParamsApiVersionEnum)[keyof typeof getVpcsIpsPathParamsApiVersionEnum];

export interface GetVpcsIpsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetVpcsIpsPathParamsApiVersionEnumKey;
}

export interface GetVpcsIpsQueryParams {
    /**
...
*/
export interface GetVpcsIps200 {
    /**
...
*/
export interface GetVpcsIpsError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetVpcsIpsQueryResponse = GetVpcsIps200;

export type GetVpcsIpsQuery = {
    Response: GetVpcsIps200;
    PathParams: GetVpcsIpsPathParams;
    QueryParams: GetVpcsIpsQueryParams;
    Errors: any;
};