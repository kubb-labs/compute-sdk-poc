...
export const getPersonalAccessTokensPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetPersonalAccessTokensPathParamsApiVersionEnumKey = (typeof getPersonalAccessTokensPathParamsApiVersionEnum)[keyof typeof getPersonalAccessTokensPathParamsApiVersionEnum];

export interface GetPersonalAccessTokensPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetPersonalAccessTokensPathParamsApiVersionEnumKey;
}

/**
 * @description A paginated list of active tokens.
*/
export interface GetPersonalAccessTokens200 {
    /**
...
*/
export interface GetPersonalAccessTokensError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetPersonalAccessTokensQueryResponse = GetPersonalAccessTokens200;

export type GetPersonalAccessTokensQuery = {
    Response: GetPersonalAccessTokens200;
    PathParams: GetPersonalAccessTokensPathParams;
    Errors: any;
};