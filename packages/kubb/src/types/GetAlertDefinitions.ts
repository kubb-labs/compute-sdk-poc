...
export const getAlertDefinitionsPathParamsApiVersionEnum = {
    "v4beta": "v4beta"
} as const;

export type GetAlertDefinitionsPathParamsApiVersionEnumKey = (typeof getAlertDefinitionsPathParamsApiVersionEnum)[keyof typeof getAlertDefinitionsPathParamsApiVersionEnum];

export interface GetAlertDefinitionsPathParams {
    /**
     * @description __Enum__ Call the `v4beta` URL for operations still only in beta.
     * @type string
    */
    apiVersion: GetAlertDefinitionsPathParamsApiVersionEnumKey;
}

export const alertChannelsTypeEnum = {
    "email": "email"
} as const;

export type AlertChannelsTypeEnumKey = (typeof alertChannelsTypeEnum)[keyof typeof alertChannelsTypeEnum];

export const dataClassEnum3 = {
    "shared": "shared",
    "dedicated": "dedicated"
} as const;

export type DataClassEnum3Key = (typeof dataClassEnum3)[keyof typeof dataClassEnum3];

export const rulesAggregateFunctionEnum = {
    "avg": "avg",
    "sum": "sum",
    "min": "min",
    "max": "max"
...
export type RulesAggregateFunctionEnumKey = (typeof rulesAggregateFunctionEnum)[keyof typeof rulesAggregateFunctionEnum];

export const dimensionFiltersOperatorEnum = {
    "eq": "eq",
    "neq": "neq",
...
export type DimensionFiltersOperatorEnumKey = (typeof dimensionFiltersOperatorEnum)[keyof typeof dimensionFiltersOperatorEnum];
...
export type RulesUnitEnumKey = (typeof rulesUnitEnum)[keyof typeof rulesUnitEnum];

export const dataSeverityEnum3 = {
    "0": 0,
    "1": 1,
    "2": 2,
    "3": 3
...
export type DataSeverityEnum3Key = (typeof dataSeverityEnum3)[keyof typeof dataSeverityEnum3];

export const dataStatusEnum29 = {
    "enabled": "enabled",
    "disabled": "disabled",
...
export type DataStatusEnum29Key = (typeof dataStatusEnum29)[keyof typeof dataStatusEnum29];

export const triggerConditionsCriteriaConditionEnum = {
    "ALL": "ALL"
} as const;

export type TriggerConditionsCriteriaConditionEnumKey = (typeof triggerConditionsCriteriaConditionEnum)[keyof typeof triggerConditionsCriteriaConditionEnum];
...
export type DataTypeEnum17Key = (typeof dataTypeEnum17)[keyof typeof dataTypeEnum17];

/**
 * @description Returns a paginated list of all alert definitions.
*/
export interface GetAlertDefinitions200 {
    /**
    ...
    data?: {
        ...
        rule_criteria?: {
            ...
            */
            rules?: {
                 ...
                 * @type string | undefined
                */
                aggregate_function?: RulesAggregateFunctionEnumKey;
                /**
                ...
                */
                dimension_filters?: {
                    ...
                    */
                     ...
                     * @type string | undefined
                    */
                    operator?: DimensionFiltersOperatorEnumKey;
                    /**
        ...
        */
        trigger_conditions?: {
             ...
             * @type string | undefined
            */
            criteria_condition?: TriggerConditionsCriteriaConditionEnumKey;
            /**
...
*/
export interface GetAlertDefinitionsError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetAlertDefinitionsQueryResponse = GetAlertDefinitions200;

export type GetAlertDefinitionsQuery = {
    Response: GetAlertDefinitions200;
    PathParams: GetAlertDefinitionsPathParams;
    Errors: any;
};