...
export const postAllocateIpPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostAllocateIpPathParamsApiVersionEnumKey = (typeof postAllocateIpPathParamsApiVersionEnum)[keyof typeof postAllocateIpPathParamsApiVersionEnum];

export interface PostAllocateIpPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostAllocateIpPathParamsApiVersionEnumKey;
}

export const postAllocateIp200TypeEnum = {
    "ipv4": "ipv4",
    "ipv6": "ipv6",
    "ipv6/pool": "ipv6/pool",
...
export type PostAllocateIp200TypeEnumKey = (typeof postAllocateIp200TypeEnum)[keyof typeof postAllocateIp200TypeEnum];

/**
 * @description IP Address allocated successfully.
*/
export interface PostAllocateIp200 {
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly type?: PostAllocateIp200TypeEnumKey;
    /**
...
*/
export interface PostAllocateIpError {
    /**
...
export const postAllocateIpMutationRequestTypeEnum = {
    "ipv4": "ipv4"
} as const;

export type PostAllocateIpMutationRequestTypeEnumKey = (typeof postAllocateIpMutationRequestTypeEnum)[keyof typeof postAllocateIpMutationRequestTypeEnum];

/**
 * @description Information about the address you are creating.
*/
export interface PostAllocateIpMutationRequest {
    /**
    ...
    */
     ...
     * @type string
    */
    type: PostAllocateIpMutationRequestTypeEnumKey;
}

export type PostAllocateIpMutationResponse = PostAllocateIp200;

export type PostAllocateIpMutation = {
    Response: PostAllocateIp200;
    Request: PostAllocateIpMutationRequest;
    PathParams: PostAllocateIpPathParams;
    Errors: any;
};