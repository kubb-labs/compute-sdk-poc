...
export const postNodeBalancerPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostNodeBalancerPathParamsApiVersionEnumKey = (typeof postNodeBalancerPathParamsApiVersionEnum)[keyof typeof postNodeBalancerPathParamsApiVersionEnum];

export interface PostNodeBalancerPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostNodeBalancerPathParamsApiVersionEnumKey;
}
...
export type PostNodeBalancerMutation = {
    ...
    PathParams: PostNodeBalancerPathParams;
    Errors: any;
};