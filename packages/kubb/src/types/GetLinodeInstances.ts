...
export const xFilterorderEnum5 = {
    "asc": "asc",
    "desc": "desc"
} as const;

export type XFilterorderEnum5Key = (typeof xFilterorderEnum5)[keyof typeof xFilterorderEnum5];

export interface GetLinodeInstancesHeaderParams {
    /**
...
export type ScheduleDayEnum2Key = (typeof scheduleDayEnum2)[keyof typeof scheduleDayEnum2];

export const scheduleWindowEnum2 = {
    "Scheduling": "Scheduling",
    "W0": "W0",
    "W2": "W2",
    "W4": "W4",
...
export type ScheduleWindowEnum2Key = (typeof scheduleWindowEnum2)[keyof typeof scheduleWindowEnum2];

export const dataDiskEncryptionEnum = {
    "enabled": "enabled",
    "disabled": "disabled"
} as const;

export type DataDiskEncryptionEnumKey = (typeof dataDiskEncryptionEnum)[keyof typeof dataDiskEncryptionEnum];

export const dataHypervisorEnum = {
    "kvm": "kvm"
} as const;

export type DataHypervisorEnumKey = (typeof dataHypervisorEnum)[keyof typeof dataHypervisorEnum];

export const dataInterfaceGenerationEnum = {
    "legacy_config": "legacy_config",
    "linode": "linode"
} as const;

export type DataInterfaceGenerationEnumKey = (typeof dataInterfaceGenerationEnum)[keyof typeof dataInterfaceGenerationEnum];

export const dataMaintenancePolicyEnum = {
    "linode/migrate": "linode/migrate",
    "linode/power_off_on": "linode/power_off_on"
} as const;

export type DataMaintenancePolicyEnumKey = (typeof dataMaintenancePolicyEnum)[keyof typeof dataMaintenancePolicyEnum];

export const placementGroupPlacementGroupPolicyEnum2 = {
    "strict": "strict",
    "flexible": "flexible"
} as const;

export type PlacementGroupPlacementGroupPolicyEnum2Key = (typeof placementGroupPlacementGroupPolicyEnum2)[keyof typeof placementGroupPlacementGroupPolicyEnum2];

export const placementGroupPlacementGroupTypeEnum2 = {
    "anti_affinity:local": "anti_affinity:local"
} as const;

export type PlacementGroupPlacementGroupTypeEnum2Key = (typeof placementGroupPlacementGroupTypeEnum2)[keyof typeof placementGroupPlacementGroupTypeEnum2];

export const dataStatusEnum22 = {
    "running": "running",
    "offline": "offline",
    "booting": "booting",
    "busy": "busy",
...
export type DataStatusEnum22Key = (typeof dataStatusEnum22)[keyof typeof dataStatusEnum22];
...
export type GetLinodeInstancesQueryResponse = GetLinodeInstances200;
