...
export const putLinodeInterfaceSettingsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutLinodeInterfaceSettingsPathParamsApiVersionEnumKey = (typeof putLinodeInterfaceSettingsPathParamsApiVersionEnum)[keyof typeof putLinodeInterfaceSettingsPathParamsApiVersionEnum];

export interface PutLinodeInterfaceSettingsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PutLinodeInterfaceSettingsPathParamsApiVersionEnumKey;
    /**
...
*/
export interface PutLinodeInterfaceSettings200 {
    /**
...
*/
export interface PutLinodeInterfaceSettingsError {
    /**
     * @type array | undefined
    */
    errors?: {
...
*/
export interface PutLinodeInterfaceSettingsMutationRequest {
    /**
     * @description Interfaces used for the IPv4 `default_route` and IPv6 `default_route` when multiple interfaces are eligible for the role.
     * @type object | undefined
    */
...
export type PutLinodeInterfaceSettingsMutationResponse = PutLinodeInterfaceSettings200;

export type PutLinodeInterfaceSettingsMutation = {
    Response: PutLinodeInterfaceSettings200;
    Request: PutLinodeInterfaceSettingsMutationRequest;
    PathParams: PutLinodeInterfaceSettingsPathParams;
    Errors: any;
};