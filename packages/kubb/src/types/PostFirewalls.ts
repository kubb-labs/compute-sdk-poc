...
export const postFirewallsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostFirewallsPathParamsApiVersionEnumKey = (typeof postFirewallsPathParamsApiVersionEnum)[keyof typeof postFirewallsPathParamsApiVersionEnum];

export interface PostFirewallsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostFirewallsPathParamsApiVersionEnumKey;
}
...
export type PostFirewallsMutation = {
    ...
    PathParams: PostFirewallsPathParams;
    Errors: any;
};