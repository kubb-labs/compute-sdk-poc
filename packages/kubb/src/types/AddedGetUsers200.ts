...
export const lastLoginStatusEnum2 = {
    "successful": "successful",
    "failed": "failed"
} as const;

export type LastLoginStatusEnum2Key = (typeof lastLoginStatusEnum2)[keyof typeof lastLoginStatusEnum2];

export const dataUserTypeEnum = {
    "parent": "parent",
    "child": "child",
    "proxy": "proxy",
    "default": "default"
...
export type DataUserTypeEnumKey = (typeof dataUserTypeEnum)[keyof typeof dataUserTypeEnum];

export interface AddedGetUsers200 {
    /**
    ...
    data?: {
        ...
        */
        readonly last_login?: {
            ...
            */
            readonly status?: LastLoginStatusEnum2Key;
        } | null;
        /**
        ...
        */
         ...
         * @type string | undefined
        */
        readonly user_type?: DataUserTypeEnumKey;
    }[];
    /**
