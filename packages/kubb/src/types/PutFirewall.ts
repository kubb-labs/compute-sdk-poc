...
export const putFirewallPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutFirewallPathParamsApiVersionEnumKey = (typeof putFirewallPathParamsApiVersionEnum)[keyof typeof putFirewallPathParamsApiVersionEnum];

export interface PutFirewallPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PutFirewallPathParamsApiVersionEnumKey;
    /**
...
export const parentEntityTypeEnum8 = {
    "linode": "linode"
} as const;

export type ParentEntityTypeEnum8Key = (typeof parentEntityTypeEnum8)[keyof typeof parentEntityTypeEnum8];

export const entitiesTypeEnum8 = {
    "linode": "linode",
    "linode_interface": "linode_interface",
    "nodebalancer": "nodebalancer"
} as const;

export type EntitiesTypeEnum8Key = (typeof entitiesTypeEnum8)[keyof typeof entitiesTypeEnum8];

export const inboundActionEnum10 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type InboundActionEnum10Key = (typeof inboundActionEnum10)[keyof typeof inboundActionEnum10];

export const inboundProtocolEnum10 = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type InboundProtocolEnum10Key = (typeof inboundProtocolEnum10)[keyof typeof inboundProtocolEnum10];

export const rulesInboundPolicyEnum10 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesInboundPolicyEnum10Key = (typeof rulesInboundPolicyEnum10)[keyof typeof rulesInboundPolicyEnum10];

export const outboundActionEnum10 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type OutboundActionEnum10Key = (typeof outboundActionEnum10)[keyof typeof outboundActionEnum10];

export const outboundProtocolEnum10 = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type OutboundProtocolEnum10Key = (typeof outboundProtocolEnum10)[keyof typeof outboundProtocolEnum10];

export const rulesOutboundPolicyEnum10 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesOutboundPolicyEnum10Key = (typeof rulesOutboundPolicyEnum10)[keyof typeof rulesOutboundPolicyEnum10];

export const putFirewall200StatusEnum = {
    "enabled": "enabled",
    "disabled": "disabled",
    "deleted": "deleted"
} as const;

export type PutFirewall200StatusEnumKey = (typeof putFirewall200StatusEnum)[keyof typeof putFirewall200StatusEnum];

/**
 * @description Firewall updated successfully.
*/
export interface PutFirewall200 {
    /**
    ...
    */
    rules?: {
        ...
        */
        inbound?: {
            ...
            */
             ...
             * @type string | undefined
            */
            protocol?: InboundProtocolEnum10Key;
        }[];
        /**
         ...
         * @type string | undefined
        */
        inbound_policy?: RulesInboundPolicyEnum10Key;
        /**
        ...
        */
        outbound?: {
             ...
             * @type string | undefined
            */
            action?: OutboundActionEnum10Key;
            /**
             * @description The IPv4 or IPv6 addresses affected by this rule. A rule can have up to 255 total addresses or networks listed across its `ipv4` and `ipv6` arrays. A network and a single IP are treated as equivalent when accounting for this limit.\n\nMust contain `ipv4`, `ipv6`, or both.
             * @type object | undefined
            */
            ...
            */
             ...
             * @type string | undefined
            */
            protocol?: OutboundProtocolEnum10Key;
        }[];
        /**
         ...
         * @type string | undefined
        */
        outbound_policy?: RulesOutboundPolicyEnum10Key;
        /**
     ...
     * @type string | undefined
    */
    readonly status?: PutFirewall200StatusEnumKey;
    /**
...
*/
export interface PutFirewallError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export const putFirewallMutationRequestStatusEnum = {
    "enabled": "enabled",
    "disabled": "disabled"
} as const;

export type PutFirewallMutationRequestStatusEnumKey = (typeof putFirewallMutationRequestStatusEnum)[keyof typeof putFirewallMutationRequestStatusEnum];

export interface PutFirewallMutationRequest {
    /**
     * @description __Filterable__ The Firewall\'s label, for display purposes only.\n\nFirewall labels have the following constraints:\n\n  - Must begin and end with an alphanumeric character.\n  - May only consist of alphanumeric characters, hyphens (`-`), underscores (`_`) or periods (`.`).\n  - Cannot have two hyphens (`--`), underscores (`__`) or periods (`..`) in a row.\n  - Must be between 3 and 32 characters.\n  - Must be unique.
     * @minLength 3
     * @maxLength 32
    ...
    */
     ...
     * @type string | undefined
    */
    status?: PutFirewallMutationRequestStatusEnumKey;
    /**
     * @description __Filterable__ An array of tags applied to this object. Tags are for organizational purposes only.
     * @type array | undefined
    */
...
export type PutFirewallMutationResponse = PutFirewall200;

export type PutFirewallMutation = {
    Response: PutFirewall200;
    Request: PutFirewallMutationRequest;
    PathParams: PutFirewallPathParams;
    Errors: any;
};