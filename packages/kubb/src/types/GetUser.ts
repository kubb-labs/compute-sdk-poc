...
export const getUserPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetUserPathParamsApiVersionEnumKey = (typeof getUserPathParamsApiVersionEnum)[keyof typeof getUserPathParamsApiVersionEnum];
...
export interface GetUserPathParams {
     ...
     * @type string
    */
    apiVersion: GetUserPathParamsApiVersionEnumKey;
    /**
...
export const lastLoginStatusEnum9 = {
    "successful": "successful",
    "failed": "failed"
} as const;

export type LastLoginStatusEnum9Key = (typeof lastLoginStatusEnum9)[keyof typeof lastLoginStatusEnum9];

export const getUser200UserTypeEnum = {
    "parent": "parent",
    "child": "child",
    "proxy": "proxy",
    "default": "default"
...
export type GetUser200UserTypeEnumKey = (typeof getUser200UserTypeEnum)[keyof typeof getUser200UserTypeEnum];

/**
 * @description The requested User object.
*/
export interface GetUser200 {
    /**
    ...
    */
    readonly last_login?: {
        ...
        */
        readonly status?: LastLoginStatusEnum9Key;
    } | null;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly user_type?: GetUser200UserTypeEnumKey;
}
