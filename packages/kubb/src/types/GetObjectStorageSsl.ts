...
export const getObjectStorageSslPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetObjectStorageSslPathParamsApiVersionEnumKey = (typeof getObjectStorageSslPathParamsApiVersionEnum)[keyof typeof getObjectStorageSslPathParamsApiVersionEnum];
...
export interface GetObjectStorageSslPathParams {
     ...
     * @type string
    */
    apiVersion: GetObjectStorageSslPathParamsApiVersionEnumKey;
    /**
