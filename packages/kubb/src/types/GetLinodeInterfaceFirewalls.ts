...
export const getLinodeInterfaceFirewallsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLinodeInterfaceFirewallsPathParamsApiVersionEnumKey = (typeof getLinodeInterfaceFirewallsPathParamsApiVersionEnum)[keyof typeof getLinodeInterfaceFirewallsPathParamsApiVersionEnum];

export interface GetLinodeInterfaceFirewallsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetLinodeInterfaceFirewallsPathParamsApiVersionEnumKey;
    /**
...
export const parentEntityTypeEnum3 = {
    "linode": "linode"
} as const;

export type ParentEntityTypeEnum3Key = (typeof parentEntityTypeEnum3)[keyof typeof parentEntityTypeEnum3];

export const entitiesTypeEnum3 = {
    "linode": "linode",
    "linode_interface": "linode_interface",
    "nodebalancer": "nodebalancer"
} as const;

export type EntitiesTypeEnum3Key = (typeof entitiesTypeEnum3)[keyof typeof entitiesTypeEnum3];

export const inboundActionEnum3 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type InboundActionEnum3Key = (typeof inboundActionEnum3)[keyof typeof inboundActionEnum3];

export const inboundProtocolEnum3 = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type InboundProtocolEnum3Key = (typeof inboundProtocolEnum3)[keyof typeof inboundProtocolEnum3];

export const rulesInboundPolicyEnum3 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesInboundPolicyEnum3Key = (typeof rulesInboundPolicyEnum3)[keyof typeof rulesInboundPolicyEnum3];

export const outboundActionEnum3 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type OutboundActionEnum3Key = (typeof outboundActionEnum3)[keyof typeof outboundActionEnum3];

export const outboundProtocolEnum3 = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type OutboundProtocolEnum3Key = (typeof outboundProtocolEnum3)[keyof typeof outboundProtocolEnum3];

export const rulesOutboundPolicyEnum3 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesOutboundPolicyEnum3Key = (typeof rulesOutboundPolicyEnum3)[keyof typeof rulesOutboundPolicyEnum3];

export const dataStatusEnum26 = {
    "enabled": "enabled",
    "disabled": "disabled",
    "deleted": "deleted"
} as const;

export type DataStatusEnum26Key = (typeof dataStatusEnum26)[keyof typeof dataStatusEnum26];

/**
 * @description Returns a paginated list of firewalls assigned to an interface.
*/
export interface GetLinodeInterfaceFirewalls200 {
    /**
    ...
    */
    data?: {
        ...
        */
            ...
            */
            inbound?: {
                ...
                */
                 ...
                 * @type string | undefined
                */
                protocol?: InboundProtocolEnum3Key;
            }[];
            /**
             ...
             * @type string | undefined
            */
            inbound_policy?: RulesInboundPolicyEnum3Key;
            /**
            ...
            */
            outbound?: {
                ...
                */
                 ...
                 * @type string | undefined
                */
                protocol?: OutboundProtocolEnum3Key;
            }[];
            /**
             ...
             * @type string | undefined
            */
            outbound_policy?: RulesOutboundPolicyEnum3Key;
            /**
         ...
         * @type string | undefined
        */
        readonly status?: DataStatusEnum26Key;
        /**
...
*/
export interface GetLinodeInterfaceFirewallsError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetLinodeInterfaceFirewallsQueryResponse = GetLinodeInterfaceFirewalls200;

export type GetLinodeInterfaceFirewallsQuery = {
    Response: GetLinodeInterfaceFirewalls200;
    PathParams: GetLinodeInterfaceFirewallsPathParams;
    Errors: any;
};