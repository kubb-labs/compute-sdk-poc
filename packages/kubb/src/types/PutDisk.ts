...
export const putDiskPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutDiskPathParamsApiVersionEnumKey = (typeof putDiskPathParamsApiVersionEnum)[keyof typeof putDiskPathParamsApiVersionEnum];
...
export interface PutDiskPathParams {
     ...
     * @type string
    */
    apiVersion: PutDiskPathParamsApiVersionEnumKey;
    /**
