...
export const getDomainPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetDomainPathParamsApiVersionEnumKey = (typeof getDomainPathParamsApiVersionEnum)[keyof typeof getDomainPathParamsApiVersionEnum];

export interface GetDomainPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetDomainPathParamsApiVersionEnumKey;
    /**
...
export const getDomain200StatusEnum = {
    "disabled": "disabled",
    "active": "active"
} as const;

export type GetDomain200StatusEnumKey = (typeof getDomain200StatusEnum)[keyof typeof getDomain200StatusEnum];

export const getDomain200TypeEnum = {
    "master": "master",
    "slave": "slave"
} as const;

export type GetDomain200TypeEnumKey = (typeof getDomain200TypeEnum)[keyof typeof getDomain200TypeEnum];

/**
 * @description A single Domain in Linode\'s DNS Manager.
*/
export interface GetDomain200 {
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    status?: GetDomain200StatusEnumKey;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    type?: GetDomain200TypeEnumKey;
}

/**
 * @description See [Errors](https://techdocs.akamai.com/linode-api/reference/errors) for the range of possible error response codes.
*/
export interface GetDomainError {
    /**
     * @type array | undefined
    */
    errors?: {
