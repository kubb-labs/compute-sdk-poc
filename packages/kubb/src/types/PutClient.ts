...
export const putClient200StatusEnum = {
    "active": "active",
    "disabled": "disabled",
    "suspended": "suspended"
} as const;

export type PutClient200StatusEnumKey = (typeof putClient200StatusEnum)[keyof typeof putClient200StatusEnum];
...
export const putClientMutationRequestStatusEnum = {
    "active": "active",
    "disabled": "disabled",
    "suspended": "suspended"
} as const;

export type PutClientMutationRequestStatusEnumKey = (typeof putClientMutationRequestStatusEnum)[keyof typeof putClientMutationRequestStatusEnum];

/**
 * @description The fields to update.
*/
export type PutClientMutationRequest = Omit<NonNullable<{
    /**
     * @description __Read-only__ The OAuth Client ID.  This is used to identify the client, and is a publicly known value (it is not a secret).
    ...
    */
     ...
     * @type string | undefined
    */
    readonly status?: PutClientMutationRequestStatusEnumKey;
    /**
     * @description __Read-only__ The URL where this client\'s thumbnail may be viewed, or `null` if this client does not have a thumbnail set.
     * @type string, url
    */
    readonly thumbnail_url?: string | null;
}>, "id" | "secret" | "status" | "thumbnail_url">;

export type PutClientMutationResponse = PutClient200;

export type PutClientMutation = {
    Response: PutClient200;
    Request: PutClientMutationRequest;
    PathParams: PutClientPathParams;
    Errors: any;
};