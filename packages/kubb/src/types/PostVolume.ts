...
export const postVolumePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostVolumePathParamsApiVersionEnumKey = (typeof postVolumePathParamsApiVersionEnum)[keyof typeof postVolumePathParamsApiVersionEnum];

export interface PostVolumePathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostVolumePathParamsApiVersionEnumKey;
}
...
export type PostVolumeMutation = {
    ...
    PathParams: PostVolumePathParams;
    Errors: any;
};