...
export type EventActionEnumKey = (typeof eventActionEnum)[keyof typeof eventActionEnum];

export const detailsDescriptionEnum = {
    "Scheduled Maintenance": "Scheduled Maintenance",
    "Emergency Maintenance": "Emergency Maintenance"
} as const;

export type DetailsDescriptionEnumKey = (typeof detailsDescriptionEnum)[keyof typeof detailsDescriptionEnum];

export const detailsSourceEnum = {
    "platform": "platform",
    "user": "user"
} as const;

export type DetailsSourceEnumKey = (typeof detailsSourceEnum)[keyof typeof detailsSourceEnum];

export const entityTypeEnum2 = {
    "account": "account",
    "backups": "backups",
    "community": "community",
    "disks": "disks",
...
export type EntityTypeEnum2Key = (typeof entityTypeEnum2)[keyof typeof entityTypeEnum2];
...
/**
 * @description A specific event object. An event is an action taken against an entity related to your account. For example, if you boot a Linode, the system creates an event. The events returned depend on your user grants.
*/
export interface Event {
    ...
    */
    readonly action?: EventActionEnumKey;
    /**
    ...
    */
    readonly details?: {
        ...
        */
         ...
         * @type string | undefined
        */
        description?: DetailsDescriptionEnumKey;
        /**
    ...
    */
    readonly entity?: {
        ...
        */
         ...
         * @type string | undefined
        */
        readonly type?: EntityTypeEnum2Key;
        /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly status?: EventStatusEnumKey;
    /**
