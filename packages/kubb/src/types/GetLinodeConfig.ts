...
export const getLinodeConfigPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLinodeConfigPathParamsApiVersionEnumKey = (typeof getLinodeConfigPathParamsApiVersionEnum)[keyof typeof getLinodeConfigPathParamsApiVersionEnum];

export interface GetLinodeConfigPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetLinodeConfigPathParamsApiVersionEnumKey;
    /**
...
export const ipv4Nat11Enum5 = {
    "any": "any"
} as const;

export type Ipv4Nat11Enum5Key = (typeof ipv4Nat11Enum5)[keyof typeof ipv4Nat11Enum5];

export const interfacesPurposeEnum5 = {
    "public": "public",
    "vlan": "vlan",
    "vpc": "vpc"
} as const;

export type InterfacesPurposeEnum5Key = (typeof interfacesPurposeEnum5)[keyof typeof interfacesPurposeEnum5];

export const getLinodeConfig200RunLevelEnum = {
    "default": "default",
    "single": "single",
    "binbash": "binbash"
} as const;

export type GetLinodeConfig200RunLevelEnumKey = (typeof getLinodeConfig200RunLevelEnum)[keyof typeof getLinodeConfig200RunLevelEnum];

export const getLinodeConfig200VirtModeEnum = {
    "paravirt": "paravirt",
    "fullvirt": "fullvirt"
} as const;

export type GetLinodeConfig200VirtModeEnumKey = (typeof getLinodeConfig200VirtModeEnum)[keyof typeof getLinodeConfig200VirtModeEnum];

/**
 * @description A configuration profile object.
*/
export interface GetLinodeConfig200 {
    /**
    ...
    interfaces?: {
        ...
        */
        ipv4?: {
             ...
             * @type string
            */
            nat_1_1?: (string | Ipv4Nat11Enum5Key) | null;
            /**
        ...
        */
         ...
         * @type string
        */
        purpose: InterfacesPurposeEnum5Key;
        /**
    ...
    */
     ...
     * @type string | undefined
    */
    run_level?: GetLinodeConfig200RunLevelEnumKey;
    /**
     ...
     * @type string | undefined
    */
    virt_mode?: GetLinodeConfig200VirtModeEnumKey;
}

/**
 * @description See [Errors](https://techdocs.akamai.com/linode-api/reference/errors) for the range of possible error response codes.
*/
export interface GetLinodeConfigError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetLinodeConfigQueryResponse = GetLinodeConfig200;

export type GetLinodeConfigQuery = {
    Response: GetLinodeConfig200;
