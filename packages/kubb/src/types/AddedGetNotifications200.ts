...
export type EntityTypeEnumKey = (typeof entityTypeEnum)[keyof typeof entityTypeEnum];

export const dataSeverityEnum = {
    "minor": "minor",
    "major": "major",
    "critical": "critical"
} as const;

export type DataSeverityEnumKey = (typeof dataSeverityEnum)[keyof typeof dataSeverityEnum];
...
export interface AddedGetNotifications200 {
    /**
