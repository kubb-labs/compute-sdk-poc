...
export interface GetFirewallTemplatePathParams {
     ...
     * @type string
    */
    slug: GetFirewallTemplatePathParamsSlugEnumKey;
}

export interface GetFirewallTemplateQueryParams {
    /**
...
export const inboundActionEnum8 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type InboundActionEnum8Key = (typeof inboundActionEnum8)[keyof typeof inboundActionEnum8];

export const inboundProtocolEnum8 = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type InboundProtocolEnum8Key = (typeof inboundProtocolEnum8)[keyof typeof inboundProtocolEnum8];

export const rulesInboundPolicyEnum8 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesInboundPolicyEnum8Key = (typeof rulesInboundPolicyEnum8)[keyof typeof rulesInboundPolicyEnum8];

export const outboundActionEnum8 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type OutboundActionEnum8Key = (typeof outboundActionEnum8)[keyof typeof outboundActionEnum8];

export const outboundProtocolEnum8 = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type OutboundProtocolEnum8Key = (typeof outboundProtocolEnum8)[keyof typeof outboundProtocolEnum8];

export const rulesOutboundPolicyEnum8 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesOutboundPolicyEnum8Key = (typeof rulesOutboundPolicyEnum8)[keyof typeof rulesOutboundPolicyEnum8];

export const getFirewallTemplate200SlugEnum = {
    "vpc": "vpc",
    "public": "public"
} as const;

export type GetFirewallTemplate200SlugEnumKey = (typeof getFirewallTemplate200SlugEnum)[keyof typeof getFirewallTemplate200SlugEnum];
...
export type GetFirewallTemplateQueryResponse = GetFirewallTemplate200;

export type GetFirewallTemplateQuery = {
    Response: GetFirewallTemplate200;
    PathParams: GetFirewallTemplatePathParams;
    QueryParams: GetFirewallTemplateQueryParams;
    Errors: any;
};