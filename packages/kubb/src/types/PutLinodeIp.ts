...
export const putLinodeIpPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutLinodeIpPathParamsApiVersionEnumKey = (typeof putLinodeIpPathParamsApiVersionEnum)[keyof typeof putLinodeIpPathParamsApiVersionEnum];

export interface PutLinodeIpPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PutLinodeIpPathParamsApiVersionEnumKey;
    /**
...
export const putLinodeIp200TypeEnum = {
    "ipv4": "ipv4",
    "ipv6": "ipv6",
    "ipv6/pool": "ipv6/pool",
...
export type PutLinodeIp200TypeEnumKey = (typeof putLinodeIp200TypeEnum)[keyof typeof putLinodeIp200TypeEnum];

/**
 * @description The updated IP address record.
*/
export interface PutLinodeIp200 {
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly type?: PutLinodeIp200TypeEnumKey;
    /**
...
*/
export interface PutLinodeIpError {
    /**
...
*/
export interface PutLinodeIpMutationRequest {
    /**
     * @description The reverse DNS assigned to this address. For public IPv4 addresses, this will be set to a default value provided by Linode if not explicitly set.
     * @type string
    */
...
export type PutLinodeIpMutationResponse = PutLinodeIp200;

export type PutLinodeIpMutation = {
    Response: PutLinodeIp200;
    Request: PutLinodeIpMutationRequest;
    PathParams: PutLinodeIpPathParams;
    Errors: any;
};