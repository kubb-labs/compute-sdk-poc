...
export const putNodeBalancerPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutNodeBalancerPathParamsApiVersionEnumKey = (typeof putNodeBalancerPathParamsApiVersionEnum)[keyof typeof putNodeBalancerPathParamsApiVersionEnum];
...
export interface PutNodeBalancerPathParams {
     ...
     * @type string
    */
    apiVersion: PutNodeBalancerPathParamsApiVersionEnumKey;
    /**
