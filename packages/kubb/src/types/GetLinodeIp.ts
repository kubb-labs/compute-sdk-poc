...
export const getLinodeIpPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLinodeIpPathParamsApiVersionEnumKey = (typeof getLinodeIpPathParamsApiVersionEnum)[keyof typeof getLinodeIpPathParamsApiVersionEnum];

export interface GetLinodeIpPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetLinodeIpPathParamsApiVersionEnumKey;
    /**
...
export const getLinodeIp200TypeEnum = {
    "ipv4": "ipv4",
    "ipv6": "ipv6",
    "ipv6/pool": "ipv6/pool",
...
export type GetLinodeIp200TypeEnumKey = (typeof getLinodeIp200TypeEnum)[keyof typeof getLinodeIp200TypeEnum];

/**
 * @description A single IP address.
*/
export interface GetLinodeIp200 {
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly type?: GetLinodeIp200TypeEnumKey;
    /**
...
*/
export interface GetLinodeIpError {
    /**
...
export type GetLinodeIpQueryResponse = GetLinodeIp200;

export type GetLinodeIpQuery = {
    Response: GetLinodeIp200;
