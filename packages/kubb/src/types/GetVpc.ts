...
export const getVpcPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetVpcPathParamsApiVersionEnumKey = (typeof getVpcPathParamsApiVersionEnum)[keyof typeof getVpcPathParamsApiVersionEnum];
...
export interface GetVpcPathParams {
     ...
     * @type string
    */
    apiVersion: GetVpcPathParamsApiVersionEnumKey;
    /**
