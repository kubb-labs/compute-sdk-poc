...
export const getLkeTypesPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLkeTypesPathParamsApiVersionEnumKey = (typeof getLkeTypesPathParamsApiVersionEnum)[keyof typeof getLkeTypesPathParamsApiVersionEnum];

export interface GetLkeTypesPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetLkeTypesPathParamsApiVersionEnumKey;
}

/**
 * @description A collection of Kubernetes types.
*/
export interface GetLkeTypes200 {
    /**
    ...
    */
    data?: {
        /**
         * @description __Read-only__ The ID representing the Kubernetes type.
         * @type string | undefined
        */
        readonly id?: string;
        /**
         * @description __Filterable__, __Read-only__ The Kubernetes type label is for display purposes only.
         * @type string | undefined
        */
        readonly label?: string;
        /**
         * @description __Read-only__ The default cost of this Kubernetes type. Prices are in US dollars, broken down into hourly and monthly charges.\n\nCertain regions have different prices from the default. For region-specific prices, see `region_prices`.
...
*/
export interface GetLkeTypesError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetLkeTypesQueryResponse = GetLkeTypes200;

export type GetLkeTypesQuery = {
    Response: GetLkeTypes200;
    PathParams: GetLkeTypesPathParams;
    Errors: any;
};