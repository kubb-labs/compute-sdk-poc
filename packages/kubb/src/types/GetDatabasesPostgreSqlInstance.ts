...
export const getDatabasesPostgreSqlInstancePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetDatabasesPostgreSqlInstancePathParamsApiVersionEnumKey = (typeof getDatabasesPostgreSqlInstancePathParamsApiVersionEnum)[keyof typeof getDatabasesPostgreSqlInstancePathParamsApiVersionEnum];

export interface GetDatabasesPostgreSqlInstancePathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetDatabasesPostgreSqlInstancePathParamsApiVersionEnumKey;
    /**
...
export const getDatabasesPostgreSqlInstance200ClusterSizeEnum = {
    "1": 1,
    "2": 2,
    "3": 3
} as const;

export type GetDatabasesPostgreSqlInstance200ClusterSizeEnumKey = (typeof getDatabasesPostgreSqlInstance200ClusterSizeEnum)[keyof typeof getDatabasesPostgreSqlInstance200ClusterSizeEnum];

export const pgDefaultToastCompressionEnum4 = {
    "lz4": "lz4",
    "pglz": "pglz"
} as const;

export type PgDefaultToastCompressionEnum4Key = (typeof pgDefaultToastCompressionEnum4)[keyof typeof pgDefaultToastCompressionEnum4];

export const pgPasswordEncryptionEnum4 = {
    "scram-sh-256": "scram-sh-256",
    "md5": "md5"
} as const;

export type PgPasswordEncryptionEnum4Key = (typeof pgPasswordEncryptionEnum4)[keyof typeof pgPasswordEncryptionEnum4];

export const pgPgStatStatementsTrackEnum4 = {
    "all": "all",
    "top": "top",
    "none": "none"
} as const;

export type PgPgStatStatementsTrackEnum4Key = (typeof pgPgStatStatementsTrackEnum4)[keyof typeof pgPgStatStatementsTrackEnum4];

export const pgTrackCommitTimestampEnum4 = {
    "on": "on",
    "off": "off"
} as const;

export type PgTrackCommitTimestampEnum4Key = (typeof pgTrackCommitTimestampEnum4)[keyof typeof pgTrackCommitTimestampEnum4];

export const pgTrackFunctionsEnum4 = {
    "all": "all",
    "pl": "pl",
    "none": "none"
} as const;

export type PgTrackFunctionsEnum4Key = (typeof pgTrackFunctionsEnum4)[keyof typeof pgTrackFunctionsEnum4];

export const pgTrackIoTimingEnum4 = {
    "on": "on",
    "off": "off"
} as const;

export type PgTrackIoTimingEnum4Key = (typeof pgTrackIoTimingEnum4)[keyof typeof pgTrackIoTimingEnum4];

export const getDatabasesPostgreSqlInstance200PlatformEnum = {
    "rdbms-legacy": "rdbms-legacy",
    "rdbms-default": "rdbms-default"
} as const;

export type GetDatabasesPostgreSqlInstance200PlatformEnumKey = (typeof getDatabasesPostgreSqlInstance200PlatformEnum)[keyof typeof getDatabasesPostgreSqlInstance200PlatformEnum];

export const getDatabasesPostgreSqlInstance200StatusEnum = {
...
export type GetDatabasesPostgreSqlInstance200StatusEnumKey = (typeof getDatabasesPostgreSqlInstance200StatusEnum)[keyof typeof getDatabasesPostgreSqlInstance200StatusEnum];

export const updatesFrequencyEnum9 = {
    "weekly": "weekly"
} as const;

export type UpdatesFrequencyEnum9Key = (typeof updatesFrequencyEnum9)[keyof typeof updatesFrequencyEnum9];

/**
 * @description Returns information for a single PostgreSQL Managed Database.
*/
export interface GetDatabasesPostgreSqlInstance200 {
    /**
    ...
    */
    cluster_size?: GetDatabasesPostgreSqlInstance200ClusterSizeEnumKey;
    /**
        ...
        */
        pg?: {
            ...
            */
             ...
             * @type string | undefined
            */
            default_toast_compression?: PgDefaultToastCompressionEnum4Key;
            /**
            ...
            */
             ...
             * @type string | undefined
            */
            password_encryption?: PgPasswordEncryptionEnum4Key;
            /**
            ...
            */
             ...
             * @type string | undefined
            */
            "pg_stat_statements.track"?: PgPgStatStatementsTrackEnum4Key;
            /**
            ...
            */
             ...
             * @type string | undefined
            */
            track_commit_timestamp?: PgTrackCommitTimestampEnum4Key;
            /**
             ...
             * @type string | undefined
            */
            track_functions?: PgTrackFunctionsEnum4Key;
            /**
             ...
             * @type string | undefined
            */
            track_io_timing?: PgTrackIoTimingEnum4Key;
            /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly platform?: GetDatabasesPostgreSqlInstance200PlatformEnumKey;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly status?: GetDatabasesPostgreSqlInstance200StatusEnumKey;
    /**
    ...
    */
    updates?: {
        ...
        */
         ...
         * @type string | undefined
        */
        frequency?: UpdatesFrequencyEnum9Key;
        /**
...
*/
export interface GetDatabasesPostgreSqlInstanceError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetDatabasesPostgreSqlInstanceQueryResponse = GetDatabasesPostgreSqlInstance200;

export type GetDatabasesPostgreSqlInstanceQuery = {
    Response: GetDatabasesPostgreSqlInstance200;
    PathParams: GetDatabasesPostgreSqlInstancePathParams;
    Errors: any;
};