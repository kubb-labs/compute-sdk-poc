...
export const getLinodeFirewallsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLinodeFirewallsPathParamsApiVersionEnumKey = (typeof getLinodeFirewallsPathParamsApiVersionEnum)[keyof typeof getLinodeFirewallsPathParamsApiVersionEnum];

export interface GetLinodeFirewallsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetLinodeFirewallsPathParamsApiVersionEnumKey;
    /**
...
export interface GetLinodeFirewallsQueryParams {
    /**
...
export const parentEntityTypeEnum = {
    "linode": "linode"
} as const;

export type ParentEntityTypeEnumKey = (typeof parentEntityTypeEnum)[keyof typeof parentEntityTypeEnum];
...
export const inboundActionEnum = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type InboundActionEnumKey = (typeof inboundActionEnum)[keyof typeof inboundActionEnum];

export const inboundProtocolEnum = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type InboundProtocolEnumKey = (typeof inboundProtocolEnum)[keyof typeof inboundProtocolEnum];

export const rulesInboundPolicyEnum = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesInboundPolicyEnumKey = (typeof rulesInboundPolicyEnum)[keyof typeof rulesInboundPolicyEnum];

export const outboundActionEnum = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type OutboundActionEnumKey = (typeof outboundActionEnum)[keyof typeof outboundActionEnum];

export const outboundProtocolEnum = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type OutboundProtocolEnumKey = (typeof outboundProtocolEnum)[keyof typeof outboundProtocolEnum];

export const rulesOutboundPolicyEnum = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesOutboundPolicyEnumKey = (typeof rulesOutboundPolicyEnum)[keyof typeof rulesOutboundPolicyEnum];

export const dataStatusEnum24 = {
    "enabled": "enabled",
    "disabled": "disabled",
    "deleted": "deleted"
} as const;

export type DataStatusEnum24Key = (typeof dataStatusEnum24)[keyof typeof dataStatusEnum24];

/**
 * @description Returns a paginated list of Firewalls assigned to this Linode.
*/
export interface GetLinodeFirewalls200 {
    /**
    ...
    */
    data?: {
        ...
        */
            ...
            */
            inbound?: {
                ...
                */
                 ...
                 * @type string | undefined
                */
                protocol?: InboundProtocolEnumKey;
            }[];
            /**
             ...
             * @type string | undefined
            */
            inbound_policy?: RulesInboundPolicyEnumKey;
            /**
            ...
            */
            outbound?: {
                ...
                */
                 ...
                 * @type string | undefined
                */
                protocol?: OutboundProtocolEnumKey;
            }[];
            /**
             ...
             * @type string | undefined
            */
            outbound_policy?: RulesOutboundPolicyEnumKey;
            /**
         ...
         * @type string | undefined
        */
        readonly status?: DataStatusEnum24Key;
        /**
...
*/
export interface GetLinodeFirewallsError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetLinodeFirewallsQueryResponse = GetLinodeFirewalls200;

export type GetLinodeFirewallsQuery = {
    Response: GetLinodeFirewalls200;
