...
export const getLinodeVolumesPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLinodeVolumesPathParamsApiVersionEnumKey = (typeof getLinodeVolumesPathParamsApiVersionEnum)[keyof typeof getLinodeVolumesPathParamsApiVersionEnum];
...
export interface GetLinodeVolumesPathParams {
     ...
     * @type string
    */
    apiVersion: GetLinodeVolumesPathParamsApiVersionEnumKey;
    /**
