...
export const putPersonalAccessTokenPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutPersonalAccessTokenPathParamsApiVersionEnumKey = (typeof putPersonalAccessTokenPathParamsApiVersionEnum)[keyof typeof putPersonalAccessTokenPathParamsApiVersionEnum];

export interface PutPersonalAccessTokenPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PutPersonalAccessTokenPathParamsApiVersionEnumKey;
    /**
...
*/
export interface PutPersonalAccessToken200 {
    /**
...
*/
export interface PutPersonalAccessTokenError {
    /**
...
*/
export type PutPersonalAccessTokenMutationRequest = Omit<NonNullable<{
    /**
     * @description __Filterable__, __Read-only__ The date and time this token was created.
     * @type string | undefined, date-time
    */
    ...
    */
    readonly token?: string;
}>, "created" | "expiry" | "id" | "scopes" | "token">;

export type PutPersonalAccessTokenMutationResponse = PutPersonalAccessToken200;

export type PutPersonalAccessTokenMutation = {
    Response: PutPersonalAccessToken200;
    Request: PutPersonalAccessTokenMutationRequest;
    PathParams: PutPersonalAccessTokenPathParams;
    Errors: any;
};