...
*/
export interface GetLinodeInterfaces200 {
    /**
     * @description Any of the following interface types: VPC, public, or VLAN.
     * @type array
    */
    interfaces: ({
        /**
...
export type GetLinodeInterfacesQueryResponse = GetLinodeInterfaces200;

export type GetLinodeInterfacesQuery = {
    Response: GetLinodeInterfaces200;
    PathParams: GetLinodeInterfacesPathParams;
    Errors: any;
};