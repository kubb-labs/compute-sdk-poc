...
export const postChildAccountTokenPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostChildAccountTokenPathParamsApiVersionEnumKey = (typeof postChildAccountTokenPathParamsApiVersionEnum)[keyof typeof postChildAccountTokenPathParamsApiVersionEnum];
...
export interface PostChildAccountTokenPathParams {
     ...
     * @type string
    */
    apiVersion: PostChildAccountTokenPathParamsApiVersionEnumKey;
    /**
