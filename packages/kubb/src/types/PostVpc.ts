...
export const postVpcPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostVpcPathParamsApiVersionEnumKey = (typeof postVpcPathParamsApiVersionEnum)[keyof typeof postVpcPathParamsApiVersionEnum];

export interface PostVpcPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostVpcPathParamsApiVersionEnumKey;
}

/**
 * @description The new VPC.
*/
export interface PostVpc200 {
    /**
...
*/
export type PostVpcMutationRequest = (any & {
    /**
     * @description A list of subnets associated with the VPC.
     * @type array | undefined
    */
...
export type PostVpcMutationResponse = PostVpc200;

export type PostVpcMutation = {
    Response: PostVpc200;
    Request: PostVpcMutationRequest;
    PathParams: PostVpcPathParams;
    Errors: any;
};