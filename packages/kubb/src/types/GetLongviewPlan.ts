...
export const getLongviewPlanPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLongviewPlanPathParamsApiVersionEnumKey = (typeof getLongviewPlanPathParamsApiVersionEnum)[keyof typeof getLongviewPlanPathParamsApiVersionEnum];

export interface GetLongviewPlanPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetLongviewPlanPathParamsApiVersionEnumKey;
}

export const getLongviewPlan200IdEnum = {
...
export type GetLongviewPlan200IdEnumKey = (typeof getLongviewPlan200IdEnum)[keyof typeof getLongviewPlan200IdEnum];

/**
 * @description The Longview plan details for this account.
*/
export interface GetLongviewPlan200 {
    /**
    ...
    */
    readonly id?: GetLongviewPlan200IdEnumKey;
    /**
...
*/
export interface GetLongviewPlanError {
    /**
...
export type GetLongviewPlanQueryResponse = GetLongviewPlan200;

export type GetLongviewPlanQuery = {
    Response: GetLongviewPlan200;
    PathParams: GetLongviewPlanPathParams;
    Errors: any;
};