...
export const getFirewallRuleVersionsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetFirewallRuleVersionsPathParamsApiVersionEnumKey = (typeof getFirewallRuleVersionsPathParamsApiVersionEnum)[keyof typeof getFirewallRuleVersionsPathParamsApiVersionEnum];

export interface GetFirewallRuleVersionsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetFirewallRuleVersionsPathParamsApiVersionEnumKey;
    /**
...
export const parentEntityTypeEnum13 = {
    "linode": "linode"
} as const;

export type ParentEntityTypeEnum13Key = (typeof parentEntityTypeEnum13)[keyof typeof parentEntityTypeEnum13];

export const entitiesTypeEnum9 = {
    "linode": "linode",
    "linode_interface": "linode_interface",
    "nodebalancer": "nodebalancer"
} as const;

export type EntitiesTypeEnum9Key = (typeof entitiesTypeEnum9)[keyof typeof entitiesTypeEnum9];

export const inboundActionEnum11 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type InboundActionEnum11Key = (typeof inboundActionEnum11)[keyof typeof inboundActionEnum11];

export const inboundProtocolEnum11 = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type InboundProtocolEnum11Key = (typeof inboundProtocolEnum11)[keyof typeof inboundProtocolEnum11];

export const rulesInboundPolicyEnum11 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesInboundPolicyEnum11Key = (typeof rulesInboundPolicyEnum11)[keyof typeof rulesInboundPolicyEnum11];

export const outboundActionEnum11 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type OutboundActionEnum11Key = (typeof outboundActionEnum11)[keyof typeof outboundActionEnum11];

export const outboundProtocolEnum11 = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type OutboundProtocolEnum11Key = (typeof outboundProtocolEnum11)[keyof typeof outboundProtocolEnum11];

export const rulesOutboundPolicyEnum11 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesOutboundPolicyEnum11Key = (typeof rulesOutboundPolicyEnum11)[keyof typeof rulesOutboundPolicyEnum11];

export const getFirewallRuleVersions200StatusEnum = {
    "enabled": "enabled",
    "disabled": "disabled",
    "deleted": "deleted"
} as const;

export type GetFirewallRuleVersions200StatusEnumKey = (typeof getFirewallRuleVersions200StatusEnum)[keyof typeof getFirewallRuleVersions200StatusEnum];

/**
 * @description Returns information for all rule versions for this firewall.
*/
export interface GetFirewallRuleVersions200 {
    /**
        ...
        */
        readonly parent_entity?: {
            ...
            */
             ...
             * @type string | undefined
            */
            type?: ParentEntityTypeEnum13Key;
            /**
    ...
    */
    rules?: {
        ...
        */
        inbound?: {
            ...
            */
             ...
             * @type string | undefined
            */
            protocol?: InboundProtocolEnum11Key;
        }[];
        /**
         ...
         * @type string | undefined
        */
        inbound_policy?: RulesInboundPolicyEnum11Key;
        /**
        ...
        */
        outbound?: {
             ...
             * @type string | undefined
            */
            action?: OutboundActionEnum11Key;
            /**
             * @description The IPv4 or IPv6 addresses affected by this rule. A rule can have up to 255 total addresses or networks listed across its `ipv4` and `ipv6` arrays. A network and a single IP are treated as equivalent when accounting for this limit.\n\nMust contain `ipv4`, `ipv6`, or both.
             * @type object | undefined
            */
            ...
            */
             ...
             * @type string | undefined
            */
            protocol?: OutboundProtocolEnum11Key;
        }[];
        /**
         ...
         * @type string | undefined
        */
        outbound_policy?: RulesOutboundPolicyEnum11Key;
        /**
     ...
     * @type string | undefined
    */
    readonly status?: GetFirewallRuleVersions200StatusEnumKey;
    /**
...
*/
export interface GetFirewallRuleVersionsError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetFirewallRuleVersionsQueryResponse = GetFirewallRuleVersions200;

export type GetFirewallRuleVersionsQuery = {
    Response: GetFirewallRuleVersions200;
    PathParams: GetFirewallRuleVersionsPathParams;
    Errors: any;
};