...
export const getFirewallPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetFirewallPathParamsApiVersionEnumKey = (typeof getFirewallPathParamsApiVersionEnum)[keyof typeof getFirewallPathParamsApiVersionEnum];

export interface GetFirewallPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetFirewallPathParamsApiVersionEnumKey;
    /**
...
export const parentEntityTypeEnum7 = {
    "linode": "linode"
} as const;

export type ParentEntityTypeEnum7Key = (typeof parentEntityTypeEnum7)[keyof typeof parentEntityTypeEnum7];

export const entitiesTypeEnum7 = {
    "linode": "linode",
    "linode_interface": "linode_interface",
    "nodebalancer": "nodebalancer"
} as const;

export type EntitiesTypeEnum7Key = (typeof entitiesTypeEnum7)[keyof typeof entitiesTypeEnum7];

export const inboundActionEnum9 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type InboundActionEnum9Key = (typeof inboundActionEnum9)[keyof typeof inboundActionEnum9];

export const inboundProtocolEnum9 = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type InboundProtocolEnum9Key = (typeof inboundProtocolEnum9)[keyof typeof inboundProtocolEnum9];

export const rulesInboundPolicyEnum9 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesInboundPolicyEnum9Key = (typeof rulesInboundPolicyEnum9)[keyof typeof rulesInboundPolicyEnum9];

export const outboundActionEnum9 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type OutboundActionEnum9Key = (typeof outboundActionEnum9)[keyof typeof outboundActionEnum9];

export const outboundProtocolEnum9 = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type OutboundProtocolEnum9Key = (typeof outboundProtocolEnum9)[keyof typeof outboundProtocolEnum9];

export const rulesOutboundPolicyEnum9 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesOutboundPolicyEnum9Key = (typeof rulesOutboundPolicyEnum9)[keyof typeof rulesOutboundPolicyEnum9];

export const getFirewall200StatusEnum = {
    "enabled": "enabled",
    "disabled": "disabled",
    "deleted": "deleted"
} as const;

export type GetFirewall200StatusEnumKey = (typeof getFirewall200StatusEnum)[keyof typeof getFirewall200StatusEnum];

/**
 * @description Returns information about this Firewall.
*/
export interface GetFirewall200 {
    /**
    ...
    */
        ...
        */
        inbound?: {
            ...
            */
             ...
             * @type string | undefined
            */
            protocol?: InboundProtocolEnum9Key;
        }[];
        /**
         ...
         * @type string | undefined
        */
        inbound_policy?: RulesInboundPolicyEnum9Key;
        /**
        ...
        */
        outbound?: {
            ...
            */
             ...
             * @type string | undefined
            */
            protocol?: OutboundProtocolEnum9Key;
        }[];
        /**
         ...
         * @type string | undefined
        */
        outbound_policy?: RulesOutboundPolicyEnum9Key;
        /**
     ...
     * @type string | undefined
    */
    readonly status?: GetFirewall200StatusEnumKey;
    /**
...
*/
export interface GetFirewallError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetFirewallQueryResponse = GetFirewall200;

export type GetFirewallQuery = {
    Response: GetFirewall200;
