...
export const getLinodeIpsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLinodeIpsPathParamsApiVersionEnumKey = (typeof getLinodeIpsPathParamsApiVersionEnum)[keyof typeof getLinodeIpsPathParamsApiVersionEnum];
...
export interface GetLinodeIpsPathParams {
     ...
     * @type string
    */
    apiVersion: GetLinodeIpsPathParamsApiVersionEnumKey;
    /**
