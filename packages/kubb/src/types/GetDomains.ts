...
export const getDomainsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetDomainsPathParamsApiVersionEnumKey = (typeof getDomainsPathParamsApiVersionEnum)[keyof typeof getDomainsPathParamsApiVersionEnum];

export interface GetDomainsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetDomainsPathParamsApiVersionEnumKey;
}
...
export type GetDomainsQuery = {
    ...
    PathParams: GetDomainsPathParams;
