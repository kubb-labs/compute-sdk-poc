...
export const postImportDomainPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostImportDomainPathParamsApiVersionEnumKey = (typeof postImportDomainPathParamsApiVersionEnum)[keyof typeof postImportDomainPathParamsApiVersionEnum];

export interface PostImportDomainPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostImportDomainPathParamsApiVersionEnumKey;
}

export const postImportDomain200StatusEnum = {
    "disabled": "disabled",
    "active": "active"
} as const;

export type PostImportDomain200StatusEnumKey = (typeof postImportDomain200StatusEnum)[keyof typeof postImportDomain200StatusEnum];

export const postImportDomain200TypeEnum = {
    "master": "master",
    "slave": "slave"
} as const;

export type PostImportDomain200TypeEnumKey = (typeof postImportDomain200TypeEnum)[keyof typeof postImportDomain200TypeEnum];

/**
 * @description A single Domain in Linode\'s DNS Manager.
*/
export interface PostImportDomain200 {
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    status?: PostImportDomain200StatusEnumKey;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    type?: PostImportDomain200TypeEnumKey;
}

/**
 * @description See [Errors](https://techdocs.akamai.com/linode-api/reference/errors) for the range of possible error response codes.
*/
export interface PostImportDomainError {
    /**
     * @type array | undefined
    */
    errors?: {
...
*/
export interface PostImportDomainMutationRequest {
    /**
...
export type PostImportDomainMutationResponse = PostImportDomain200;

export type PostImportDomainMutation = {
    Response: PostImportDomain200;
    Request: PostImportDomainMutationRequest;
    PathParams: PostImportDomainPathParams;
    Errors: any;
};