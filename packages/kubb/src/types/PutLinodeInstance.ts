...
export const putLinodeInstancePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutLinodeInstancePathParamsApiVersionEnumKey = (typeof putLinodeInstancePathParamsApiVersionEnum)[keyof typeof putLinodeInstancePathParamsApiVersionEnum];

export interface PutLinodeInstancePathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PutLinodeInstancePathParamsApiVersionEnumKey;
    /**
...
export type ScheduleDayEnum4Key = (typeof scheduleDayEnum4)[keyof typeof scheduleDayEnum4];

export const scheduleWindowEnum4 = {
    "Scheduling": "Scheduling",
    "W0": "W0",
    "W2": "W2",
    "W4": "W4",
...
export type ScheduleWindowEnum4Key = (typeof scheduleWindowEnum4)[keyof typeof scheduleWindowEnum4];

export const putLinodeInstance200HypervisorEnum = {
    "kvm": "kvm"
} as const;

export type PutLinodeInstance200HypervisorEnumKey = (typeof putLinodeInstance200HypervisorEnum)[keyof typeof putLinodeInstance200HypervisorEnum];

export const putLinodeInstance200InterfaceGenerationEnum = {
    "legacy_config": "legacy_config",
    "linode": "linode"
} as const;

export type PutLinodeInstance200InterfaceGenerationEnumKey = (typeof putLinodeInstance200InterfaceGenerationEnum)[keyof typeof putLinodeInstance200InterfaceGenerationEnum];

export const putLinodeInstance200MaintenancePolicyEnum = {
    "linode/migrate": "linode/migrate",
    "linode/power_off_on": "linode/power_off_on"
} as const;

export type PutLinodeInstance200MaintenancePolicyEnumKey = (typeof putLinodeInstance200MaintenancePolicyEnum)[keyof typeof putLinodeInstance200MaintenancePolicyEnum];

export const placementGroupPlacementGroupPolicyEnum4 = {
    "strict": "strict",
    "flexible": "flexible"
} as const;

export type PlacementGroupPlacementGroupPolicyEnum4Key = (typeof placementGroupPlacementGroupPolicyEnum4)[keyof typeof placementGroupPlacementGroupPolicyEnum4];

export const placementGroupPlacementGroupTypeEnum4 = {
    "anti_affinity:local": "anti_affinity:local"
} as const;

export type PlacementGroupPlacementGroupTypeEnum4Key = (typeof placementGroupPlacementGroupTypeEnum4)[keyof typeof placementGroupPlacementGroupTypeEnum4];

export const putLinodeInstance200StatusEnum = {
    "running": "running",
    "offline": "offline",
    "booting": "booting",
    "busy": "busy",
...
export type PutLinodeInstance200StatusEnumKey = (typeof putLinodeInstance200StatusEnum)[keyof typeof putLinodeInstance200StatusEnum];

/**
 * @description The updated Linode.
*/
export interface PutLinodeInstance200 {
    /**
        ...
        */
        schedule?: {
            ...
            */
             ...
             * @type string
            */
            window?: ScheduleWindowEnum4Key | null;
        };
    };
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly hypervisor?: PutLinodeInstance200HypervisorEnumKey;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly interface_generation?: PutLinodeInstance200InterfaceGenerationEnumKey;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    maintenance_policy?: PutLinodeInstance200MaintenancePolicyEnumKey;
    /**
    ...
    */
    readonly placement_group?: {
        ...
        */
         ...
         * @type string | undefined
        */
        placement_group_policy?: PlacementGroupPlacementGroupPolicyEnum4Key;
        /**
         ...
         * @type string | undefined
        */
        readonly placement_group_type?: PlacementGroupPlacementGroupTypeEnum4Key;
    } | null;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly status?: PutLinodeInstance200StatusEnumKey;
    /**
...
*/
export interface PutLinodeInstanceError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type ScheduleDayEnum5Key = (typeof scheduleDayEnum5)[keyof typeof scheduleDayEnum5];

export const scheduleWindowEnum5 = {
    "Scheduling": "Scheduling",
    "W0": "W0",
    "W2": "W2",
    "W4": "W4",
...
export type ScheduleWindowEnum5Key = (typeof scheduleWindowEnum5)[keyof typeof scheduleWindowEnum5];

export const putLinodeInstanceMutationRequestHypervisorEnum = {
    "kvm": "kvm"
} as const;

export type PutLinodeInstanceMutationRequestHypervisorEnumKey = (typeof putLinodeInstanceMutationRequestHypervisorEnum)[keyof typeof putLinodeInstanceMutationRequestHypervisorEnum];

export const putLinodeInstanceMutationRequestInterfaceGenerationEnum = {
    "legacy_config": "legacy_config",
    "linode": "linode"
} as const;

export type PutLinodeInstanceMutationRequestInterfaceGenerationEnumKey = (typeof putLinodeInstanceMutationRequestInterfaceGenerationEnum)[keyof typeof putLinodeInstanceMutationRequestInterfaceGenerationEnum];

export const putLinodeInstanceMutationRequestMaintenancePolicyEnum = {
    "linode/migrate": "linode/migrate",
    "linode/power_off_on": "linode/power_off_on"
} as const;

export type PutLinodeInstanceMutationRequestMaintenancePolicyEnumKey = (typeof putLinodeInstanceMutationRequestMaintenancePolicyEnum)[keyof typeof putLinodeInstanceMutationRequestMaintenancePolicyEnum];

export const placementGroupPlacementGroupPolicyEnum5 = {
    "strict": "strict",
    "flexible": "flexible"
} as const;

export type PlacementGroupPlacementGroupPolicyEnum5Key = (typeof placementGroupPlacementGroupPolicyEnum5)[keyof typeof placementGroupPlacementGroupPolicyEnum5];

export const placementGroupPlacementGroupTypeEnum5 = {
    "anti_affinity:local": "anti_affinity:local"
} as const;

export type PlacementGroupPlacementGroupTypeEnum5Key = (typeof placementGroupPlacementGroupTypeEnum5)[keyof typeof placementGroupPlacementGroupTypeEnum5];

export const putLinodeInstanceMutationRequestStatusEnum = {
    "running": "running",
    "offline": "offline",
    "booting": "booting",
    "busy": "busy",
...
export type PutLinodeInstanceMutationRequestStatusEnumKey = (typeof putLinodeInstanceMutationRequestStatusEnum)[keyof typeof putLinodeInstanceMutationRequestStatusEnum];
...
*/
export type PutLinodeInstanceMutationRequest = Omit<NonNullable<{
    /**
     * @type object | undefined
    */
    alerts?: {
    ...
    backups?: {
        ...
        */
        schedule?: {
             ...
             * @type string
            */
            day?: ScheduleDayEnum5Key | null;
            /**
             * @description When your backups will be taken, in UTC. A backups window is a two-hour span of time in which the backup may occur.\n\nFor example, `W10` indicates that your backups should be taken between 10:00 and 12:00. If you don\'t choose a backup window, the API automatically assigns one.\n\nIf not set manually, when backups are initially enabled this may come back as `Scheduling` until the `window` is automatically selected.
             * @type string
            */
            window?: ScheduleWindowEnum5Key | null;
        };
    };
    /**
     * @description __Limited availability__, __Read-only__ A list of capabilities this compute instance supports.
    ...
    */
     ...
     * @type string | undefined
    */
    readonly hypervisor?: PutLinodeInstanceMutationRequestHypervisorEnumKey;
    /**
     * @description __Filterable__, __Read-only__ This Linode\'s ID which must be provided for all operations impacting this Linode.
     * @type integer | undefined
    */
     ...
     * @type string | undefined
    */
    readonly interface_generation?: PutLinodeInstanceMutationRequestInterfaceGenerationEnumKey;
    /**
     * @description __Filterable__, __Read-only__ This Linode\'s IPv4 Addresses. Each Linode is assigned a single public IPv4 address upon creation, and may get a single private IPv4 address if needed. You may need to [Open a support ticket](https://techdocs.akamai.com/linode-api/reference/post-ticket) to get additional IPv4 addresses.\n\nIPv4 addresses may be reassigned between your Linodes, or shared with other Linodes. See the [networking](https://techdocs.akamai.com/linode-api/reference/post-firewalls) operations for details.
     * @type array | undefined, ipv4
    */
    ...
    */
     ...
     * @type string | undefined
    */
    maintenance_policy?: PutLinodeInstanceMutationRequestMaintenancePolicyEnumKey;
    /**
     * @description __Read-only__ Details on the [placement group](https://www.linode.com/docs/products/compute/compute-instances/guides/placement-groups/) that this Linode belongs to. Empty if the Linode isn\'t in a placement group.
     * @type object
    */
    readonly placement_group?: {
        ...
        */
         ...
         * @type string | undefined
        */
        placement_group_policy?: PlacementGroupPlacementGroupPolicyEnum5Key;
        /**
         * @description __Filterable__, __Read-only__ How compute instances are distributed in your placement group. A `placement_group_type` using anti-affinity (`anti-affinity:local`) places compute instances in separate hosts, but still in the same region. This best supports the spread-apart model for high availability. A `placement_group_type` using affinity places compute instances physically close together, possibly on the same host. This supports the grouped-together model for low-latency.\n\n> 📘\n>\n> Currently, only `anti_affinity:local` is available for `placement_group_type`.
         * @type string | undefined
        */
        readonly placement_group_type?: PlacementGroupPlacementGroupTypeEnum5Key;
    } | null;
    /**
     * @description __Filterable__, __Read-only__ The [region](https://techdocs.akamai.com/linode-api/reference/get-regions) where the Linode deployed. A Linode\'s region can only be changed by initiating a [cross data center migration](https://techdocs.akamai.com/linode-api/reference/post-migrate-linode-instance).
     * @type string | undefined
    ...
    */
     ...
     * @type string | undefined
    */
    readonly status?: PutLinodeInstanceMutationRequestStatusEnumKey;
    /**
     * @description __Filterable__ Tags to help you organize your content.
     * @type array | undefined
    */
    ...
    */
    watchdog_enabled?: boolean;
}>, "capabilities" | "created" | "disk_encryption" | "has_user_data" | "host_uuid" | "hypervisor" | "id" | "image" | "interface_generation" | "ipv4" | "ipv6" | "lke_cluster_id" | "placement_group" | "region" | "specs" | "status" | "type" | "updated">;

export type PutLinodeInstanceMutationResponse = PutLinodeInstance200;

export type PutLinodeInstanceMutation = {
    Response: PutLinodeInstance200;
    Request: PutLinodeInstanceMutationRequest;
    PathParams: PutLinodeInstancePathParams;
    Errors: any;
};