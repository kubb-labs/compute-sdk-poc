...
export const getAccountAgreementsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetAccountAgreementsPathParamsApiVersionEnumKey = (typeof getAccountAgreementsPathParamsApiVersionEnum)[keyof typeof getAccountAgreementsPathParamsApiVersionEnum];

export interface GetAccountAgreementsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetAccountAgreementsPathParamsApiVersionEnumKey;
}
...
export type GetAccountAgreementsQuery = {
    ...
    PathParams: GetAccountAgreementsPathParams;
    Errors: any;
};