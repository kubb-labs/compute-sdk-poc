...
export const postVpcSubnetPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostVpcSubnetPathParamsApiVersionEnumKey = (typeof postVpcSubnetPathParamsApiVersionEnum)[keyof typeof postVpcSubnetPathParamsApiVersionEnum];

export interface PostVpcSubnetPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostVpcSubnetPathParamsApiVersionEnumKey;
    /**
...
*/
export interface PostVpcSubnet200 {
    /**
...
*/
export interface PostVpcSubnetError {
    /**
     * @type array | undefined
    */
    errors?: {
...
*/
export interface PostVpcSubnetMutationRequest {
    /**
     * @description IPv4 range in CIDR canonical form.\n\n- The range must belong to a private address space as defined in [RFC1918](https://datatracker.ietf.org/doc/html/rfc1918).\n- Allowed prefix lengths: 1-29.\n- The range must not overlap with 192.168.128.0/17.\n- The range must not overlap with other Subnets on the same VPC.
     * @type string, ip
    */
...
export type PostVpcSubnetMutationResponse = PostVpcSubnet200;

export type PostVpcSubnetMutation = {
    Response: PostVpcSubnet200;
    Request: PostVpcSubnetMutationRequest;
    PathParams: PostVpcSubnetPathParams;
    Errors: any;
};