...
export const putUserPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutUserPathParamsApiVersionEnumKey = (typeof putUserPathParamsApiVersionEnum)[keyof typeof putUserPathParamsApiVersionEnum];
...
export interface PutUserPathParams {
     ...
     * @type string
    */
    apiVersion: PutUserPathParamsApiVersionEnumKey;
    /**
...
export const lastLoginStatusEnum10 = {
    "successful": "successful",
    "failed": "failed"
} as const;

export type LastLoginStatusEnum10Key = (typeof lastLoginStatusEnum10)[keyof typeof lastLoginStatusEnum10];

export const putUser200UserTypeEnum = {
    "parent": "parent",
    "child": "child",
    "proxy": "proxy",
    "default": "default"
...
export type PutUser200UserTypeEnumKey = (typeof putUser200UserTypeEnum)[keyof typeof putUser200UserTypeEnum];

/**
 * @description User updated successfully.
*/
export interface PutUser200 {
    /**
    ...
    */
    readonly last_login?: {
        ...
        */
        readonly status?: LastLoginStatusEnum10Key;
    } | null;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly user_type?: PutUser200UserTypeEnumKey;
}
...
export const lastLoginStatusEnum11 = {
    "successful": "successful",
    "failed": "failed"
} as const;

export type LastLoginStatusEnum11Key = (typeof lastLoginStatusEnum11)[keyof typeof lastLoginStatusEnum11];

/**
 * @description The information to update.
*/
export type PutUserMutationRequest = Omit<NonNullable<{
    /**
     * @description This user\'s email address. Akamai uses this address for account management communications.
     * @type string | undefined, email
    */
    ...
    */
    readonly last_login?: {
        ...
        */
         ...
         * @type string | undefined
        */
        readonly status?: LastLoginStatusEnum11Key;
    } | null;
    /**
     * @description __Read-only__ When this user\'s current password was created. You initially create a password during the account sign-up process, and you can update it using the [Reset Password](https://login.linode.com/forgot/password) webpage. Returned as `null` if this user doesn\'t have a password set.
     * @type string, date-time
    ...
    */
    readonly verified_phone_number?: string | null;
}>, "last_login" | "password_created" | "ssh_keys" | "tfa_enabled" | "verified_phone_number">;

export type PutUserMutationResponse = PutUser200;

export type PutUserMutation = {
    Response: PutUser200;
    Request: PutUserMutationRequest;
