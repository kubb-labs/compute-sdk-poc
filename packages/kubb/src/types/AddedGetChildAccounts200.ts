...
export const dataBillingSourceEnum = {
    "external": "external"
} as const;

export type DataBillingSourceEnumKey = (typeof dataBillingSourceEnum)[keyof typeof dataBillingSourceEnum];

export interface AddedGetChildAccounts200 {
    /**
    ...
    */
    data?: {
        ...
        */
         ...
         * @type string | undefined
        */
        readonly billing_source?: DataBillingSourceEnumKey;
        /**
