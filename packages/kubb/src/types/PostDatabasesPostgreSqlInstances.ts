...
export type PostDatabasesPostgreSqlInstances200ClusterSizeEnumKey = (typeof postDatabasesPostgreSqlInstances200ClusterSizeEnum)[keyof typeof postDatabasesPostgreSqlInstances200ClusterSizeEnum];

export const pgDefaultToastCompressionEnum = {
    "lz4": "lz4",
    "pglz": "pglz"
} as const;

export type PgDefaultToastCompressionEnumKey = (typeof pgDefaultToastCompressionEnum)[keyof typeof pgDefaultToastCompressionEnum];

export const pgPasswordEncryptionEnum = {
    "scram-sh-256": "scram-sh-256",
    "md5": "md5"
} as const;

export type PgPasswordEncryptionEnumKey = (typeof pgPasswordEncryptionEnum)[keyof typeof pgPasswordEncryptionEnum];

export const pgPgStatStatementsTrackEnum = {
    "all": "all",
    "top": "top",
    "none": "none"
} as const;

export type PgPgStatStatementsTrackEnumKey = (typeof pgPgStatStatementsTrackEnum)[keyof typeof pgPgStatStatementsTrackEnum];

export const pgTrackCommitTimestampEnum = {
    "on": "on",
    "off": "off"
} as const;

export type PgTrackCommitTimestampEnumKey = (typeof pgTrackCommitTimestampEnum)[keyof typeof pgTrackCommitTimestampEnum];

export const pgTrackFunctionsEnum = {
    "all": "all",
    "pl": "pl",
    "none": "none"
} as const;

export type PgTrackFunctionsEnumKey = (typeof pgTrackFunctionsEnum)[keyof typeof pgTrackFunctionsEnum];

export const pgTrackIoTimingEnum = {
    "on": "on",
    "off": "off"
} as const;

export type PgTrackIoTimingEnumKey = (typeof pgTrackIoTimingEnum)[keyof typeof pgTrackIoTimingEnum];

export const postDatabasesPostgreSqlInstances200PlatformEnum = {
    "rdbms-legacy": "rdbms-legacy",
    "rdbms-default": "rdbms-default"
} as const;

export type PostDatabasesPostgreSqlInstances200PlatformEnumKey = (typeof postDatabasesPostgreSqlInstances200PlatformEnum)[keyof typeof postDatabasesPostgreSqlInstances200PlatformEnum];

export const postDatabasesPostgreSqlInstances200StatusEnum = {
...
export type PostDatabasesPostgreSqlInstances200StatusEnumKey = (typeof postDatabasesPostgreSqlInstances200StatusEnum)[keyof typeof postDatabasesPostgreSqlInstances200StatusEnum];

export const updatesFrequencyEnum7 = {
    "weekly": "weekly"
} as const;

export type UpdatesFrequencyEnum7Key = (typeof updatesFrequencyEnum7)[keyof typeof updatesFrequencyEnum7];
...
export const postDatabasesPostgreSqlInstancesMutationRequestClusterSizeEnum = {
    "1": 1,
    "2": 2,
    "3": 3
} as const;

export type PostDatabasesPostgreSqlInstancesMutationRequestClusterSizeEnumKey = (typeof postDatabasesPostgreSqlInstancesMutationRequestClusterSizeEnum)[keyof typeof postDatabasesPostgreSqlInstancesMutationRequestClusterSizeEnum];

export const pgDefaultToastCompressionEnum2 = {
    "lz4": "lz4",
    "pglz": "pglz"
} as const;

export type PgDefaultToastCompressionEnum2Key = (typeof pgDefaultToastCompressionEnum2)[keyof typeof pgDefaultToastCompressionEnum2];

export const pgPasswordEncryptionEnum2 = {
    "scram-sh-256": "scram-sh-256",
    "md5": "md5"
} as const;

export type PgPasswordEncryptionEnum2Key = (typeof pgPasswordEncryptionEnum2)[keyof typeof pgPasswordEncryptionEnum2];

export const pgPgStatStatementsTrackEnum2 = {
    "all": "all",
    "top": "top",
    "none": "none"
} as const;

export type PgPgStatStatementsTrackEnum2Key = (typeof pgPgStatStatementsTrackEnum2)[keyof typeof pgPgStatStatementsTrackEnum2];

export const pgTrackCommitTimestampEnum2 = {
    "on": "on",
    "off": "off"
} as const;

export type PgTrackCommitTimestampEnum2Key = (typeof pgTrackCommitTimestampEnum2)[keyof typeof pgTrackCommitTimestampEnum2];

export const pgTrackFunctionsEnum2 = {
    "all": "all",
    "pl": "pl",
    "none": "none"
} as const;

export type PgTrackFunctionsEnum2Key = (typeof pgTrackFunctionsEnum2)[keyof typeof pgTrackFunctionsEnum2];

export const pgTrackIoTimingEnum2 = {
    "on": "on",
    "off": "off"
} as const;

export type PgTrackIoTimingEnum2Key = (typeof pgTrackIoTimingEnum2)[keyof typeof pgTrackIoTimingEnum2];

export interface PostDatabasesPostgreSqlInstancesMutationRequest {
    /**
     * @description Controls access to the Managed Database.\n\n- Individually included IP addresses or CIDR ranges can access the Managed Database while all other sources are blocked.\n\n- A standalone value of `0.0.0.0/0` allows all IP addresses access to the Managed Database.\n\n- An empty array (`[]`) blocks all public and private connections to the Managed Database.
    ...
    */
    cluster_size?: PostDatabasesPostgreSqlInstancesMutationRequestClusterSizeEnumKey;
    /**
    ...
    engine_config?: {
        ...
        */
        pg?: {
            ...
            */
            default_toast_compression?: PgDefaultToastCompressionEnum2Key;
            /**
             * @description Time out sessions with open transactions after this number of milliseconds.
             * @minLength 0
             * @maxLength 604800000
            ...
            */
             ...
             * @type string | undefined
            */
            password_encryption?: PgPasswordEncryptionEnum2Key;
            /**
             * @description Sets the time interval to run `pg_partman` scheduled tasks.
             * @minLength 3600
             * @maxLength 604800
            ...
            */
             ...
             * @type string | undefined
            */
            "pg_stat_statements.track"?: PgPgStatStatementsTrackEnum2Key;
            /**
             * @description PostgreSQL temporary file limit in KB. Set to `-1` for unlimited.
             * @minLength -1
             * @maxLength 2147483647
            ...
            */
             ...
             * @type string | undefined
            */
            track_commit_timestamp?: PgTrackCommitTimestampEnum2Key;
            /**
             * @description Enables tracking of function call counts and time used. Specify `pl` to track only procedural-language functions, `all` to also track SQL and C language functions, or `none` to disable function statistics tracking.
             * @default "none"
             * @type string | undefined
            */
            track_functions?: PgTrackFunctionsEnum2Key;
            /**
             * @description Enables timing of database I/O calls. This parameter is `off` by default, because it will repeatedly query the operating system for the current time, which may cause significant overhead on some platforms.
             * @default "off"
             * @type string | undefined
            */
            track_io_timing?: PgTrackIoTimingEnum2Key;
            /**
             * @description Terminate replication connections that are inactive for longer than this amount of time, in milliseconds. Setting this value to `0` disables the timeout.
             * @minLength 0
             * @maxLength 60000
...
export type PostDatabasesPostgreSqlInstancesMutationResponse = PostDatabasesPostgreSqlInstances200;
