 ...
 */
export const postUploadImageMutationRequestSchema = z.object({
    "cloud_init": z.optional(z.boolean().describe("Whether the uploaded Image supports cloud-init.")),
"description": z.optional(z.string().describe("Description for the uploaded image.")),
...
"tags": z.optional(z.array(z.string().min(3).max(100)).min(0).max(500).describe("Tags you can use to organize images. A tag can be from 3 to 100 characters long, and an image can have a maximum of 500 total tags."))
    })

export const postUploadImageMutationResponseSchema = z.lazy(() => postUploadImage200Schema)