 ...
 */
export const getIpv6Ranges200Schema = z.object({
 ...
 */
export const getIpv6RangesErrorSchema = z.object({
...
export const getIpv6RangesQueryResponseSchema = z.lazy(() => getIpv6Ranges200Schema)