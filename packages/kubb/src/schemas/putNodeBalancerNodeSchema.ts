...
export const putNodeBalancerNodePathParamsSchema = z.object({
 ...
 */
export const putNodeBalancerNode200Schema = z.union([z.object({
 ...
 */
export const putNodeBalancerNodeErrorSchema = z.object({
 ...
 */
export const putNodeBalancerNodeMutationRequestSchema = z.union([z.object({
...
export const putNodeBalancerNodeMutationResponseSchema = z.lazy(() => putNodeBalancerNode200Schema)