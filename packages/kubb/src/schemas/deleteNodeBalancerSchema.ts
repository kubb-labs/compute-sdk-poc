...
export const deleteNodeBalancerPathParamsSchema = z.object({
 ...
 */
export const deleteNodeBalancer200Schema = z.object({
 ...
 */
export const deleteNodeBalancerErrorSchema = z.object({
...
export const deleteNodeBalancerMutationResponseSchema = z.lazy(() => deleteNodeBalancer200Schema)