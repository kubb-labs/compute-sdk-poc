...
export const deleteEntityTransferPathParamsSchema = z.object({
 ...
 */
export const deleteEntityTransfer200Schema = z.object({
 ...
 */
export const deleteEntityTransferErrorSchema = z.object({
...
export const deleteEntityTransferMutationResponseSchema = z.lazy(() => deleteEntityTransfer200Schema)