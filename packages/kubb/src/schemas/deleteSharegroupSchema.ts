...
export const deleteSharegroupPathParamsSchema = z.object({
 ...
 */
export const deleteSharegroup200Schema = z.object({
 ...
 */
export const deleteSharegroupErrorSchema = z.object({
...
export const deleteSharegroupMutationResponseSchema = z.lazy(() => deleteSharegroup200Schema)