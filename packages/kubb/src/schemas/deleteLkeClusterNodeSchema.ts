...
export const deleteLkeClusterNodePathParamsSchema = z.object({
 ...
 */
export const deleteLkeClusterNode200Schema = z.object({
 ...
 */
export const deleteLkeClusterNodeErrorSchema = z.object({
...
export const deleteLkeClusterNodeMutationResponseSchema = z.lazy(() => deleteLkeClusterNode200Schema)