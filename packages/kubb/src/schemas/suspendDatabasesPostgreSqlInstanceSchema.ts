...
export const suspendDatabasesPostgreSqlInstancePathParamsSchema = z.object({
 ...
 */
export const suspendDatabasesPostgreSqlInstance200Schema = z.object({
 ...
 */
export const suspendDatabasesPostgreSqlInstanceErrorSchema = z.object({
...
export const suspendDatabasesPostgreSqlInstanceMutationResponseSchema = z.lazy(() => suspendDatabasesPostgreSqlInstance200Schema)