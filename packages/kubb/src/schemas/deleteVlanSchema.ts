...
export const deleteVlanPathParamsSchema = z.object({
    "label": z.string().describe("The label of the VLAN to be deleted."),
"regionId": z.string().describe("The VLAN's region.")
    })

/**
 * @description The VLAN was deleted.
 */
export const deleteVlan200Schema = z.object({
 ...
 */
export const deleteVlanErrorSchema = z.object({
...
export const deleteVlanMutationResponseSchema = z.lazy(() => deleteVlan200Schema)