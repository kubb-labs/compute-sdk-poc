...
export const getLkeClusterDashboardPathParamsSchema = z.object({
 ...
 */
export const getLkeClusterDashboard200Schema = z.object({
    "url": z.optional(z.string().describe("The Cluster Dashboard access URL."))
    })

/**
 * @description See [Errors](https://techdocs.akamai.com/linode-api/reference/errors) for the range of possible error response codes.
 */
export const getLkeClusterDashboardErrorSchema = z.object({
...
export const getLkeClusterDashboardQueryResponseSchema = z.lazy(() => getLkeClusterDashboard200Schema)