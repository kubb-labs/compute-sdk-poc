...
export const putDatabasesMysqlInstancePathParamsSchema = z.object({
 ...
 */
export const putDatabasesMysqlInstance200Schema = z.object({
 ...
 */
export const putDatabasesMysqlInstanceErrorSchema = z.object({
...
export const putDatabasesMysqlInstanceMutationRequestSchema = z.object({
...
"version": z.optional(z.string().describe("__Filterable__ The Managed Database engine version."))
    }).describe("Updated information for the Managed MySQL Database.")

export const putDatabasesMysqlInstanceMutationResponseSchema = z.lazy(() => putDatabasesMysqlInstance200Schema)