...
export const postApplyFirewallsPathParamsSchema = z.object({
 ...
 */
export const postApplyFirewalls200Schema = z.object({
 ...
 */
export const postApplyFirewallsErrorSchema = z.object({
...
export const postApplyFirewallsMutationResponseSchema = z.lazy(() => postApplyFirewalls200Schema)