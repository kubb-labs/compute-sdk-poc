 ...
 */
export const deletePaymentMethod200Schema = z.object({
 ...
 */
export const deletePaymentMethodErrorSchema = z.object({
...
export const deletePaymentMethodMutationResponseSchema = z.lazy(() => deletePaymentMethod200Schema)