...
export const postEventSeenPathParamsSchema = z.object({
    "apiVersion": z.enum(["v4", "v4beta"]).describe("__Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta."),
"eventId": z.coerce.number().int().describe("The ID of the Event to designate as seen.")
    })

/**
 * @description Event acknowledged and marked as seen.
 */
export const postEventSeen200Schema = z.object({
 ...
 */
export const postEventSeenErrorSchema = z.object({
...
export const postEventSeenMutationResponseSchema = z.lazy(() => postEventSeen200Schema)