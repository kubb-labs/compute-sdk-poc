...
export const getDatabasesMysqlInstancesQueryParamsSchema = z.object({
...
/**
 * @description Returns a paginated list of all accessible MySQL Managed Databases on your account.
 */
export const getDatabasesMysqlInstances200Schema = z.object({
 ...
 */
export const getDatabasesMysqlInstancesErrorSchema = z.object({
...
export const getDatabasesMysqlInstancesQueryResponseSchema = z.lazy(() => getDatabasesMysqlInstances200Schema)