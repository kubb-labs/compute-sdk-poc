...
export const getUserPreferencesPathParamsSchema = z.object({
 ...
 */
export const getUserPreferences200Schema = z.object({
    
    }).describe("A dictionary of user preferences.")

/**
 * @description See [Errors](https://techdocs.akamai.com/linode-api/reference/errors) for the range of possible error response codes.
 */
export const getUserPreferencesErrorSchema = z.object({
...
export const getUserPreferencesQueryResponseSchema = z.lazy(() => getUserPreferences200Schema)