 ...
 */
export const putSharegroupImageshare200Schema = z.object({
...
export const putSharegroupImageshareMutationRequestSchema = z.object({
    "description": z.optional(z.string().describe("A detailed description of this image share.")),
"label": z.optional(z.string().describe("The shared image's descriptive name."))
    }).describe("The shared image's details you want to update.")

export const putSharegroupImageshareMutationResponseSchema = z.lazy(() => putSharegroupImageshare200Schema)