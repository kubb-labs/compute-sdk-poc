...
export const deleteLinodeInstancePathParamsSchema = z.object({
 ...
 */
export const deleteLinodeInstance200Schema = z.object({
 ...
 */
export const deleteLinodeInstanceErrorSchema = z.object({
...
export const deleteLinodeInstanceMutationResponseSchema = z.lazy(() => deleteLinodeInstance200Schema)