...
export const deleteLkeClusterAclPathParamsSchema = z.object({
 ...
 */
export const deleteLkeClusterAcl200Schema = z.object({
 ...
 */
export const deleteLkeClusterAcl400Schema = z.object({
 ...
 */
export const deleteLkeClusterAcl404Schema = z.object({
    "errors": z.array(z.object({
    "field": z.string().describe("The field in the request that caused this error. This may be a path, separated by periods in the case of nested fields. In some cases this may come back as `null` if the error is not specific to any single element of the request."),
 ...
 */
export const deleteLkeClusterAclErrorSchema = z.object({
    "errors": z.array(z.object({
    "field": z.string().describe("The field in the request that caused this error. This may be a path, separated by periods in the case of nested fields. In some cases this may come back as `null` if the error is not specific to any single element of the request."),
...
export const deleteLkeClusterAclMutationResponseSchema = z.lazy(() => deleteLkeClusterAcl200Schema)