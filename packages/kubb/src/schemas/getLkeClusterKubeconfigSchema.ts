...
export const getLkeClusterKubeconfigPathParamsSchema = z.object({
 ...
 */
export const getLkeClusterKubeconfig200Schema = z.object({
    "kubeconfig": z.optional(z.string().describe("__Read-only__ The Base64-encoded Kubeconfig file for this Cluster."))
    })

/**
 * @description See [Errors](https://techdocs.akamai.com/linode-api/reference/errors) for the range of possible error response codes.
 */
export const getLkeClusterKubeconfigErrorSchema = z.object({
...
export const getLkeClusterKubeconfigQueryResponseSchema = z.lazy(() => getLkeClusterKubeconfig200Schema)