...
export const getObjectStorageTransfer200Schema = z.object({
    "used": z.int().describe("__Read-only__ The amount of outbound data transfer used by your account's Object Storage buckets, in bytes, for the current month's billing cycle.")
    })
