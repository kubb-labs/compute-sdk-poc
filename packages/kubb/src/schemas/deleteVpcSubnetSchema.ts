...
export const deleteVpcSubnetPathParamsSchema = z.object({
 ...
 */
export const deleteVpcSubnet200Schema = z.object({
 ...
 */
export const deleteVpcSubnetErrorSchema = z.object({
...
export const deleteVpcSubnetMutationResponseSchema = z.lazy(() => deleteVpcSubnet200Schema)