...
export const postCreditCardPathParamsSchema = z.object({
 ...
 */
export const postCreditCard200Schema = z.object({
 ...
 */
export const postCreditCardErrorSchema = z.object({
 ...
 */
export const postCreditCardMutationRequestSchema = z.object({
...
export const postCreditCardMutationResponseSchema = z.lazy(() => postCreditCard200Schema)