...
export const putManagedContactPathParamsSchema = z.object({
 ...
 */
export const putManagedContact200Schema = z.object({
 ...
 */
export const putManagedContactErrorSchema = z.object({
 ...
 */
export const putManagedContactMutationRequestSchema = z.object({
...
"updated": z.optional(z.string().datetime().describe("__Read-only__ When this Contact was last updated."))
    }).describe("Information about someone Linode's special forces may contact in case an issue is detected with a manager service.").omit({ 'id': true,'updated': true })

export const putManagedContactMutationResponseSchema = z.lazy(() => putManagedContact200Schema)