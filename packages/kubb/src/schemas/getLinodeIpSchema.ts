...
export const getLinodeIpPathParamsSchema = z.object({
 ...
 */
export const getLinodeIp200Schema = z.object({
 ...
 */
export const getLinodeIpErrorSchema = z.object({
...
export const getLinodeIpQueryResponseSchema = z.lazy(() => getLinodeIp200Schema)