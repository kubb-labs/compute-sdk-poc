...
export const deleteLkeClusterKubeconfigPathParamsSchema = z.object({
 ...
 */
export const deleteLkeClusterKubeconfig200Schema = z.object({
 ...
 */
export const deleteLkeClusterKubeconfigErrorSchema = z.object({
...
export const deleteLkeClusterKubeconfigMutationResponseSchema = z.lazy(() => deleteLkeClusterKubeconfig200Schema)