...
export const deleteDomainRecordPathParamsSchema = z.object({
 ...
 */
export const deleteDomainRecord200Schema = z.object({
 ...
 */
export const deleteDomainRecordErrorSchema = z.object({
...
export const deleteDomainRecordMutationResponseSchema = z.lazy(() => deleteDomainRecord200Schema)