...
export const getPersonalAccessTokenPathParamsSchema = z.object({
 ...
 */
export const getPersonalAccessToken200Schema = z.object({
 ...
 */
export const getPersonalAccessTokenErrorSchema = z.object({
...
export const getPersonalAccessTokenQueryResponseSchema = z.lazy(() => getPersonalAccessToken200Schema)