...
export const getVpcIpsPathParamsSchema = z.object({
    "vpcId": z.coerce.number().int().describe("The `id` of the VPC.")
    })

export const getVpcIpsQueryParamsSchema = z.object({
 ...
 */
export const getVpcIps200Schema = z.object({
 ...
 */
export const getVpcIpsErrorSchema = z.object({
...
export const getVpcIpsQueryResponseSchema = z.lazy(() => getVpcIps200Schema)