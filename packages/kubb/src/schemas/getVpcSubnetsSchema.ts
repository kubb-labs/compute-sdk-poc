...
export const getVpcSubnetsPathParamsSchema = z.object({
...
export const getVpcSubnetsQueryParamsSchema = z.object({
 ...
 */
export const getVpcSubnets200Schema = z.object({
 ...
 */
export const getVpcSubnetsErrorSchema = z.object({
...
export const getVpcSubnetsQueryResponseSchema = z.lazy(() => getVpcSubnets200Schema)