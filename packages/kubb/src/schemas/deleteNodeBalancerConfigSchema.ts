...
export const deleteNodeBalancerConfigPathParamsSchema = z.object({
 ...
 */
export const deleteNodeBalancerConfig200Schema = z.object({
 ...
 */
export const deleteNodeBalancerConfigErrorSchema = z.object({
...
export const deleteNodeBalancerConfigMutationResponseSchema = z.lazy(() => deleteNodeBalancerConfig200Schema)