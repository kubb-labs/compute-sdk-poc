...
export const deleteNodeBalancerConfigNodePathParamsSchema = z.object({
 ...
 */
export const deleteNodeBalancerConfigNode200Schema = z.object({
 ...
 */
export const deleteNodeBalancerConfigNodeErrorSchema = z.object({
...
export const deleteNodeBalancerConfigNodeMutationResponseSchema = z.lazy(() => deleteNodeBalancerConfigNode200Schema)