...
export const postManagedCredentialRevokePathParamsSchema = z.object({
 ...
 */
export const postManagedCredentialRevoke200Schema = z.object({
 ...
 */
export const postManagedCredentialRevokeErrorSchema = z.object({
...
export const postManagedCredentialRevokeMutationResponseSchema = z.lazy(() => postManagedCredentialRevoke200Schema)