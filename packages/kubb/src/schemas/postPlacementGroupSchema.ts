 ...
 */
export const postPlacementGroup200Schema = z.object({
 ...
 */
export const postPlacementGroupErrorSchema = z.object({
...
export const postPlacementGroupMutationRequestSchema = z.object({
