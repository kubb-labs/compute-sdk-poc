...
export const getNodeBalancerPathParamsSchema = z.object({
 ...
 */
export const getNodeBalancer200Schema = z.object({
 ...
 */
export const getNodeBalancerErrorSchema = z.object({
...
export const getNodeBalancerQueryResponseSchema = z.lazy(() => getNodeBalancer200Schema)