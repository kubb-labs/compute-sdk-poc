...
export const deleteLkeClusterPathParamsSchema = z.object({
 ...
 */
export const deleteLkeCluster200Schema = z.object({
 ...
 */
export const deleteLkeClusterErrorSchema = z.object({
...
export const deleteLkeClusterMutationResponseSchema = z.lazy(() => deleteLkeCluster200Schema)