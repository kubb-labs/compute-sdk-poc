...
export const postShutdownLinodeInstancePathParamsSchema = z.object({
    "linodeId": z.coerce.number().int().describe("ID of the Linode to shutdown.")
    })

/**
 * @description Shutdown started.
 */
export const postShutdownLinodeInstance200Schema = z.object({
 ...
 */
export const postShutdownLinodeInstanceErrorSchema = z.object({
...
export const postShutdownLinodeInstanceMutationResponseSchema = z.lazy(() => postShutdownLinodeInstance200Schema)