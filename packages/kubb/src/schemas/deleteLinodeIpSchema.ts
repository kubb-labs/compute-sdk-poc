...
export const deleteLinodeIpPathParamsSchema = z.object({
 ...
 */
export const deleteLinodeIp200Schema = z.object({
 ...
 */
export const deleteLinodeIpErrorSchema = z.object({
...
export const deleteLinodeIpMutationResponseSchema = z.lazy(() => deleteLinodeIp200Schema)