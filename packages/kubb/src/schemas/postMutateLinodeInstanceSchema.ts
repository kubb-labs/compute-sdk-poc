...
export const postMutateLinodeInstancePathParamsSchema = z.object({
    "apiVersion": z.enum(["v4", "v4beta"]).describe("__Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta."),
"linodeId": z.coerce.number().int().describe("ID of the Linode to mutate.")
    })

/**
 * @description Mutate started.
 */
export const postMutateLinodeInstance200Schema = z.object({
 ...
 */
export const postMutateLinodeInstanceErrorSchema = z.object({
 ...
 */
export const postMutateLinodeInstanceMutationRequestSchema = z.object({
...
export const postMutateLinodeInstanceMutationResponseSchema = z.lazy(() => postMutateLinodeInstance200Schema)