...
export const postCloseTicketPathParamsSchema = z.object({
 ...
 */
export const postCloseTicket200Schema = z.object({
 ...
 */
export const postCloseTicketErrorSchema = z.object({
...
export const postCloseTicketMutationResponseSchema = z.lazy(() => postCloseTicket200Schema)