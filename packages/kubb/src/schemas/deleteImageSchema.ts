 ...
 */
export const deleteImage200Schema = z.object({
 ...
 */
export const deleteImageErrorSchema = z.object({
...
export const deleteImageMutationResponseSchema = z.lazy(() => deleteImage200Schema)