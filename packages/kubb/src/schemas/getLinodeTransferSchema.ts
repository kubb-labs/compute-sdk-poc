...
export const getLinodeTransferPathParamsSchema = z.object({
 ...
 */
export const getLinodeTransfer200Schema = z.object({
    "billable": z.optional(z.int().describe("__Read-only__ The amount of network transfer this Linode has used, in GB, past your monthly quota.")),
"quota": z.optional(z.int().describe("__Read-only__ The amount of network transfer this Linode adds to your transfer pool, in GB, for the current month's billing cycle.")),
"used": z.optional(z.int().describe("__Read-only__ The amount of network transfer used by this Linode, in bytes, for the current month's billing cycle."))
    })

/**
 * @description See [Errors](https://techdocs.akamai.com/linode-api/reference/errors) for the range of possible error response codes.
 */
export const getLinodeTransferErrorSchema = z.object({
...
export const getLinodeTransferQueryResponseSchema = z.lazy(() => getLinodeTransfer200Schema)