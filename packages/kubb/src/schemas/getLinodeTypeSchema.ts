...
export const getLinodeTypePathParamsSchema = z.object({
    "typeId": z.string().describe("The ID of the Linode Type to look up.")
    })

/**
 * @description A single Linode Type.
 */
export const getLinodeType200Schema = z.object({
    "addons": z.object({
    "backups": z.object({
    "price": z.object({
...
"vcpus": z.int().describe("__Filterable__, __Read-only__ The number of VCPU cores this Linode type offers.")
    }).describe("The available Linode types, including pricing and specifications for each. Use them when [creating](https://techdocs.akamai.com/linode-api/reference/post-linode-instance) or [resizing](https://techdocs.akamai.com/linode-api/reference/post-resize-linode-instance) Linodes.")

/**
 * @description See [Errors](https://techdocs.akamai.com/linode-api/reference/errors) for the range of possible error response codes.
 */
export const getLinodeTypeErrorSchema = z.object({
...
export const getLinodeTypeQueryResponseSchema = z.lazy(() => getLinodeType200Schema)