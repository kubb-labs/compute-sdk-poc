...
export const getLinodeDiskPathParamsSchema = z.object({
 ...
 */
export const getLinodeDisk200Schema = z.object({
 ...
 */
export const getLinodeDiskErrorSchema = z.object({
...
export const getLinodeDiskQueryResponseSchema = z.lazy(() => getLinodeDisk200Schema)