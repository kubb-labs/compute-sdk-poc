...
"cluster": z.string().describe("__Deprecated__ For backwards compatibility, this is included to identify the legacy cluster equivalent of the `region` where this key can be used. The key grants access to each specified `bucket_name`, based on the `permissions` set.\n\n> 📘\n>\n> Use of clusters in a limited access key has been deprecated."),
...
"region": z.string().describe("The region where the `bucket_name` resides.")
...
"id": z.int().describe("This Object Storage key's unique ID."),
"label": z.string().describe("The label given to this key. For display purposes only."),
"limited": z.boolean().describe("Whether this Object Storage key limits access to specific buckets and permissions. Returns `false` if this key grants full access. Specific limitations are set in `bucket_access`."),
