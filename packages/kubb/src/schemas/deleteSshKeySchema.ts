...
export const deleteSshKeyPathParamsSchema = z.object({
 ...
 */
export const deleteSshKey200Schema = z.object({
 ...
 */
export const deleteSshKeyErrorSchema = z.object({
...
export const deleteSshKeyMutationResponseSchema = z.lazy(() => deleteSshKey200Schema)