...
export const postImagePathParamsSchema = z.object({
 ...
 */
export const postImage200Schema = z.object({
 ...
 */
export const postImageErrorSchema = z.object({
...
export const postImageMutationRequestSchema = z.object({
    "cloud_init": z.optional(z.boolean().describe("Whether this image supports [cloud-init](https://www.linode.com/docs/guides/write-files-with-cloud-init/).")),
"description": z.optional(z.string().describe("A detailed description of this image.")),
"disk_id": z.int().describe("The ID of the target Linode disk for this image."),
"label": z.optional(z.string().describe("The short title for this image. If not provided, the disk's current label is used.")),
"tags": z.optional(z.array(z.string().min(3).max(100)).min(0).max(500).describe("Tags used for organizational purposes. A tag can be from 3 to 100 characters long, and an image can have a maximum of 500 total tags."))
    })

export const postImageMutationResponseSchema = z.lazy(() => postImage200Schema)