...
export const getDatabasesInstancesPathParamsSchema = z.object({
...
"engine": z.optional(z.enum(["mysql", "postgresql"]).describe("__Filterable__, __Read-only__ The Managed Database engine type.")),
...
"instance_uri": z.optional(z.string().describe("__Read-only__ Append this to `https://api.linode.com` to run commands for the Managed Database.")),
