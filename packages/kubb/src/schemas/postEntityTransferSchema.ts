...
export const postEntityTransferPathParamsSchema = z.object({
 ...
 */
export const postEntityTransfer200Schema = z.object({
 ...
 */
export const postEntityTransferErrorSchema = z.object({
 ...
 */
export const postEntityTransferMutationRequestSchema = z.object({
    "entities": z.object({
    "linodes": z.optional(z.array(z.int()).describe("An array containing the IDs of each of the Linodes included in this transfer."))
    }).describe("A collection of the entities to include in this transfer request, separated by type.")
    })

export const postEntityTransferMutationResponseSchema = z.lazy(() => postEntityTransfer200Schema)