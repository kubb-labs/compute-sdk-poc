...
export const postResetDiskPasswordPathParamsSchema = z.object({
 ...
 */
export const postResetDiskPassword200Schema = z.object({
 ...
 */
export const postResetDiskPasswordErrorSchema = z.object({
 ...
 */
export const postResetDiskPasswordMutationRequestSchema = z.object({
...
export const postResetDiskPasswordMutationResponseSchema = z.lazy(() => postResetDiskPassword200Schema)