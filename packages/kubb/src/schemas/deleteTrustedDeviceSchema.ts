...
export const deleteTrustedDevicePathParamsSchema = z.object({
 ...
 */
export const deleteTrustedDevice200Schema = z.object({
 ...
 */
export const deleteTrustedDeviceErrorSchema = z.object({
...
export const deleteTrustedDeviceMutationResponseSchema = z.lazy(() => deleteTrustedDevice200Schema)