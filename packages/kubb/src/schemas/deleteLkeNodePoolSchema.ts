...
export const deleteLkeNodePoolPathParamsSchema = z.object({
 ...
 */
export const deleteLkeNodePool200Schema = z.object({
 ...
 */
export const deleteLkeNodePoolErrorSchema = z.object({
...
export const deleteLkeNodePoolMutationResponseSchema = z.lazy(() => deleteLkeNodePool200Schema)