...
export const getIpPathParamsSchema = z.object({
 ...
 */
export const getIp200Schema = z.object({
 ...
 */
export const getIpErrorSchema = z.object({
...
export const getIpQueryResponseSchema = z.lazy(() => getIp200Schema)