...
export const deleteManagedContactPathParamsSchema = z.object({
 ...
 */
export const deleteManagedContact200Schema = z.object({
 ...
 */
export const deleteManagedContactErrorSchema = z.object({
...
export const deleteManagedContactMutationResponseSchema = z.lazy(() => deleteManagedContact200Schema)