...
export const postCancelBackupsPathParamsSchema = z.object({
    "linodeId": z.coerce.number().int().describe("The ID of the Linode to cancel backup service for.")
    })

/**
 * @description Backup service was canceled for the specified Linode.
 */
export const postCancelBackups200Schema = z.object({
 ...
 */
export const postCancelBackupsErrorSchema = z.object({
...
export const postCancelBackupsMutationResponseSchema = z.lazy(() => postCancelBackups200Schema)