...
export const getNodeBalancerNodePathParamsSchema = z.object({
 ...
 */
export const getNodeBalancerNode200Schema = z.union([z.object({
 ...
 */
export const getNodeBalancerNodeErrorSchema = z.object({
...
export const getNodeBalancerNodeQueryResponseSchema = z.lazy(() => getNodeBalancerNode200Schema)