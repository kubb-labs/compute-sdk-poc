...
export const postDatabasesPostgreSqlInstanceCredentialsResetPathParamsSchema = z.object({
 ...
 */
export const postDatabasesPostgreSqlInstanceCredentialsReset200Schema = z.object({
 ...
 */
export const postDatabasesPostgreSqlInstanceCredentialsResetErrorSchema = z.object({
...
export const postDatabasesPostgreSqlInstanceCredentialsResetMutationResponseSchema = z.lazy(() => postDatabasesPostgreSqlInstanceCredentialsReset200Schema)