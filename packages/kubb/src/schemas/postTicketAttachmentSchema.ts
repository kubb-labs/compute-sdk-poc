...
export const postTicketAttachmentPathParamsSchema = z.object({
 ...
 */
export const postTicketAttachment200Schema = z.object({
 ...
 */
export const postTicketAttachmentErrorSchema = z.object({
...
export const postTicketAttachmentMutationRequestSchema = z.object({
    "file": z.string().describe("The local, absolute path to the file you want to attach to your support ticket.")
    })

export const postTicketAttachmentMutationResponseSchema = z.lazy(() => postTicketAttachment200Schema)