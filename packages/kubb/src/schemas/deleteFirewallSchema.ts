...
export const deleteFirewallPathParamsSchema = z.object({
 ...
 */
export const deleteFirewall200Schema = z.object({
 ...
 */
export const deleteFirewallErrorSchema = z.object({
...
export const deleteFirewallMutationResponseSchema = z.lazy(() => deleteFirewall200Schema)