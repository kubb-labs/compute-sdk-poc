...
export const postGroupUnassignPathParamsSchema = z.object({
 ...
 */
export const postGroupUnassign200Schema = z.object({
 ...
 */
export const postGroupUnassignErrorSchema = z.object({
...
export const postGroupUnassignMutationRequestSchema = z.object({
...
export const postGroupUnassignMutationResponseSchema = z.lazy(() => postGroupUnassign200Schema)