...
export const postDetachVolumePathParamsSchema = z.object({
 ...
 */
export const postDetachVolume200Schema = z.object({
 ...
 */
export const postDetachVolumeErrorSchema = z.object({
...
export const postDetachVolumeMutationResponseSchema = z.lazy(() => postDetachVolume200Schema)