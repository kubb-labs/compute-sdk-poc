...
export const postObjectStorageBucketAccessPathParamsSchema = z.object({
 ...
 */
export const postObjectStorageBucketAccess200Schema = z.object({
 ...
 */
export const postObjectStorageBucketAccessErrorSchema = z.object({
...
export const postObjectStorageBucketAccessMutationRequestSchema = z.object({
...
"cors_enabled": z.optional(z.boolean().describe("If `true`, cross-origin resource sharing (CORS) is enabled for all origins in the bucket."))
    })

export const postObjectStorageBucketAccessMutationResponseSchema = z.lazy(() => postObjectStorageBucketAccess200Schema)