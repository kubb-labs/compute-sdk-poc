...
export const postAcceptEntityTransferPathParamsSchema = z.object({
 ...
 */
export const postAcceptEntityTransfer200Schema = z.object({
 ...
 */
export const postAcceptEntityTransferErrorSchema = z.object({
...
export const postAcceptEntityTransferMutationResponseSchema = z.lazy(() => postAcceptEntityTransfer200Schema)