...
export const getLongviewClientPathParamsSchema = z.object({
 ...
 */
export const getLongviewClient200Schema = z.object({
 ...
 */
export const getLongviewClientErrorSchema = z.object({
...
export const getLongviewClientQueryResponseSchema = z.lazy(() => getLongviewClient200Schema)