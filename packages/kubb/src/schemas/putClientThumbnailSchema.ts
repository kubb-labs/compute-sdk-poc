...
export const putClientThumbnailPathParamsSchema = z.object({
 ...
 */
export const putClientThumbnail200Schema = z.object({
 ...
 */
export const putClientThumbnailErrorSchema = z.object({
 ...
 */
export const putClientThumbnailMutationRequestSchema = z.instanceof(File)

export const putClientThumbnailMutationResponseSchema = z.lazy(() => putClientThumbnail200Schema)