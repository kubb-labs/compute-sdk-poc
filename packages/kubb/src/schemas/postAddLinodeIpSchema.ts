...
export const postAddLinodeIpPathParamsSchema = z.object({
 ...
 */
export const postAddLinodeIp200Schema = z.object({
 ...
 */
export const postAddLinodeIpErrorSchema = z.object({
 ...
 */
export const postAddLinodeIpMutationRequestSchema = z.object({
    "public": z.boolean().describe("Whether to create a public or private IPv4 address."),
"type": z.enum(["ipv4"]).describe("The type of address you are allocating. Only IPv4 addresses may be allocated through this operation.")
    })

export const postAddLinodeIpMutationResponseSchema = z.lazy(() => postAddLinodeIp200Schema)