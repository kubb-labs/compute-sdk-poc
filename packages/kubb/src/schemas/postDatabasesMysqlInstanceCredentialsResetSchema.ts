...
export const postDatabasesMysqlInstanceCredentialsResetPathParamsSchema = z.object({
 ...
 */
export const postDatabasesMysqlInstanceCredentialsReset200Schema = z.object({
 ...
 */
export const postDatabasesMysqlInstanceCredentialsResetErrorSchema = z.object({
...
export const postDatabasesMysqlInstanceCredentialsResetMutationResponseSchema = z.lazy(() => postDatabasesMysqlInstanceCredentialsReset200Schema)