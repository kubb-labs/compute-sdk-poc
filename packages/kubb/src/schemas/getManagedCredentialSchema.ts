...
export const getManagedCredentialPathParamsSchema = z.object({
 ...
 */
export const getManagedCredential200Schema = z.object({
 ...
 */
export const getManagedCredentialErrorSchema = z.object({
...
export const getManagedCredentialQueryResponseSchema = z.lazy(() => getManagedCredential200Schema)