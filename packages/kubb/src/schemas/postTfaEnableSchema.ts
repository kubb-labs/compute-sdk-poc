...
export const postTfaEnable200Schema = z.object({
    "expiry": z.string().datetime().describe("When this Two Factor secret expires."),
"secret": z.string().describe("Your Two Factor secret. This is used to generate time-based two factor codes required for logging in. Doing this will be required to confirm TFA an actually enable it.")
    })
