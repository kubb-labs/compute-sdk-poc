...
export const getStackScriptPathParamsSchema = z.object({
 ...
 */
export const getStackScript200Schema = z.object({
 ...
 */
export const getStackScriptErrorSchema = z.object({
...
export const getStackScriptQueryResponseSchema = z.lazy(() => getStackScript200Schema)