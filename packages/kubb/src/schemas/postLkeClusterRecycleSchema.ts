...
export const postLkeClusterRecyclePathParamsSchema = z.object({
    "clusterId": z.coerce.number().int().describe("ID of the Kubernetes cluster which contains nodes to be recycled.")
    })

/**
 * @description Recycle request succeeded and is in progress.
 */
export const postLkeClusterRecycle200Schema = z.object({
 ...
 */
export const postLkeClusterRecycleErrorSchema = z.object({
...
export const postLkeClusterRecycleMutationResponseSchema = z.lazy(() => postLkeClusterRecycle200Schema)