...
export const postDatabasesMysqlInstancePatchPathParamsSchema = z.object({
 ...
 */
export const postDatabasesMysqlInstancePatch200Schema = z.object({
 ...
 */
export const postDatabasesMysqlInstancePatchErrorSchema = z.object({
...
export const postDatabasesMysqlInstancePatchMutationResponseSchema = z.lazy(() => postDatabasesMysqlInstancePatch200Schema)