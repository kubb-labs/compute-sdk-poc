...
export const getObjectStorageBucketAclPathParamsSchema = z.object({
...
export const getObjectStorageBucketAclQueryParamsSchema = z.object({
 ...
 */
export const getObjectStorageBucketAcl200Schema = z.object({
 ...
 */
export const getObjectStorageBucketAclErrorSchema = z.object({
...
export const getObjectStorageBucketAclQueryResponseSchema = z.lazy(() => getObjectStorageBucketAcl200Schema)