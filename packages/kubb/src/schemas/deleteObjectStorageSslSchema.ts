...
export const deleteObjectStorageSslPathParamsSchema = z.object({
 ...
 */
export const deleteObjectStorageSsl200Schema = z.object({
 ...
 */
export const deleteObjectStorageSslErrorSchema = z.object({
...
export const deleteObjectStorageSslMutationResponseSchema = z.lazy(() => deleteObjectStorageSsl200Schema)