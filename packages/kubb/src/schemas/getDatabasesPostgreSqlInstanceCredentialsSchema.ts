...
export const getDatabasesPostgreSqlInstanceCredentials200Schema = z.object({
    "password": z.optional(z.string().describe("__Read-only__ The randomly generated root password for the Managed Database instance.")),
"username": z.optional(z.string().describe("__Read-only__ The root username for the Managed Database instance."))
