...
export const postServiceTransferPathParamsSchema = z.object({
 ...
 */
export const postServiceTransfer200Schema = z.object({
 ...
 */
export const postServiceTransferErrorSchema = z.object({
 ...
 */
export const postServiceTransferMutationRequestSchema = z.object({
    "entities": z.object({
    "linodes": z.optional(z.array(z.int()).describe("An array containing the IDs of each of the Linodes included in this transfer."))
    }).describe("A collection of the services to include in this transfer request, separated by type.")
    })

export const postServiceTransferMutationResponseSchema = z.lazy(() => postServiceTransfer200Schema)