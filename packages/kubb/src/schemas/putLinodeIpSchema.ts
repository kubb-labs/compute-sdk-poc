...
export const putLinodeIpPathParamsSchema = z.object({
 ...
 */
export const putLinodeIp200Schema = z.object({
 ...
 */
export const putLinodeIpErrorSchema = z.object({
 ...
 */
export const putLinodeIpMutationRequestSchema = z.object({
    "rdns": z.nullable(z.string().describe("The reverse DNS assigned to this address. For public IPv4 addresses, this will be set to a default value provided by Linode if not explicitly set."))
    })

export const putLinodeIpMutationResponseSchema = z.lazy(() => putLinodeIp200Schema)