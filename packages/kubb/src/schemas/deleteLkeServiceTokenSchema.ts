...
export const deleteLkeServiceTokenPathParamsSchema = z.object({
 ...
 */
export const deleteLkeServiceToken200Schema = z.object({
 ...
 */
export const deleteLkeServiceTokenErrorSchema = z.object({
...
export const deleteLkeServiceTokenMutationResponseSchema = z.lazy(() => deleteLkeServiceToken200Schema)