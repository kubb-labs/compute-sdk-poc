...
export const deleteLinodeConfigPathParamsSchema = z.object({
 ...
 */
export const deleteLinodeConfig200Schema = z.object({
 ...
 */
export const deleteLinodeConfigErrorSchema = z.object({
...
export const deleteLinodeConfigMutationResponseSchema = z.lazy(() => deleteLinodeConfig200Schema)