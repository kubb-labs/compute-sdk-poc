...
export const getDatabasesMysqlInstanceCredentialsPathParamsSchema = z.object({
 ...
 */
export const getDatabasesMysqlInstanceCredentials200Schema = z.object({
 ...
 */
export const getDatabasesMysqlInstanceCredentialsErrorSchema = z.object({
...
export const getDatabasesMysqlInstanceCredentialsQueryResponseSchema = z.lazy(() => getDatabasesMysqlInstanceCredentials200Schema)