...
export const resumeDatabasesMysqlInstancePathParamsSchema = z.object({
 ...
 */
export const resumeDatabasesMysqlInstance200Schema = z.object({
 ...
 */
export const resumeDatabasesMysqlInstanceErrorSchema = z.object({
...
export const resumeDatabasesMysqlInstanceMutationResponseSchema = z.lazy(() => resumeDatabasesMysqlInstance200Schema)