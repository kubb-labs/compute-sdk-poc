...
export const deleteObjectStorageKeyPathParamsSchema = z.object({
 ...
 */
export const deleteObjectStorageKey200Schema = z.object({
 ...
 */
export const deleteObjectStorageKeyErrorSchema = z.object({
...
export const deleteObjectStorageKeyMutationResponseSchema = z.lazy(() => deleteObjectStorageKey200Schema)