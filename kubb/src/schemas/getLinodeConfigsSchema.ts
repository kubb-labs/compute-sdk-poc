...
export const getLinodeConfigsPathParamsSchema = z.object({
    "apiVersion": z.enum(["v4", "v4beta"]).describe("__Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta."),
"linodeId": z.coerce.number().int().describe("ID of the Linode to look up Configuration profiles for.")
    })

export const getLinodeConfigsQueryParamsSchema = z.object({
 ...
 */
export const getLinodeConfigs200Schema = z.object({
...
export const getLinodeConfigsQueryResponseSchema = z.lazy(() => getLinodeConfigs200Schema)