...
export const getDatabasesPostgreSqlInstancePathParamsSchema = z.object({
 ...
 */
export const getDatabasesPostgreSqlInstance200Schema = z.object({
 ...
 */
export const getDatabasesPostgreSqlInstanceErrorSchema = z.object({
...
export const getDatabasesPostgreSqlInstanceQueryResponseSchema = z.lazy(() => getDatabasesPostgreSqlInstance200Schema)