...
export const getDatabasesMysqlInstanceSslPathParamsSchema = z.object({
    "apiVersion": z.enum(["v4", "v4beta"]).describe("__Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta."),
"instanceId": z.coerce.number().int().describe("The ID of the Managed MySQL Database.")
    })

/**
 * @description Returns the SSL CA certificate of a single MySQL Managed Database.
 */
export const getDatabasesMysqlInstanceSsl200Schema = z.object({
 ...
 */
export const getDatabasesMysqlInstanceSslErrorSchema = z.object({
...
export const getDatabasesMysqlInstanceSslQueryResponseSchema = z.lazy(() => getDatabasesMysqlInstanceSsl200Schema)