...
export const deleteSharegroupTokenPathParamsSchema = z.object({
 ...
 */
export const deleteSharegroupToken200Schema = z.object({
 ...
 */
export const deleteSharegroupTokenErrorSchema = z.object({
...
export const deleteSharegroupTokenMutationResponseSchema = z.lazy(() => deleteSharegroupToken200Schema)