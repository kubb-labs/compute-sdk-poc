...
export const postTfaDisablePathParamsSchema = z.object({
 ...
 */
export const postTfaDisable200Schema = z.object({
 ...
 */
export const postTfaDisableErrorSchema = z.object({
...
export const postTfaDisableMutationResponseSchema = z.lazy(() => postTfaDisable200Schema)