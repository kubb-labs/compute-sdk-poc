...
export const getNodeBalancersPathParamsSchema = z.object({
    "apiVersion": z.enum(["v4", "v4beta"]).describe("__Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.")
    })

export const getNodeBalancersQueryParamsSchema = z.object({
 ...
 */
export const getNodeBalancers200Schema = z.object({
 ...
 */
export const getNodeBalancersErrorSchema = z.object({
...
export const getNodeBalancersQueryResponseSchema = z.lazy(() => getNodeBalancers200Schema)