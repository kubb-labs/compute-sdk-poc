...
export const deleteVolumePathParamsSchema = z.object({
 ...
 */
export const deleteVolume200Schema = z.object({
 ...
 */
export const deleteVolumeErrorSchema = z.object({
...
export const deleteVolumeMutationResponseSchema = z.lazy(() => deleteVolume200Schema)