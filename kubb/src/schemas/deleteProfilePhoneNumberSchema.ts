...
export const deleteProfilePhoneNumberPathParamsSchema = z.object({
 ...
 */
export const deleteProfilePhoneNumber200Schema = z.object({
 ...
 */
export const deleteProfilePhoneNumberErrorSchema = z.object({
...
export const deleteProfilePhoneNumberMutationResponseSchema = z.lazy(() => deleteProfilePhoneNumber200Schema)