...
export const getObjectStorageKeyPathParamsSchema = z.object({
 ...
 */
export const getObjectStorageKey200Schema = z.object({
 ...
 */
export const getObjectStorageKeyErrorSchema = z.object({
...
export const getObjectStorageKeyQueryResponseSchema = z.lazy(() => getObjectStorageKey200Schema)