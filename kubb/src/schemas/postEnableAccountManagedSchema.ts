...
export const postEnableAccountManagedPathParamsSchema = z.object({
 ...
 */
export const postEnableAccountManaged200Schema = z.object({
 ...
 */
export const postEnableAccountManagedErrorSchema = z.object({
...
export const postEnableAccountManagedMutationResponseSchema = z.lazy(() => postEnableAccountManaged200Schema)