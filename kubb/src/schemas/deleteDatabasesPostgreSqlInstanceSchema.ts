...
export const deleteDatabasesPostgreSqlInstancePathParamsSchema = z.object({
 ...
 */
export const deleteDatabasesPostgreSqlInstance200Schema = z.object({
 ...
 */
export const deleteDatabasesPostgreSqlInstanceErrorSchema = z.object({
...
export const deleteDatabasesPostgreSqlInstanceMutationResponseSchema = z.lazy(() => deleteDatabasesPostgreSqlInstance200Schema)