...
export const postEnableBackupsPathParamsSchema = z.object({
    "apiVersion": z.enum(["v4", "v4beta"]).describe("__Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta."),
"linodeId": z.coerce.number().int().describe("The ID of the Linode to enable backup service for.")
    })

/**
 * @description Backup service was enabled.
 */
export const postEnableBackups200Schema = z.object({
 ...
 */
export const postEnableBackupsErrorSchema = z.object({
...
export const postEnableBackupsMutationResponseSchema = z.lazy(() => postEnableBackups200Schema)