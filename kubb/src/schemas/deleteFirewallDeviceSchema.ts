...
export const deleteFirewallDevicePathParamsSchema = z.object({
 ...
 */
export const deleteFirewallDevice200Schema = z.object({
 ...
 */
export const deleteFirewallDeviceErrorSchema = z.object({
...
export const deleteFirewallDeviceMutationResponseSchema = z.lazy(() => deleteFirewallDevice200Schema)