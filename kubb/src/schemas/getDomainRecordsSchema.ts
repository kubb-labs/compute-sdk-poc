...
export const getDomainRecordsPathParamsSchema = z.object({
    "apiVersion": z.enum(["v4", "v4beta"]).describe("__Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta."),
"domainId": z.coerce.number().int().describe("The ID of the Domain we are accessing Records for.")
    })

export const getDomainRecordsQueryParamsSchema = z.object({
 ...
 */
export const getDomainRecords200Schema = z.object({
...
export const getDomainRecordsQueryResponseSchema = z.lazy(() => getDomainRecords200Schema)