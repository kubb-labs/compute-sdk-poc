...
export const resumeDatabasesPostgreSqlInstancePathParamsSchema = z.object({
 ...
 */
export const resumeDatabasesPostgreSqlInstance200Schema = z.object({
 ...
 */
export const resumeDatabasesPostgreSqlInstanceErrorSchema = z.object({
...
export const resumeDatabasesPostgreSqlInstanceMutationResponseSchema = z.lazy(() => resumeDatabasesPostgreSqlInstance200Schema)