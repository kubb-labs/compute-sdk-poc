...
export const getIpv6PoolsPathParamsSchema = z.object({
...
"range": z.optional(z.string().describe("__Read-only__ The IPv6 range of addresses in this pool.")),
"region": z.optional(z.string().describe("__Filterable__, __Read-only__ The region for this pool of IPv6 addresses.")),
"route_target": z.string().describe("The last address in this block of IPv6 addresses.").nullish()
