...
export const deletePersonalAccessTokenPathParamsSchema = z.object({
 ...
 */
export const deletePersonalAccessToken200Schema = z.object({
 ...
 */
export const deletePersonalAccessTokenErrorSchema = z.object({
...
export const deletePersonalAccessTokenMutationResponseSchema = z.lazy(() => deletePersonalAccessToken200Schema)