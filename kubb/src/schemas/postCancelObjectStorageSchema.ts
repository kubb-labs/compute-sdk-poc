...
export const postCancelObjectStoragePathParamsSchema = z.object({
 ...
 */
export const postCancelObjectStorage200Schema = z.object({
 ...
 */
export const postCancelObjectStorageErrorSchema = z.object({
...
export const postCancelObjectStorageMutationResponseSchema = z.lazy(() => postCancelObjectStorage200Schema)