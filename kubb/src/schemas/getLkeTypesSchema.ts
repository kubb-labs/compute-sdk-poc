...
export const getLkeTypesPathParamsSchema = z.object({
 ...
 */
export const getLkeTypes200Schema = z.object({
    "data": z.optional(z.array(z.object({
    "id": z.optional(z.string().describe("__Read-only__ The ID representing the Kubernetes type.")),
"label": z.optional(z.string().describe("__Filterable__, __Read-only__ The Kubernetes type label is for display purposes only.")),
...
"monthly": z.optional(z.number().describe("__Filterable__ Cost per month, in US dollars."))
    }).describe("__Read-only__ The default cost of this Kubernetes type. Prices are in US dollars, broken down into hourly and monthly charges.\n\nCertain regions have different prices from the default. For region-specific prices, see `region_prices`.")),
...
"transfer": z.optional(z.int().min(0).describe("__Filterable__, __Read-only__ The monthly outbound transfer amount, in MB."))
    }).describe("Returns collection of Kubernetes types and prices, including any region-specific rates.")).describe("The Kubernetes types.")),
 ...
 */
export const getLkeTypesErrorSchema = z.object({
...
export const getLkeTypesQueryResponseSchema = z.lazy(() => getLkeTypes200Schema)