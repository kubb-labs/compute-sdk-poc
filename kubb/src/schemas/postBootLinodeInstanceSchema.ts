...
export const postBootLinodeInstancePathParamsSchema = z.object({
    "apiVersion": z.enum(["v4", "v4beta"]).describe("__Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta."),
"linodeId": z.coerce.number().int().describe("The ID of the Linode to boot.")
    })

/**
 * @description Boot started.
 */
export const postBootLinodeInstance200Schema = z.object({
 ...
 */
export const postBootLinodeInstanceErrorSchema = z.object({
 ...
 */
export const postBootLinodeInstanceMutationRequestSchema = z.object({
    "config_id": z.int().describe("The Linode Config ID to boot into.").nullish()
    })

export const postBootLinodeInstanceMutationResponseSchema = z.lazy(() => postBootLinodeInstance200Schema)