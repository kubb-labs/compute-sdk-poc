...
export const postDatabasesPostgreSqlInstancePatchPathParamsSchema = z.object({
 ...
 */
export const postDatabasesPostgreSqlInstancePatch200Schema = z.object({
 ...
 */
export const postDatabasesPostgreSqlInstancePatchErrorSchema = z.object({
...
export const postDatabasesPostgreSqlInstancePatchMutationResponseSchema = z.lazy(() => postDatabasesPostgreSqlInstancePatch200Schema)