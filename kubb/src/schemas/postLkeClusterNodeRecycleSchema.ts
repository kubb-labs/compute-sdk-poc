...
export const postLkeClusterNodeRecyclePathParamsSchema = z.object({
...
"nodeId": z.string().describe("ID of the Node to be recycled.")
    })

/**
 * @description Recycle request succeeded and is in progress.
 */
export const postLkeClusterNodeRecycle200Schema = z.object({
 ...
 */
export const postLkeClusterNodeRecycleErrorSchema = z.object({
...
export const postLkeClusterNodeRecycleMutationResponseSchema = z.lazy(() => postLkeClusterNodeRecycle200Schema)