 ...
 */
export const putIpErrorSchema = z.object({
 ...
 */
export const putIpMutationRequestSchema = z.object({
...
export const putIpMutationResponseSchema = z.lazy(() => putIp200Schema)