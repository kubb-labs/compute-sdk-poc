...
export const deleteLinodeInterfacePathParamsSchema = z.object({
 ...
 */
export const deleteLinodeInterface200Schema = z.object({
 ...
 */
export const deleteLinodeInterfaceErrorSchema = z.object({
...
export const deleteLinodeInterfaceMutationResponseSchema = z.lazy(() => deleteLinodeInterface200Schema)