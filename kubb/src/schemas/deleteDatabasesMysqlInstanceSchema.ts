...
export const deleteDatabasesMysqlInstancePathParamsSchema = z.object({
 ...
 */
export const deleteDatabasesMysqlInstance200Schema = z.object({
 ...
 */
export const deleteDatabasesMysqlInstanceErrorSchema = z.object({
...
export const deleteDatabasesMysqlInstanceMutationResponseSchema = z.lazy(() => deleteDatabasesMysqlInstance200Schema)