...
export const postAcceptServiceTransferPathParamsSchema = z.object({
 ...
 */
export const postAcceptServiceTransfer200Schema = z.object({
 ...
 */
export const postAcceptServiceTransferErrorSchema = z.object({
...
export const postAcceptServiceTransferMutationResponseSchema = z.lazy(() => postAcceptServiceTransfer200Schema)