...
export const postBetaProgramPathParamsSchema = z.object({
 ...
 */
export const postBetaProgram200Schema = z.object({
 ...
 */
export const postBetaProgramErrorSchema = z.object({
 ...
 */
export const postBetaProgramMutationRequestSchema = z.object({
    "id": z.string().describe("The unique identifier of the Beta Program.")
    }).describe("The Beta Program ID to enroll in for your Account.")

export const postBetaProgramMutationResponseSchema = z.lazy(() => postBetaProgram200Schema)