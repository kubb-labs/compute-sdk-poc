...
export const postTfaEnablePathParamsSchema = z.object({
 ...
 */
export const postTfaEnable200Schema = z.object({
    "expiry": z.optional(z.string().datetime().describe("When this Two Factor secret expires.")),
"secret": z.optional(z.string().describe("Your Two Factor secret. This is used to generate time-based two factor codes required for logging in. Doing this will be required to confirm TFA an actually enable it."))
    })

/**
 * @description See [Errors](https://techdocs.akamai.com/linode-api/reference/errors) for the range of possible error response codes.
 */
export const postTfaEnableErrorSchema = z.object({
...
export const postTfaEnableMutationResponseSchema = z.lazy(() => postTfaEnable200Schema)