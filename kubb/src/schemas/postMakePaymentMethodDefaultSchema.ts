...
export const postMakePaymentMethodDefaultPathParamsSchema = z.object({
    "apiVersion": z.enum(["v4", "v4beta"]).describe("__Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta."),
"paymentMethodId": z.coerce.number().int().describe("The ID of the Payment Method to make default.")
    })

/**
 * @description Payment Method successfully set as the default method.
 */
export const postMakePaymentMethodDefault200Schema = z.object({
 ...
 */
export const postMakePaymentMethodDefaultErrorSchema = z.object({
...
export const postMakePaymentMethodDefaultMutationResponseSchema = z.lazy(() => postMakePaymentMethodDefault200Schema)