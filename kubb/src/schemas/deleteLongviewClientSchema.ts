...
export const deleteLongviewClientPathParamsSchema = z.object({
 ...
 */
export const deleteLongviewClient200Schema = z.object({
 ...
 */
export const deleteLongviewClientErrorSchema = z.object({
...
export const deleteLongviewClientMutationResponseSchema = z.lazy(() => deleteLongviewClient200Schema)