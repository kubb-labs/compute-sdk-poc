...
export const deleteServiceTransferPathParamsSchema = z.object({
 ...
 */
export const deleteServiceTransfer200Schema = z.object({
 ...
 */
export const deleteServiceTransferErrorSchema = z.object({
...
export const deleteServiceTransferMutationResponseSchema = z.lazy(() => deleteServiceTransfer200Schema)