...
export const deleteStackScriptPathParamsSchema = z.object({
 ...
 */
export const deleteStackScript200Schema = z.object({
 ...
 */
export const deleteStackScriptErrorSchema = z.object({
...
export const deleteStackScriptMutationResponseSchema = z.lazy(() => deleteStackScript200Schema)