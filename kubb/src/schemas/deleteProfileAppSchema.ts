...
export const deleteProfileAppPathParamsSchema = z.object({
 ...
 */
export const deleteProfileApp200Schema = z.object({
 ...
 */
export const deleteProfileAppErrorSchema = z.object({
...
export const deleteProfileAppMutationResponseSchema = z.lazy(() => deleteProfileApp200Schema)