...
export const getAccountLoginsPathParamsSchema = z.object({
 ...
 */
export const getAccountLogins200Schema = z.object({
 ...
 */
export const getAccountLoginsErrorSchema = z.object({
...
export const getAccountLoginsQueryResponseSchema = z.lazy(() => getAccountLogins200Schema)