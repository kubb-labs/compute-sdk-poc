...
export const getDatabasesEnginesPathParamsSchema = z.object({
    "apiVersion": z.enum(["v4", "v4beta"]).describe("__Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.")
    })

export const getDatabasesEnginesQueryParamsSchema = z.object({
 ...
 */
export const getDatabasesEngines200Schema = z.object({
 ...
 */
export const getDatabasesEnginesErrorSchema = z.object({
...
export const getDatabasesEnginesQueryResponseSchema = z.lazy(() => getDatabasesEngines200Schema)