...
export const deleteSharegroupImagesharePathParamsSchema = z.object({
 ...
 */
export const deleteSharegroupImageshare200Schema = z.object({
 ...
 */
export const deleteSharegroupImageshareErrorSchema = z.object({
...
export const deleteSharegroupImageshareMutationResponseSchema = z.lazy(() => deleteSharegroupImageshare200Schema)