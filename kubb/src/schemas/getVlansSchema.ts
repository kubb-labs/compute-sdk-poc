...
export const getVlansPathParamsSchema = z.object({
...
export const getVlans200Schema = z.object({
    ...
    "created": z.optional(z.string().datetime().describe("__Read-only__ The date this VLAN was created.")),
"label": z.optional(z.string().describe("__Filterable__, __Read-only__ The name of this VLAN.")),
"linodes": z.optional(z.array(z.int()).describe("__Read-only__ An array of Linode IDs attached to this VLAN.")),
"region": z.optional(z.string().describe("__Filterable__, __Read-only__ This VLAN's data center region.\n\n> 📘\n>\n> Currently, a VLAN can only be assigned to a Linode within the same data center region."))
