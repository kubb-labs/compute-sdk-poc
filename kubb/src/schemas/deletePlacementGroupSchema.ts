...
export const deletePlacementGroupPathParamsSchema = z.object({
 ...
 */
export const deletePlacementGroup200Schema = z.object({
 ...
 */
export const deletePlacementGroupErrorSchema = z.object({
...
export const deletePlacementGroupMutationResponseSchema = z.lazy(() => deletePlacementGroup200Schema)