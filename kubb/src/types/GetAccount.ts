...
export const getAccountPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetAccountPathParamsApiVersionEnumKey = (typeof getAccountPathParamsApiVersionEnum)[keyof typeof getAccountPathParamsApiVersionEnum];
...
export interface GetAccountPathParams {
     ...
     * @type string
    */
    apiVersion: GetAccountPathParamsApiVersionEnumKey;
}

export const activePromotionsServiceTypeEnum2 = {
    "all": "all",
    "backup": "backup",
...
export type ActivePromotionsServiceTypeEnum2Key = (typeof activePromotionsServiceTypeEnum2)[keyof typeof activePromotionsServiceTypeEnum2];

export const getAccount200BillingSourceEnum = {
    "akamai": "akamai",
    "linode": "linode"
} as const;

export type GetAccount200BillingSourceEnumKey = (typeof getAccount200BillingSourceEnum)[keyof typeof getAccount200BillingSourceEnum];
...
export interface GetAccount200 {
    ...
    */
    readonly active_promotions?: {
        ...
        */
         ...
         * @type string | undefined
        */
        service_type?: ActivePromotionsServiceTypeEnum2Key;
        /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly billing_source?: GetAccount200BillingSourceEnumKey;
    /**
