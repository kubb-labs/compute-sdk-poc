...
export const postMigrateLinodeInstancePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostMigrateLinodeInstancePathParamsApiVersionEnumKey = (typeof postMigrateLinodeInstancePathParamsApiVersionEnum)[keyof typeof postMigrateLinodeInstancePathParamsApiVersionEnum];

export interface PostMigrateLinodeInstancePathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostMigrateLinodeInstancePathParamsApiVersionEnumKey;
    /**
...
*/
export type PostMigrateLinodeInstance200 = object;

/**
 * @description See [Errors](https://techdocs.akamai.com/linode-api/reference/errors) for the range of possible error response codes.
*/
export interface PostMigrateLinodeInstanceError {
    /**
...
export const postMigrateLinodeInstanceMutationRequestTypeEnum = {
    "warm": "warm",
    "cold": "cold"
} as const;

export type PostMigrateLinodeInstanceMutationRequestTypeEnumKey = (typeof postMigrateLinodeInstanceMutationRequestTypeEnum)[keyof typeof postMigrateLinodeInstanceMutationRequestTypeEnum];

export interface PostMigrateLinodeInstanceMutationRequest {
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    type?: PostMigrateLinodeInstanceMutationRequestTypeEnumKey;
    /**
...
export type PostMigrateLinodeInstanceMutationResponse = PostMigrateLinodeInstance200;

export type PostMigrateLinodeInstanceMutation = {
    Response: PostMigrateLinodeInstance200;
    Request: PostMigrateLinodeInstanceMutationRequest;
    PathParams: PostMigrateLinodeInstancePathParams;
    Errors: any;
};