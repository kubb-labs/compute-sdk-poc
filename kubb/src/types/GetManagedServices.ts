...
export const getManagedServicesPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetManagedServicesPathParamsApiVersionEnumKey = (typeof getManagedServicesPathParamsApiVersionEnum)[keyof typeof getManagedServicesPathParamsApiVersionEnum];

export interface GetManagedServicesPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetManagedServicesPathParamsApiVersionEnumKey;
}

export const dataServiceTypeEnum = {
    "url": "url",
    "tcp": "tcp"
} as const;

export type DataServiceTypeEnumKey = (typeof dataServiceTypeEnum)[keyof typeof dataServiceTypeEnum];

export const dataStatusEnum28 = {
    "disabled": "disabled",
    "pending": "pending",
    "ok": "ok",
    "problem": "problem"
...
export type DataStatusEnum28Key = (typeof dataStatusEnum28)[keyof typeof dataStatusEnum28];

/**
 * @description A paginated list of Managed Services.
*/
export interface GetManagedServices200 {
    /**
    ...
    */
    data?: {
        ...
        */
         ...
         * @type string | undefined
        */
        service_type?: DataServiceTypeEnumKey;
        /**
         * @description __Read-only__ The current status of this Service.
         * @type string | undefined
        */
        readonly status?: DataStatusEnum28Key;
        /**
...
*/
export interface GetManagedServicesError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetManagedServicesQueryResponse = GetManagedServices200;

export type GetManagedServicesQuery = {
    Response: GetManagedServices200;
    PathParams: GetManagedServicesPathParams;
    Errors: any;
};