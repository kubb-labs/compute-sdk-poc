...
export const ipv4Nat11Enum6 = {
    "any": "any"
} as const;

export type Ipv4Nat11Enum6Key = (typeof ipv4Nat11Enum6)[keyof typeof ipv4Nat11Enum6];

export const interfacesPurposeEnum6 = {
    "public": "public",
    "vlan": "vlan",
    "vpc": "vpc"
} as const;

export type InterfacesPurposeEnum6Key = (typeof interfacesPurposeEnum6)[keyof typeof interfacesPurposeEnum6];

export const putLinodeConfig200RunLevelEnum = {
    "default": "default",
    "single": "single",
    "binbash": "binbash"
} as const;

export type PutLinodeConfig200RunLevelEnumKey = (typeof putLinodeConfig200RunLevelEnum)[keyof typeof putLinodeConfig200RunLevelEnum];

export const putLinodeConfig200VirtModeEnum = {
    "paravirt": "paravirt",
    "fullvirt": "fullvirt"
} as const;

export type PutLinodeConfig200VirtModeEnumKey = (typeof putLinodeConfig200VirtModeEnum)[keyof typeof putLinodeConfig200VirtModeEnum];

/**
 * @description Configuration profile successfully updated.
*/
export interface PutLinodeConfig200 {
    /**
    ...
    */
    interfaces?: {
        ...
        */
         ...
         * @type string
        */
        purpose: InterfacesPurposeEnum6Key;
        /**
...
export const ipv4Nat11Enum7 = {
    "any": "any"
} as const;

export type Ipv4Nat11Enum7Key = (typeof ipv4Nat11Enum7)[keyof typeof ipv4Nat11Enum7];

export const interfacesPurposeEnum7 = {
    "public": "public",
    "vlan": "vlan",
    "vpc": "vpc"
} as const;

export type InterfacesPurposeEnum7Key = (typeof interfacesPurposeEnum7)[keyof typeof interfacesPurposeEnum7];

export const putLinodeConfigMutationRequestRunLevelEnum = {
    "default": "default",
    "single": "single",
    "binbash": "binbash"
} as const;

export type PutLinodeConfigMutationRequestRunLevelEnumKey = (typeof putLinodeConfigMutationRequestRunLevelEnum)[keyof typeof putLinodeConfigMutationRequestRunLevelEnum];

export const putLinodeConfigMutationRequestVirtModeEnum = {
    "paravirt": "paravirt",
    "fullvirt": "fullvirt"
} as const;

export type PutLinodeConfigMutationRequestVirtModeEnumKey = (typeof putLinodeConfigMutationRequestVirtModeEnum)[keyof typeof putLinodeConfigMutationRequestVirtModeEnum];

export type PutLinodeConfigMutationRequest = Omit<NonNullable<{
    /**
     * @description Optional field for arbitrary user comments on this configuration.
     * @type string
    */
    ...
    interfaces?: {
        ...
        */
        ipv4?: {
             ...
             * @type string
            */
            nat_1_1?: (string | Ipv4Nat11Enum7Key) | null;
            /**
             * @description The VPC subnet IPv4 address for this interface.\n\n- This only applies to interfaces with a `purpose` of `vpc`.\n\n- Returned as an empty string (`\"\"`) for non-`vpc` type interfaces.\n\nWhen included in a request:\n\n- The `vpc` can\'t be assigned to an existing Linode as an address or in a range.\n\n- The target address can\'t be the first two or last two addresses in the subnet IPv4 range.\n\n- If omitted, a valid address within the Subnet IPv4 range is automatically assigned.
             * @type string, ip
            */
        ...
        */
         ...
         * @type string
        */
        purpose: InterfacesPurposeEnum7Key;
        /**
         * @description The `id` of the VPC subnet for this interface. Use this value in a request to assign a Linode to a VPC subnet.\n\n- Required for `vpc` type interfaces.\n\n- Returned as `null` for non-`vpc` type interfaces.\n\n- Once you\'ve assigned a VPC subnet to an interface, you can\'t update it.\n\n- You need to reboot a Linode using the interface\'s configuration profile to assign the Linode to a VPC subnet.
         * @type integer
        */
    ...
    */
     ...
     * @type string | undefined
    */
    run_level?: PutLinodeConfigMutationRequestRunLevelEnumKey;
    /**
     * @description Controls the virtualization mode. Defaults to `paravirt`.\n\n- `paravirt` is suitable for most cases. Linodes running in `paravirt` mode share some qualities with the host, ultimately making it run faster since there is less transition between it and the host.\n\n- `fullvirt` affords more customization, but is slower because 100% of the VM is virtualized.
     * @type string | undefined
    */
    virt_mode?: PutLinodeConfigMutationRequestVirtModeEnumKey;
}>, "id">;

export type PutLinodeConfigMutationResponse = PutLinodeConfig200;

export type PutLinodeConfigMutation = {
    Response: PutLinodeConfig200;
    Request: PutLinodeConfigMutationRequest;
    PathParams: PutLinodeConfigPathParams;
    Errors: any;
};