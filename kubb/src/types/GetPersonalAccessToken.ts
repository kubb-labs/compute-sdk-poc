...
export const getPersonalAccessTokenPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetPersonalAccessTokenPathParamsApiVersionEnumKey = (typeof getPersonalAccessTokenPathParamsApiVersionEnum)[keyof typeof getPersonalAccessTokenPathParamsApiVersionEnum];

export interface GetPersonalAccessTokenPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetPersonalAccessTokenPathParamsApiVersionEnumKey;
    /**
...
*/
export interface GetPersonalAccessToken200 {
    /**
...
*/
export interface GetPersonalAccessTokenError {
    /**
...
export type GetPersonalAccessTokenQueryResponse = GetPersonalAccessToken200;

export type GetPersonalAccessTokenQuery = {
    Response: GetPersonalAccessToken200;
