...
export const postEnableManagedServicePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostEnableManagedServicePathParamsApiVersionEnumKey = (typeof postEnableManagedServicePathParamsApiVersionEnum)[keyof typeof postEnableManagedServicePathParamsApiVersionEnum];

export interface PostEnableManagedServicePathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostEnableManagedServicePathParamsApiVersionEnumKey;
    /**
...
export const postEnableManagedService200ServiceTypeEnum = {
    "url": "url",
    "tcp": "tcp"
} as const;

export type PostEnableManagedService200ServiceTypeEnumKey = (typeof postEnableManagedService200ServiceTypeEnum)[keyof typeof postEnableManagedService200ServiceTypeEnum];

export const postEnableManagedService200StatusEnum = {
    "disabled": "disabled",
    "pending": "pending",
    "ok": "ok",
    "problem": "problem"
...
export type PostEnableManagedService200StatusEnumKey = (typeof postEnableManagedService200StatusEnum)[keyof typeof postEnableManagedService200StatusEnum];

/**
 * @description Service enabled.
*/
export interface PostEnableManagedService200 {
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    service_type?: PostEnableManagedService200ServiceTypeEnumKey;
    /**
     * @description __Read-only__ The current status of this Service.
     * @type string | undefined
    */
    readonly status?: PostEnableManagedService200StatusEnumKey;
    /**
...
*/
export interface PostEnableManagedServiceError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type PostEnableManagedServiceMutationResponse = PostEnableManagedService200;

export type PostEnableManagedServiceMutation = {
    Response: PostEnableManagedService200;
    PathParams: PostEnableManagedServicePathParams;
    Errors: any;
};