...
export const getLinodeInterfacePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLinodeInterfacePathParamsApiVersionEnumKey = (typeof getLinodeInterfacePathParamsApiVersionEnum)[keyof typeof getLinodeInterfacePathParamsApiVersionEnum];
...
export interface GetLinodeInterfacePathParams {
     ...
     * @type string
    */
    apiVersion: GetLinodeInterfacePathParamsApiVersionEnumKey;
    /**
