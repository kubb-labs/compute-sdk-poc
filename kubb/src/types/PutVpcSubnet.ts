...
export const putVpcSubnetPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutVpcSubnetPathParamsApiVersionEnumKey = (typeof putVpcSubnetPathParamsApiVersionEnum)[keyof typeof putVpcSubnetPathParamsApiVersionEnum];

export interface PutVpcSubnetPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PutVpcSubnetPathParamsApiVersionEnumKey;
    /**
...
*/
export interface PutVpcSubnet200 {
    /**
...
*/
export interface PutVpcSubnetError {
    /**
     * @type array | undefined
    */
    errors?: {
...
*/
export interface PutVpcSubnetMutationRequest {
    /**
     * @description __Filterable__ The VPC Subnet\'s label, for display purposes only.\n\n- Must be unique among the VPC\'s Subnets.\n- Can only contain ASCII letters, numbers, and hyphens (`-`). You can\'t use two consecutive hyphens (`--`).
     * @minLength 1
     * @maxLength 64
...
export type PutVpcSubnetMutationResponse = PutVpcSubnet200;

export type PutVpcSubnetMutation = {
    Response: PutVpcSubnet200;
    Request: PutVpcSubnetMutationRequest;
    PathParams: PutVpcSubnetPathParams;
    Errors: any;
};