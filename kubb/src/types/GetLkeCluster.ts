...
export const getLkeClusterPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLkeClusterPathParamsApiVersionEnumKey = (typeof getLkeClusterPathParamsApiVersionEnum)[keyof typeof getLkeClusterPathParamsApiVersionEnum];
...
export interface GetLkeClusterPathParams {
     ...
     * @type string
    */
    apiVersion: GetLkeClusterPathParamsApiVersionEnumKey;
    /**
