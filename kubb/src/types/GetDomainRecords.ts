...
export const getDomainRecordsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetDomainRecordsPathParamsApiVersionEnumKey = (typeof getDomainRecordsPathParamsApiVersionEnum)[keyof typeof getDomainRecordsPathParamsApiVersionEnum];

export interface GetDomainRecordsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetDomainRecordsPathParamsApiVersionEnumKey;
    /**
...
export interface GetDomainRecordsQueryParams {
    /**
...
export const dataTagEnum = {
    "issue": "issue",
    "issuewild": "issuewild",
    "iodef": "iodef"
} as const;

export type DataTagEnumKey = (typeof dataTagEnum)[keyof typeof dataTagEnum];
...
export type DataTypeEnum10Key = (typeof dataTypeEnum10)[keyof typeof dataTypeEnum10];

/**
 * @description A list of Domain Records.
*/
export interface GetDomainRecords200 {
    /**
...
export type GetDomainRecordsQueryResponse = GetDomainRecords200;

export type GetDomainRecordsQuery = {
    Response: GetDomainRecords200;
