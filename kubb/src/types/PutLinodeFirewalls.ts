...
export const putLinodeFirewallsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutLinodeFirewallsPathParamsApiVersionEnumKey = (typeof putLinodeFirewallsPathParamsApiVersionEnum)[keyof typeof putLinodeFirewallsPathParamsApiVersionEnum];

export interface PutLinodeFirewallsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PutLinodeFirewallsPathParamsApiVersionEnumKey;
    /**
...
export interface PutLinodeFirewallsQueryParams {
    /**
...
export const parentEntityTypeEnum2 = {
    "linode": "linode"
} as const;

export type ParentEntityTypeEnum2Key = (typeof parentEntityTypeEnum2)[keyof typeof parentEntityTypeEnum2];

export const entitiesTypeEnum2 = {
    "linode": "linode",
    "linode_interface": "linode_interface",
    "nodebalancer": "nodebalancer"
} as const;

export type EntitiesTypeEnum2Key = (typeof entitiesTypeEnum2)[keyof typeof entitiesTypeEnum2];

export const inboundActionEnum2 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type InboundActionEnum2Key = (typeof inboundActionEnum2)[keyof typeof inboundActionEnum2];

export const inboundProtocolEnum2 = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type InboundProtocolEnum2Key = (typeof inboundProtocolEnum2)[keyof typeof inboundProtocolEnum2];

export const rulesInboundPolicyEnum2 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesInboundPolicyEnum2Key = (typeof rulesInboundPolicyEnum2)[keyof typeof rulesInboundPolicyEnum2];

export const outboundActionEnum2 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type OutboundActionEnum2Key = (typeof outboundActionEnum2)[keyof typeof outboundActionEnum2];

export const outboundProtocolEnum2 = {
    "TCP": "TCP",
    "UDP": "UDP",
    "ICMP": "ICMP",
    "IPENCAP": "IPENCAP"
...
export type OutboundProtocolEnum2Key = (typeof outboundProtocolEnum2)[keyof typeof outboundProtocolEnum2];

export const rulesOutboundPolicyEnum2 = {
    "ACCEPT": "ACCEPT",
    "DROP": "DROP"
} as const;

export type RulesOutboundPolicyEnum2Key = (typeof rulesOutboundPolicyEnum2)[keyof typeof rulesOutboundPolicyEnum2];

export const dataStatusEnum25 = {
    "enabled": "enabled",
    "disabled": "disabled",
    "deleted": "deleted"
} as const;

export type DataStatusEnum25Key = (typeof dataStatusEnum25)[keyof typeof dataStatusEnum25];

/**
 * @description Returns a paginated list of Firewalls assigned to this Linode.
*/
export interface PutLinodeFirewalls200 {
    /**
    ...
    */
    data?: {
        ...
        */
            ...
            */
            inbound?: {
                ...
                */
                 ...
                 * @type string | undefined
                */
                protocol?: InboundProtocolEnum2Key;
            }[];
            /**
             ...
             * @type string | undefined
            */
            inbound_policy?: RulesInboundPolicyEnum2Key;
            /**
            ...
            */
            outbound?: {
                ...
                */
                 ...
                 * @type string | undefined
                */
                protocol?: OutboundProtocolEnum2Key;
            }[];
            /**
             ...
             * @type string | undefined
            */
            outbound_policy?: RulesOutboundPolicyEnum2Key;
            /**
         ...
         * @type string | undefined
        */
        readonly status?: DataStatusEnum25Key;
        /**
...
*/
export interface PutLinodeFirewallsError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export interface PutLinodeFirewallsMutationRequest {
    /**
...
export type PutLinodeFirewallsMutationResponse = PutLinodeFirewalls200;

export type PutLinodeFirewallsMutation = {
    Response: PutLinodeFirewalls200;
    Request: PutLinodeFirewallsMutationRequest;
    PathParams: PutLinodeFirewallsPathParams;
    QueryParams: PutLinodeFirewallsQueryParams;
    Errors: any;
};