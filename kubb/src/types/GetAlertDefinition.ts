...
export const getAlertDefinitionPathParamsApiVersionEnum = {
    "v4beta": "v4beta"
} as const;

export type GetAlertDefinitionPathParamsApiVersionEnumKey = (typeof getAlertDefinitionPathParamsApiVersionEnum)[keyof typeof getAlertDefinitionPathParamsApiVersionEnum];

export interface GetAlertDefinitionPathParams {
    /**
     * @description __Enum__ Call the `v4beta` URL for operations still only in beta.
     * @type string
    */
    apiVersion: GetAlertDefinitionPathParamsApiVersionEnumKey;
    /**
...
export const alertChannelsTypeEnum4 = {
    "email": "email"
} as const;

export type AlertChannelsTypeEnum4Key = (typeof alertChannelsTypeEnum4)[keyof typeof alertChannelsTypeEnum4];

export const getAlertDefinition200ClassEnum = {
    "shared": "shared",
    "dedicated": "dedicated"
} as const;

export type GetAlertDefinition200ClassEnumKey = (typeof getAlertDefinition200ClassEnum)[keyof typeof getAlertDefinition200ClassEnum];

export const rulesAggregateFunctionEnum5 = {
    "avg": "avg",
    "sum": "sum",
    "min": "min",
    "max": "max"
...
export type RulesAggregateFunctionEnum5Key = (typeof rulesAggregateFunctionEnum5)[keyof typeof rulesAggregateFunctionEnum5];

export const dimensionFiltersOperatorEnum5 = {
    "eq": "eq",
    "neq": "neq",
...
export type DimensionFiltersOperatorEnum5Key = (typeof dimensionFiltersOperatorEnum5)[keyof typeof dimensionFiltersOperatorEnum5];
...
export type RulesUnitEnum4Key = (typeof rulesUnitEnum4)[keyof typeof rulesUnitEnum4];

export const getAlertDefinition200SeverityEnum = {
    "0": 0,
    "1": 1,
    "2": 2,
    "3": 3
...
export type GetAlertDefinition200SeverityEnumKey = (typeof getAlertDefinition200SeverityEnum)[keyof typeof getAlertDefinition200SeverityEnum];

export const getAlertDefinition200StatusEnum = {
    "enabled": "enabled",
    "disabled": "disabled",
...
export type GetAlertDefinition200StatusEnumKey = (typeof getAlertDefinition200StatusEnum)[keyof typeof getAlertDefinition200StatusEnum];

export const triggerConditionsCriteriaConditionEnum5 = {
    "ALL": "ALL"
} as const;

export type TriggerConditionsCriteriaConditionEnum5Key = (typeof triggerConditionsCriteriaConditionEnum5)[keyof typeof triggerConditionsCriteriaConditionEnum5];

export const getAlertDefinition200TypeEnum = {
    "user": "user",
    "system": "system"
} as const;

export type GetAlertDefinition200TypeEnumKey = (typeof getAlertDefinition200TypeEnum)[keyof typeof getAlertDefinition200TypeEnum];

/**
 * @description Returns the specified alert definition.
*/
export interface GetAlertDefinition200 {
    /**
    ...
    */
    alert_channels?: {
        ...
        */
         ...
         * @type string | undefined
        */
        type?: AlertChannelsTypeEnum4Key;
        /**
     ...
     * @type string
    */
    class?: GetAlertDefinition200ClassEnumKey | null;
    /**
    ...
    rule_criteria?: {
        ...
        */
        rules?: {
             ...
             * @type string | undefined
            */
            aggregate_function?: RulesAggregateFunctionEnum5Key;
            /**
            ...
            */
            dimension_filters?: {
                ...
                */
                 ...
                 * @type string | undefined
                */
                operator?: DimensionFiltersOperatorEnum5Key;
                /**
    ...
    */
    trigger_conditions?: {
         ...
         * @type string | undefined
        */
        criteria_condition?: TriggerConditionsCriteriaConditionEnum5Key;
        /**
     ...
     * @type string | undefined
    */
    type?: GetAlertDefinition200TypeEnumKey;
    /**
...
*/
export interface GetAlertDefinitionError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetAlertDefinitionQueryResponse = GetAlertDefinition200;

export type GetAlertDefinitionQuery = {
    Response: GetAlertDefinition200;
    PathParams: GetAlertDefinitionPathParams;
    Errors: any;
};