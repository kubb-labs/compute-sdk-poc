...
export const putIpPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutIpPathParamsApiVersionEnumKey = (typeof putIpPathParamsApiVersionEnum)[keyof typeof putIpPathParamsApiVersionEnum];
...
export interface PutIpPathParams {
     ...
     * @type string
    */
    apiVersion: PutIpPathParamsApiVersionEnumKey;
    /**
