...
export type GetLinodeStatsByYearMonthQueryResponse = GetLinodeStatsByYearMonth200;

export type GetLinodeStatsByYearMonthQuery = {
    Response: GetLinodeStatsByYearMonth200;
