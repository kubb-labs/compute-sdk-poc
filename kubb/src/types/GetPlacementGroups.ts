...
export const getPlacementGroupsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetPlacementGroupsPathParamsApiVersionEnumKey = (typeof getPlacementGroupsPathParamsApiVersionEnum)[keyof typeof getPlacementGroupsPathParamsApiVersionEnum];

export interface GetPlacementGroupsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetPlacementGroupsPathParamsApiVersionEnumKey;
}

export interface GetPlacementGroupsQueryParams {
    /**
...
export const dataPlacementGroupPolicyEnum = {
    "strict": "strict",
    "flexible": "flexible"
} as const;

export type DataPlacementGroupPolicyEnumKey = (typeof dataPlacementGroupPolicyEnum)[keyof typeof dataPlacementGroupPolicyEnum];

export const dataPlacementGroupTypeEnum = {
    "anti_affinity:local": "anti_affinity:local"
} as const;

export type DataPlacementGroupTypeEnumKey = (typeof dataPlacementGroupTypeEnum)[keyof typeof dataPlacementGroupTypeEnum];

/**
 * @description Returns an array of all placement groups on your Account.
*/
export interface GetPlacementGroups200 {
    /**
    ...
    */
    data?: {
        ...
        */
         ...
         * @type string | undefined
        */
        placement_group_policy?: DataPlacementGroupPolicyEnumKey;
        /**
         ...
         * @type string | undefined
        */
        readonly placement_group_type?: DataPlacementGroupTypeEnumKey;
        /**
...
*/
export interface GetPlacementGroupsError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetPlacementGroupsQueryResponse = GetPlacementGroups200;

export type GetPlacementGroupsQuery = {
    Response: GetPlacementGroups200;
    PathParams: GetPlacementGroupsPathParams;
