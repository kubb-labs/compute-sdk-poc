...
export const getUserGrantsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetUserGrantsPathParamsApiVersionEnumKey = (typeof getUserGrantsPathParamsApiVersionEnum)[keyof typeof getUserGrantsPathParamsApiVersionEnum];
...
export interface GetUserGrantsPathParams {
     ...
     * @type string
    */
    apiVersion: GetUserGrantsPathParamsApiVersionEnumKey;
    /**
