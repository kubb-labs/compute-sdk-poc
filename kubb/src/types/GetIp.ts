...
export const getIpPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetIpPathParamsApiVersionEnumKey = (typeof getIpPathParamsApiVersionEnum)[keyof typeof getIpPathParamsApiVersionEnum];

export interface GetIpPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetIpPathParamsApiVersionEnumKey;
    /**
...
export type GetIp200TypeEnumKey = (typeof getIp200TypeEnum)[keyof typeof getIp200TypeEnum];

/**
 * @description The requested IP Address.
*/
export interface GetIp200 {
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly type?: GetIp200TypeEnumKey;
    /**
...
export type GetIpQueryResponse = GetIp200;

export type GetIpQuery = {
    Response: GetIp200;
