...
export const postDisableManagedServicePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostDisableManagedServicePathParamsApiVersionEnumKey = (typeof postDisableManagedServicePathParamsApiVersionEnum)[keyof typeof postDisableManagedServicePathParamsApiVersionEnum];
...
export interface PostDisableManagedServicePathParams {
     ...
     * @type string
    */
    apiVersion: PostDisableManagedServicePathParamsApiVersionEnumKey;
    /**
