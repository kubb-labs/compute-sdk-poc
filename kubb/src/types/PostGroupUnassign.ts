...
export const postGroupUnassignPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostGroupUnassignPathParamsApiVersionEnumKey = (typeof postGroupUnassignPathParamsApiVersionEnum)[keyof typeof postGroupUnassignPathParamsApiVersionEnum];
...
export interface PostGroupUnassignPathParams {
     ...
     * @type string
    */
    apiVersion: PostGroupUnassignPathParamsApiVersionEnumKey;
    /**
