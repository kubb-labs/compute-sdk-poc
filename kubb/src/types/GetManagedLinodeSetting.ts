...
export const getManagedLinodeSettingPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetManagedLinodeSettingPathParamsApiVersionEnumKey = (typeof getManagedLinodeSettingPathParamsApiVersionEnum)[keyof typeof getManagedLinodeSettingPathParamsApiVersionEnum];
...
export interface GetManagedLinodeSettingPathParams {
     ...
     * @type string
    */
    apiVersion: GetManagedLinodeSettingPathParamsApiVersionEnumKey;
    /**
