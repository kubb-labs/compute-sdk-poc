...
export const postAddLinodeConfigPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostAddLinodeConfigPathParamsApiVersionEnumKey = (typeof postAddLinodeConfigPathParamsApiVersionEnum)[keyof typeof postAddLinodeConfigPathParamsApiVersionEnum];

export interface PostAddLinodeConfigPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostAddLinodeConfigPathParamsApiVersionEnumKey;
    /**
...
export const ipv4Nat11Enum2 = {
    "any": "any"
} as const;

export type Ipv4Nat11Enum2Key = (typeof ipv4Nat11Enum2)[keyof typeof ipv4Nat11Enum2];

export const interfacesPurposeEnum2 = {
    "public": "public",
    "vlan": "vlan",
    "vpc": "vpc"
} as const;

export type InterfacesPurposeEnum2Key = (typeof interfacesPurposeEnum2)[keyof typeof interfacesPurposeEnum2];

export const postAddLinodeConfig200RunLevelEnum = {
    "default": "default",
    "single": "single",
    "binbash": "binbash"
} as const;

export type PostAddLinodeConfig200RunLevelEnumKey = (typeof postAddLinodeConfig200RunLevelEnum)[keyof typeof postAddLinodeConfig200RunLevelEnum];

export const postAddLinodeConfig200VirtModeEnum = {
    "paravirt": "paravirt",
    "fullvirt": "fullvirt"
} as const;

export type PostAddLinodeConfig200VirtModeEnumKey = (typeof postAddLinodeConfig200VirtModeEnum)[keyof typeof postAddLinodeConfig200VirtModeEnum];

/**
 * @description A configuration profile was created.
*/
export interface PostAddLinodeConfig200 {
    /**
    ...
    interfaces?: {
        ...
        */
        ipv4?: {
             ...
             * @type string
            */
            nat_1_1?: (string | Ipv4Nat11Enum2Key) | null;
            /**
        ...
        */
         ...
         * @type string
        */
        purpose: InterfacesPurposeEnum2Key;
        /**
    ...
    */
     ...
     * @type string | undefined
    */
    run_level?: PostAddLinodeConfig200RunLevelEnumKey;
    /**
     ...
     * @type string | undefined
    */
    virt_mode?: PostAddLinodeConfig200VirtModeEnumKey;
}

/**
 * @description See [Errors](https://techdocs.akamai.com/linode-api/reference/errors) for the range of possible error response codes.
*/
export interface PostAddLinodeConfigError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export const ipv4Nat11Enum3 = {
    "any": "any"
} as const;

export type Ipv4Nat11Enum3Key = (typeof ipv4Nat11Enum3)[keyof typeof ipv4Nat11Enum3];

export const interfacesPurposeEnum3 = {
    "public": "public",
    "vlan": "vlan",
    "vpc": "vpc"
} as const;

export type InterfacesPurposeEnum3Key = (typeof interfacesPurposeEnum3)[keyof typeof interfacesPurposeEnum3];

export const postAddLinodeConfigMutationRequestRunLevelEnum = {
    "default": "default",
    "single": "single",
    "binbash": "binbash"
} as const;

export type PostAddLinodeConfigMutationRequestRunLevelEnumKey = (typeof postAddLinodeConfigMutationRequestRunLevelEnum)[keyof typeof postAddLinodeConfigMutationRequestRunLevelEnum];

export const postAddLinodeConfigMutationRequestVirtModeEnum = {
    "paravirt": "paravirt",
    "fullvirt": "fullvirt"
} as const;

export type PostAddLinodeConfigMutationRequestVirtModeEnumKey = (typeof postAddLinodeConfigMutationRequestVirtModeEnum)[keyof typeof postAddLinodeConfigMutationRequestVirtModeEnum];
...
*/
export interface PostAddLinodeConfigMutationRequest {
    /**
     * @description Optional field for arbitrary user comments on this configuration.
     * @type string
    */
    ...
    interfaces?: {
        ...
        */
        ipv4?: {
             ...
             * @type string
            */
            nat_1_1?: (string | Ipv4Nat11Enum3Key) | null;
            /**
             * @description The VPC subnet IPv4 address for this interface.\n\n- This only applies to interfaces with a `purpose` of `vpc`.\n\n- Returned as an empty string (`\"\"`) for non-`vpc` type interfaces.\n\nWhen included in a request:\n\n- The `vpc` can\'t be assigned to an existing Linode as an address or in a range.\n\n- The target address can\'t be the first two or last two addresses in the subnet IPv4 range.\n\n- If omitted, a valid address within the Subnet IPv4 range is automatically assigned.
             * @type string, ip
            */
        ...
        */
         ...
         * @type string
        */
        purpose: InterfacesPurposeEnum3Key;
        /**
         * @description The `id` of the VPC subnet for this interface. Use this value in a request to assign a Linode to a VPC subnet.\n\n- Required for `vpc` type interfaces.\n\n- Returned as `null` for non-`vpc` type interfaces.\n\n- Once you\'ve assigned a VPC subnet to an interface, you can\'t update it.\n\n- You need to reboot a Linode using the interface\'s configuration profile to assign the Linode to a VPC subnet.
         * @type integer
        */
    ...
    */
     ...
     * @type string | undefined
    */
    run_level?: PostAddLinodeConfigMutationRequestRunLevelEnumKey;
    /**
     * @description Controls the virtualization mode. Defaults to `paravirt`.\n\n- `paravirt` is suitable for most cases. Linodes running in `paravirt` mode share some qualities with the host, ultimately making it run faster since there is less transition between it and the host.\n\n- `fullvirt` affords more customization, but is slower because 100% of the VM is virtualized.
     * @type string | undefined
    */
    virt_mode?: PostAddLinodeConfigMutationRequestVirtModeEnumKey;
}

export type PostAddLinodeConfigMutationResponse = PostAddLinodeConfig200;

export type PostAddLinodeConfigMutation = {
    Response: PostAddLinodeConfig200;
    Request: PostAddLinodeConfigMutationRequest;
    PathParams: PostAddLinodeConfigPathParams;
    Errors: any;
};