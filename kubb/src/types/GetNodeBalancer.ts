...
export const getNodeBalancerPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetNodeBalancerPathParamsApiVersionEnumKey = (typeof getNodeBalancerPathParamsApiVersionEnum)[keyof typeof getNodeBalancerPathParamsApiVersionEnum];

export interface GetNodeBalancerPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetNodeBalancerPathParamsApiVersionEnumKey;
    /**
...
export const getNodeBalancer200TypeEnum = {
    "common": "common",
    "premium": "premium"
} as const;

export type GetNodeBalancer200TypeEnumKey = (typeof getNodeBalancer200TypeEnum)[keyof typeof getNodeBalancer200TypeEnum];

/**
 * @description The requested NodeBalancer object.
*/
export interface GetNodeBalancer200 {
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly type?: GetNodeBalancer200TypeEnumKey;
    /**
...
*/
export interface GetNodeBalancerError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetNodeBalancerQueryResponse = GetNodeBalancer200;

export type GetNodeBalancerQuery = {
    Response: GetNodeBalancer200;
