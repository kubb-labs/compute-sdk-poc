...
export const getAlertDefinitionsForServiceTypePathParamsApiVersionEnum = {
    "v4beta": "v4beta"
} as const;

export type GetAlertDefinitionsForServiceTypePathParamsApiVersionEnumKey = (typeof getAlertDefinitionsForServiceTypePathParamsApiVersionEnum)[keyof typeof getAlertDefinitionsForServiceTypePathParamsApiVersionEnum];
...
export interface GetAlertDefinitionsForServiceTypePathParams {
     ...
     * @type string
    */
    apiVersion: GetAlertDefinitionsForServiceTypePathParamsApiVersionEnumKey;
    /**
