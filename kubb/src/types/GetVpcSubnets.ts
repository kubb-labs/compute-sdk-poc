...
export const getVpcSubnetsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetVpcSubnetsPathParamsApiVersionEnumKey = (typeof getVpcSubnetsPathParamsApiVersionEnum)[keyof typeof getVpcSubnetsPathParamsApiVersionEnum];

export interface GetVpcSubnetsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetVpcSubnetsPathParamsApiVersionEnumKey;
    /**
...
export interface GetVpcSubnetsQueryParams {
    /**
...
*/
export interface GetVpcSubnets200 {
    /**
...
*/
export interface GetVpcSubnetsError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetVpcSubnetsQueryResponse = GetVpcSubnets200;

export type GetVpcSubnetsQuery = {
    Response: GetVpcSubnets200;
    PathParams: GetVpcSubnetsPathParams;
    QueryParams: GetVpcSubnetsQueryParams;
    Errors: any;
};