...
export const getAccountSettingsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetAccountSettingsPathParamsApiVersionEnumKey = (typeof getAccountSettingsPathParamsApiVersionEnum)[keyof typeof getAccountSettingsPathParamsApiVersionEnum];

export interface GetAccountSettingsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetAccountSettingsPathParamsApiVersionEnumKey;
}
...
export type GetAccountSettingsQuery = {
    ...
    PathParams: GetAccountSettingsPathParams;
    Errors: any;
};