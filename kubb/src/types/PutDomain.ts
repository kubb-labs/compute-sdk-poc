...
export const putDomainPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutDomainPathParamsApiVersionEnumKey = (typeof putDomainPathParamsApiVersionEnum)[keyof typeof putDomainPathParamsApiVersionEnum];
...
export interface PutDomainPathParams {
     ...
     * @type string
    */
    apiVersion: PutDomainPathParamsApiVersionEnumKey;
    /**
