...
export const putVolumePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutVolumePathParamsApiVersionEnumKey = (typeof putVolumePathParamsApiVersionEnum)[keyof typeof putVolumePathParamsApiVersionEnum];
...
export interface PutVolumePathParams {
     ...
     * @type string
    */
    apiVersion: PutVolumePathParamsApiVersionEnumKey;
    /**
