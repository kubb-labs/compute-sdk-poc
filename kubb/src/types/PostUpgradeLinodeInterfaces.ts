...
export const postUpgradeLinodeInterfacesPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostUpgradeLinodeInterfacesPathParamsApiVersionEnumKey = (typeof postUpgradeLinodeInterfacesPathParamsApiVersionEnum)[keyof typeof postUpgradeLinodeInterfacesPathParamsApiVersionEnum];

export interface PostUpgradeLinodeInterfacesPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostUpgradeLinodeInterfacesPathParamsApiVersionEnumKey;
    /**
...
*/
export interface PostUpgradeLinodeInterfaces200 {
    /**
    ...
    */
    config_id?: number;
    /**
     * @description Indicates if this was a `dry_run` upgrade that didn\'t commit any changes and didn\'t generate a unique interface ID. If `dry_run` is `false`, the upgrade completed.
...
*/
export interface PostUpgradeLinodeInterfacesError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type PostUpgradeLinodeInterfacesMutationResponse = PostUpgradeLinodeInterfaces200;

export type PostUpgradeLinodeInterfacesMutation = {
    Response: PostUpgradeLinodeInterfaces200;
    Request: PostUpgradeLinodeInterfacesMutationRequest;
    PathParams: PostUpgradeLinodeInterfacesPathParams;
    Errors: any;
};