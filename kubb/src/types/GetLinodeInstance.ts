...
export const getLinodeInstancePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLinodeInstancePathParamsApiVersionEnumKey = (typeof getLinodeInstancePathParamsApiVersionEnum)[keyof typeof getLinodeInstancePathParamsApiVersionEnum];

export interface GetLinodeInstancePathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetLinodeInstancePathParamsApiVersionEnumKey;
    /**
...
export type ScheduleDayEnum3Key = (typeof scheduleDayEnum3)[keyof typeof scheduleDayEnum3];

export const scheduleWindowEnum3 = {
    "Scheduling": "Scheduling",
    "W0": "W0",
    "W2": "W2",
    "W4": "W4",
...
export type ScheduleWindowEnum3Key = (typeof scheduleWindowEnum3)[keyof typeof scheduleWindowEnum3];

export const getLinodeInstance200DiskEncryptionEnum = {
    "enabled": "enabled",
    "disabled": "disabled"
} as const;

export type GetLinodeInstance200DiskEncryptionEnumKey = (typeof getLinodeInstance200DiskEncryptionEnum)[keyof typeof getLinodeInstance200DiskEncryptionEnum];

export const getLinodeInstance200HypervisorEnum = {
    "kvm": "kvm"
} as const;

export type GetLinodeInstance200HypervisorEnumKey = (typeof getLinodeInstance200HypervisorEnum)[keyof typeof getLinodeInstance200HypervisorEnum];

export const getLinodeInstance200InterfaceGenerationEnum = {
    "legacy_config": "legacy_config",
    "linode": "linode"
} as const;

export type GetLinodeInstance200InterfaceGenerationEnumKey = (typeof getLinodeInstance200InterfaceGenerationEnum)[keyof typeof getLinodeInstance200InterfaceGenerationEnum];

export const getLinodeInstance200MaintenancePolicyEnum = {
    "linode/migrate": "linode/migrate",
    "linode/power_off_on": "linode/power_off_on"
} as const;

export type GetLinodeInstance200MaintenancePolicyEnumKey = (typeof getLinodeInstance200MaintenancePolicyEnum)[keyof typeof getLinodeInstance200MaintenancePolicyEnum];

export const placementGroupPlacementGroupPolicyEnum3 = {
    "strict": "strict",
    "flexible": "flexible"
} as const;

export type PlacementGroupPlacementGroupPolicyEnum3Key = (typeof placementGroupPlacementGroupPolicyEnum3)[keyof typeof placementGroupPlacementGroupPolicyEnum3];

export const placementGroupPlacementGroupTypeEnum3 = {
    "anti_affinity:local": "anti_affinity:local"
} as const;

export type PlacementGroupPlacementGroupTypeEnum3Key = (typeof placementGroupPlacementGroupTypeEnum3)[keyof typeof placementGroupPlacementGroupTypeEnum3];

export const getLinodeInstance200StatusEnum = {
    "running": "running",
    "offline": "offline",
    "booting": "booting",
    "busy": "busy",
...
export type GetLinodeInstance200StatusEnumKey = (typeof getLinodeInstance200StatusEnum)[keyof typeof getLinodeInstance200StatusEnum];

/**
 * @description Returns a single Linode object.
*/
export interface GetLinodeInstance200 {
    /**
        ...
        */
        schedule?: {
            ...
            */
             ...
             * @type string
            */
            window?: ScheduleWindowEnum3Key | null;
        };
    };
    /**
    ...
    */
     ...
     * @type string
    */
    readonly disk_encryption?: GetLinodeInstance200DiskEncryptionEnumKey | null;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly hypervisor?: GetLinodeInstance200HypervisorEnumKey;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    interface_generation?: GetLinodeInstance200InterfaceGenerationEnumKey;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly maintenance_policy?: GetLinodeInstance200MaintenancePolicyEnumKey;
    /**
    ...
    */
    readonly placement_group?: {
        ...
        */
         ...
         * @type string | undefined
        */
        placement_group_policy?: PlacementGroupPlacementGroupPolicyEnum3Key;
        /**
         ...
         * @type string | undefined
        */
        readonly placement_group_type?: PlacementGroupPlacementGroupTypeEnum3Key;
    } | null;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    readonly status?: GetLinodeInstance200StatusEnumKey;
    /**
...
*/
export interface GetLinodeInstanceError {
    /**
     * @type array | undefined
    */
    errors?: {
...
export type GetLinodeInstanceQueryResponse = GetLinodeInstance200;

export type GetLinodeInstanceQuery = {
    Response: GetLinodeInstance200;
