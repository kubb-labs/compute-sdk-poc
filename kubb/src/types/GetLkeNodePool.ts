...
export const getLkeNodePoolPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLkeNodePoolPathParamsApiVersionEnumKey = (typeof getLkeNodePoolPathParamsApiVersionEnum)[keyof typeof getLkeNodePoolPathParamsApiVersionEnum];

export interface GetLkeNodePoolPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetLkeNodePoolPathParamsApiVersionEnumKey;
    /**
...
export const getLkeNodePool200DiskEncryptionEnum = {
    "enabled": "enabled",
    "disabled": "disabled"
} as const;

export type GetLkeNodePool200DiskEncryptionEnumKey = (typeof getLkeNodePool200DiskEncryptionEnum)[keyof typeof getLkeNodePool200DiskEncryptionEnum];

export const disksTypeEnum5 = {
    "raw": "raw",
    "ext4": "ext4"
} as const;

export type DisksTypeEnum5Key = (typeof disksTypeEnum5)[keyof typeof disksTypeEnum5];

export const nodesStatusEnum3 = {
    "ready": "ready",
    "not_ready": "not_ready"
} as const;

export type NodesStatusEnum3Key = (typeof nodesStatusEnum3)[keyof typeof nodesStatusEnum3];

export const taintsEffectEnum5 = {
    "NoSchedule": "NoSchedule",
    "PreferNoSchedule": "PreferNoSchedule",
    "NoExecute": "NoExecute"
} as const;

export type TaintsEffectEnum5Key = (typeof taintsEffectEnum5)[keyof typeof taintsEffectEnum5];

export const getLkeNodePool200UpdateStrategyEnum = {
    "rolling_update": "rolling_update",
    "on_recycle": "on_recycle"
} as const;

export type GetLkeNodePool200UpdateStrategyEnumKey = (typeof getLkeNodePool200UpdateStrategyEnum)[keyof typeof getLkeNodePool200UpdateStrategyEnum];

/**
 * @description Returns the requested Node Pool.
*/
export interface GetLkeNodePool200 {
    /**
    ...
    */
    disk_encryption?: GetLkeNodePool200DiskEncryptionEnumKey;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    update_strategy?: GetLkeNodePool200UpdateStrategyEnumKey;
}

export type GetLkeNodePoolQueryResponse = GetLkeNodePool200;

export type GetLkeNodePoolQuery = {
    Response: GetLkeNodePool200;
