...
export const postResetClientSecretPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostResetClientSecretPathParamsApiVersionEnumKey = (typeof postResetClientSecretPathParamsApiVersionEnum)[keyof typeof postResetClientSecretPathParamsApiVersionEnum];
...
export interface PostResetClientSecretPathParams {
     ...
     * @type string
    */
    apiVersion: PostResetClientSecretPathParamsApiVersionEnumKey;
    /**
