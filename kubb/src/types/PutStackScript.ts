...
export const putStackScriptPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutStackScriptPathParamsApiVersionEnumKey = (typeof putStackScriptPathParamsApiVersionEnum)[keyof typeof putStackScriptPathParamsApiVersionEnum];

export interface PutStackScriptPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PutStackScriptPathParamsApiVersionEnumKey;
    /**
...
*/
export interface PutStackScript200 {
    /**
...
*/
export interface PutStackScriptError {
    /**
     * @type array | undefined
    */
    errors?: {
...
*/
export type PutStackScriptMutationRequest = Omit<NonNullable<{
    /**
     * @description __Read-only__ The date this StackScript was created.
     * @type string | undefined, date-time
    */
    ...
    */
    readonly username?: string;
}>, "created" | "deployments_active" | "deployments_total" | "id" | "mine" | "updated" | "user_defined_fields" | "user_gravatar_id" | "username">;

export type PutStackScriptMutationResponse = PutStackScript200;

export type PutStackScriptMutation = {
    Response: PutStackScript200;
    Request: PutStackScriptMutationRequest;
    PathParams: PutStackScriptPathParams;
    Errors: any;
};