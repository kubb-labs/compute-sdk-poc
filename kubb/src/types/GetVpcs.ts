...
export const getVpcsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetVpcsPathParamsApiVersionEnumKey = (typeof getVpcsPathParamsApiVersionEnum)[keyof typeof getVpcsPathParamsApiVersionEnum];

export interface GetVpcsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetVpcsPathParamsApiVersionEnumKey;
}

export interface GetVpcsQueryParams {
    /**
...
export type GetVpcsQueryResponse = GetVpcs200;

export type GetVpcsQuery = {
    Response: GetVpcs200;
    PathParams: GetVpcsPathParams;
    QueryParams: GetVpcsQueryParams;
    Errors: any;
};