...
export const postAddStackScriptPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PostAddStackScriptPathParamsApiVersionEnumKey = (typeof postAddStackScriptPathParamsApiVersionEnum)[keyof typeof postAddStackScriptPathParamsApiVersionEnum];

export interface PostAddStackScriptPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PostAddStackScriptPathParamsApiVersionEnumKey;
}
...
export type PostAddStackScriptMutation = {
    ...
    PathParams: PostAddStackScriptPathParams;
    Errors: any;
};