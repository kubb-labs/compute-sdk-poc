...
export const getLkeClusterPoolsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetLkeClusterPoolsPathParamsApiVersionEnumKey = (typeof getLkeClusterPoolsPathParamsApiVersionEnum)[keyof typeof getLkeClusterPoolsPathParamsApiVersionEnum];
...
export interface GetLkeClusterPoolsPathParams {
     ...
     * @type string
    */
    apiVersion: GetLkeClusterPoolsPathParamsApiVersionEnumKey;
    /**
