...
export const putProfilePathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutProfilePathParamsApiVersionEnumKey = (typeof putProfilePathParamsApiVersionEnum)[keyof typeof putProfilePathParamsApiVersionEnum];

export interface PutProfilePathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: PutProfilePathParamsApiVersionEnumKey;
}

export const putProfile200AuthenticationTypeEnum = {
    "password": "password",
    "github": "github"
} as const;

export type PutProfile200AuthenticationTypeEnumKey = (typeof putProfile200AuthenticationTypeEnum)[keyof typeof putProfile200AuthenticationTypeEnum];

export const putProfile200LishAuthMethodEnum = {
    "password_keys": "password_keys",
    "keys_only": "keys_only",
    "disabled": "disabled"
} as const;

export type PutProfile200LishAuthMethodEnumKey = (typeof putProfile200LishAuthMethodEnum)[keyof typeof putProfile200LishAuthMethodEnum];

/**
 * @description Profile updated successfully.
*/
export interface PutProfile200 {
    /**
    ...
    */
    readonly authentication_type?: PutProfile200AuthenticationTypeEnumKey;
    /**
    ...
    */
     ...
     * @type string | undefined
    */
    lish_auth_method?: PutProfile200LishAuthMethodEnumKey;
    /**
...
*/
export interface PutProfileError {
    /**
...
export const putProfileMutationRequestAuthenticationTypeEnum = {
    "password": "password",
    "github": "github"
} as const;

export type PutProfileMutationRequestAuthenticationTypeEnumKey = (typeof putProfileMutationRequestAuthenticationTypeEnum)[keyof typeof putProfileMutationRequestAuthenticationTypeEnum];

export const putProfileMutationRequestLishAuthMethodEnum = {
    "password_keys": "password_keys",
    "keys_only": "keys_only",
    "disabled": "disabled"
} as const;

export type PutProfileMutationRequestLishAuthMethodEnumKey = (typeof putProfileMutationRequestLishAuthMethodEnum)[keyof typeof putProfileMutationRequestLishAuthMethodEnum];

/**
 * @description The fields to update.
*/
export type PutProfileMutationRequest = Omit<NonNullable<{
    /**
     * @description __Read-only__ This account\'s Cloud Manager authentication type. You choose an authentication type in Cloud Manager and Akamai authorizes it when you log into your account. Authentication types include your user\'s password (in conjunction with your username), or the name of your identity provider, such as GitHub. Here are some examples:\n\n- If a user has never used third-party authentication, the authentication type will be `password`.\n\n- If a user is using third-party authentication, the name of their identity provider is used for the authentication type, for example, `github`.\n\n- If a user has used third-party authentication and has since revoked it, the authentication type is `password`.
     * @type string | undefined
    */
    readonly authentication_type?: PutProfileMutationRequestAuthenticationTypeEnumKey;
    /**
     * @description Your user can use these SSH Keys to access Lish. This value is ignored if `lish_auth_method` is `disabled`.
     * @type array
    */
    ...
    */
     ...
     * @type string | undefined
    */
    lish_auth_method?: PutProfileMutationRequestLishAuthMethodEnumKey;
    /**
     * @description __Read-only__ Information about your status in our referral program. The API makes this information available after this profile\'s account has established at least $25.00 USD of total payments.
     * @type object | undefined
    */
    ...
    */
    readonly verified_phone_number?: string | null;
}>, "authentication_type" | "referrals" | "uid" | "username" | "verified_phone_number">;

export type PutProfileMutationResponse = PutProfile200;

export type PutProfileMutation = {
    Response: PutProfile200;
    Request: PutProfileMutationRequest;
    PathParams: PutProfilePathParams;
    Errors: any;
};