...
export const getChildAccountsPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type GetChildAccountsPathParamsApiVersionEnumKey = (typeof getChildAccountsPathParamsApiVersionEnum)[keyof typeof getChildAccountsPathParamsApiVersionEnum];

export interface GetChildAccountsPathParams {
    /**
     * @description __Enum__ Call either the `v4` URL, or `v4beta` for operations still in Beta.
     * @type string
    */
    apiVersion: GetChildAccountsPathParamsApiVersionEnumKey;
}
...
export type GetChildAccountsQuery = {
    ...
    PathParams: GetChildAccountsPathParams;
