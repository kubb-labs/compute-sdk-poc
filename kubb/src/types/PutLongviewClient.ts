...
export const putLongviewClientPathParamsApiVersionEnum = {
    "v4": "v4",
    "v4beta": "v4beta"
} as const;

export type PutLongviewClientPathParamsApiVersionEnumKey = (typeof putLongviewClientPathParamsApiVersionEnum)[keyof typeof putLongviewClientPathParamsApiVersionEnum];
...
export interface PutLongviewClientPathParams {
     ...
     * @type string
    */
    apiVersion: PutLongviewClientPathParamsApiVersionEnumKey;
    /**
